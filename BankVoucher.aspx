                                ...
                                <div class="col m6" style="background-color: #efe6e6; padding: 15px; border: 2px solid silver; border-radius: 5px;">
                                    <div class="row">
                                        <div class="input-field col m6">
                                            <label class="active" runat="server" clientidmode="Static" id="lblAccountName" for="txtAccountName">Account Name
                                                <small class="text-muted font-italic">&nbsp;(Search Min 3 Chars)</small><span class="materialize-red-text font-weight-800">*</span>
                                        ...
                                        <div class="input-field col m6">
                                            <label class="active" runat="server" clientidmode="Static" id="lblCustomerName" for="txtCustomerName">Customer A/c Name
                                                <small class="text-muted font-italic">&nbsp;(Search Min 3 Chars)</small> <span class="materialize-red-text font-weight-800">*</span>
