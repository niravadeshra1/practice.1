<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="CampaignTemplate.aspx.cs" Inherits="StarsProject.CampaignTemplate" %>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="input-field col m12">
                                            ...
                                            <asp:TextBox ID="txtCampaignHeader" runat="server" ClientIDMode="Static" CssClass="content" TabIndex="1" MaxLength="50" TextMode="MultiLine" Height="150" placeholder="" EnableViewState="true" />
                                        </div>
                                    </div>
                                    <div id="divSignOff" runat="server" clientidmode="Static" class="row" style="display:none;">
                                        <div class="input-field col m12">
                                            <label class="active" for="txtCampaignFooter">Mail SignOff</label>
                                            <asp:TextBox ID="txtCampaignFooter" runat="server" ClientIDMode="Static" CssClass="form-control" TabIndex="1" MaxLength="50" TextMode="MultiLine" Height="150" placeholder=" " />
                                        </div>
                                    </div>
                                </div>
