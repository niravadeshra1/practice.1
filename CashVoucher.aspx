...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function openAccountInfo(cat) {
            var id = (cat != 'add') ? $('#hdnAccountID').val() : 0;
            document.getElementById('spnModuleHeader').innerText = "Manage Customer";
            var pageUrl = "Customers.aspx?mode=" + cat + "&id=" + id;
            $('#ifrFinancial').attr('src', pageUrl);
            $find("mpe").show();
        }
        function openCustomerInfo(cat) {
            var id = (cat != 'add') ? $('#hdnCustomerID').val() : 0;
            document.getElementById('spnModuleHeader').innerText = "Manage Customer";
            var pageUrl = "Customers.aspx?mode=" + cat + "&id=" + id;
            $('#ifrFinancial').attr('src', pageUrl);
            $find("mpe").show();
    ...
    <form id="frmEntry" runat="server" autocomplete="off">
        ...
        <div id="contentwrapper" class="contentwrapper">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col m12" style="background-color: #efe6e6; padding: 15px; border: 2px solid silver; border-radius: 5px;margin: 0px 0px 0px 15px;width: 97%;">
                                    <div class="row">
                                        <div class="input-field col m3">
                                            <label class="active" runat="server" clientidmode="Static" id="lblAccountName" for="txtAccountName">Cash A/c Name<small class="text-muted font-italic">&nbsp;(Min 3 chars to search)</small> <span class="materialize-red-text font-weight-800">*</span>
                                                <a href='javascript:openAccountInfo("view");'>
                                                ...
                                                <a href='javascript:openAccountInfo("add");'>
                                        ...
                                        <div class="input-field col m3">
                                            <label class="active" runat="server" clientidmode="Static" id="lblCustomerName" for="txtCustomerName">Customer A/c Name<small class="text-muted font-italic">&nbsp;(Min 3 chars to search)</small> <span class="materialize-red-text font-weight-800">*</span>
            ...
            <asp:Panel ID="Panl1" runat="server" CssClass="Popup" align="center" style = "display:none; border-radius:10px; padding-right: 10px !important;">  
                ...
                <iframe id="ifrFinancial" src="about:blank" runat="server" clientidmode="static" scrolling="auto" style="border:1px solid silver; background-color:transparent; width:100%; height:90%; padding:5px;"></iframe>  
                <br/>  
            </asp:Panel>
