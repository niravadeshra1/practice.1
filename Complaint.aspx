                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="input-field col m3">
                                        <% if (hdnSerialKey.Value == "GR5T-E7K3-EN2G-LAP4")
                                            {%>
                                        <label class="active" for="txtSrNo">Sr No.Repairs</label>
                                        <%  }
                                        else
                                            {%>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col m3">
                                        <div class="row mt-1 badge-secondary" style="border-radius: 5px; padding: 5px; margin-left:-22px">
                                            <div class="input-field col m12">
                                                <label class="active" for="txtRemarks">Additional Remarks<span class="materialize-red-text font-weight-800">*</span></label>
                                                <asp:TextBox ID="txtRemarks" runat="server" class="form-control" ClientIDMode="Static" TabIndex="5" MaxLength="500" TextMode="MultiLine" Rows="4" style="min-height:120px;" placeholder=""/>
                                            </div>
                                        </div>
                                    </div>
                                    <%} %>
                                    <div class="col m6">
                                        <div class="row mt-1 badge-secondary" style="border-radius: 5px; padding: 5px;">
                                           ...
                                           <% if (hdnSerialKey.Value == "GR5T-E7K3-EN2G-LAP4")
                                            ...
                                            <div class="input-field col m6 mb-0">
                                                <label class="active" for="txtSrNoReplacement">Sr.No.Replacement</label>
                                                <asp:TextBox ID="txtSrNoReplacement" runat="server" class="form-control" ClientIDMode="Static" TabIndex="4" placeholder="" />
                                            </div>
                                            <div class="input-field col m6 mb-0">
                                                <label class="active" for="drpErrorCode">Error Code</label>
                                                <asp:DropDownList ID="drpErrorCode" runat="server" class="select2-theme browser-default" ClientIDMode="Static" TabIndex="9"></asp:DropDownList>
                                            </div>
                                            <%} %>
                                        </div>
                                        <div class="row mt-1 badge-secondary" style="border-radius: 5px; padding: 5px;">
                                ...
                                <div class="row">
                                    <div class="col m12">
                                        <table id="tblComplaintLog" class="stdtable" cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <asp:Repeater ID="rptComplaintLog" runat="server" ClientIDMode="Static" OnItemDataBound="rptComplaintLog_ItemDataBound">
                                                <HeaderTemplate>
                                                    <thead>
                                                        <tr>
