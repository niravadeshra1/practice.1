<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComplaintFollowup.aspx.cs" Inherits="StarsProject.ComplaintFollowup" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>  
<%@ Register Src="~/myComplaintFollowupTimeline.ascx" TagPrefix="uc1" TagName="myComplaintFollowupTimeline" %>
            ...
            <%--<asp:UpdatePanel ID="upUserPanel" runat="server" UpdateMode="Conditional">
                <ContentTemplate>--%>
                    <div class="widgetbox">
                        ...
                        <asp:HiddenField ID="hdnComppkID" runat="server" ClientIDMode="Static" />
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col m6 padding-1" style="min-height:450px; border-right:3px ridge silver;">
                                            ...
                                            <%--<div class="row mt-2 hide" id="divStatus" runat="server" clientidmode="Static" style="border-radius: 5px;">
                                        ...
                                        <div class="col m6 padding-1" style="min-height:450px; border-right:3px ridge silver;">
                                            <uc1:myComplaintFollowupTimeline runat="server" ID="myComplaintFollowupTimeline" />
                                        </div>
                                    </div>
