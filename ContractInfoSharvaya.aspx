<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractInfoSharvaya.aspx.cs" Inherits="StarsProject.ContractInfoSharvaya" %>
                        ...
                        <div class="modal-body col m12">
                            <div class="row">
                                <div class="col m3" style="border-right: 3px ridge silver;">
                                    ...
                                    <div class=" row">
                                        <div class="input-field col m12">
                                            <label class="active" for="drpEmployee">Ownership</label>
                                                            ...
                                                            <asp:Repeater ID="rptContractInfoProductGroup" runat="server" ClientIDMode="Static" OnItemCommand="rptContractInfoProductGroup_ItemCommand" OnItemDataBound="rptContractInfoProductGroup_ItemDataBound">
                                                                <HeaderTemplate>
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th class="center-align hide">Serial Key</th>
                                                                            <th class="center-align">Start Dt.</th>
                                                                            <th class="center-align">End Dt.</th>
                                                                            <th class="center-align">Order No</th>
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr class="blueShed">
                                                                        ...
                                                                        <td class="center-align hide">
                                                                            <asp:TextBox ID="edSerialKey" runat="server" ClientIDMode="Static" Width="130" TabIndex="9" Text='<%# Eval("SerialKey") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" />
                                                                        </td>
                                                                        ...
                                                                        <td class="center-align">
                                                                            <asp:DropDownList ID="edOrderNo" runat="server" ClientIDMode="Static" class="select2-theme browser-default" AutoPostBack="true" OnSelectedIndexChanged="editItem_TextChanged" />
                                                                        </td>
                                                                        <td class="center-align">
                                                                ...
                                                                <FooterTemplate>
                                                                    <tr style="padding: 5px;">
                                                                        ...
                                                                        <td class="center-align hide">
                                                                            <asp:TextBox ID="txtSerialKey" runat="server" ClientIDMode="Static" Width="130" TabIndex="9" />
                                                                        </td>
                                                                        <td class="center-align">
                                                                        ...
                                                                        <td class="center-align">
                                                                            <asp:DropDownList ID="drpOrderNo" runat="server" ClientIDMode="Static" class="select2-theme browser-default" />
                                                                        </td>
                                                                        <td class="center-align">
