<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractInfo_BharatTech.aspx.cs" Inherits="StarsProject.ContractInfo_BharatTech" %>
                ...
                <div id="myModal" style="display: block; width: 100%;">
                    <div class="modal-content border-0">
                        <div class="modal-body col m12">
                            <div class="row">
                                <div class="col m3" style="border-right: 3px ridge silver;">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="input-field col m6">
                                            <label class="active" for="txtStartDate">Contract Date<span class="materialize-red-text font-weight-800">*</span> </label>
                                            <asp:TextBox ID="txtContractDate" runat="server" class="form-control" ClientIDMode="Static" TabIndex="6" onkeypress="return false;" placeholder="" TextMode="Date" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col m12">
                                    ...
                                    <div class="row hide">
                                        <div class="input-field col m12">
                                            <label class="active" for="txtSerialKey">Serial Key<span class="materialize-red-text font-weight-800">*</span> </label>
                                            <asp:TextBox ID="txtSerialKey" runat="server" class="form-control" ClientIDMode="Static" TabIndex="6" placeholder="" Width="200" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col m12">
                                                            ...
                                                            <asp:Repeater ID="rptContractInfoProductGroup" runat="server" ClientIDMode="Static" OnItemCommand="rptContractInfoProductGroup_ItemCommand" OnItemDataBound="rptContractInfoProductGroup_ItemDataBound">
                                                                <HeaderTemplate>
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th class="text-cente">End Dt.</th>
                                                                            <th class="text-center">Unit Price</th>
                                                                            <th class="text-center">Quantity <span class="materialize-red-text font-weight-800">*</span></th>
                                                                            <th class="text-center">Amount</th>
                                                                            <th class="text-center hide">Order No</th>
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr class="blueShed">
                                                                        ...
                                                                        <td class="text-center">
                                                                            <asp:TextBox ID="edStartDate" runat="server" ClientIDMode="Static" Width="130" TabIndex="9" TextMode="Date" Text='<%# Eval("StartDate","{0:yyyy-MM-dd}") %>' onkeypress="return false;" AutoPostBack="true" OnTextChanged="editItem_TextChanged" />
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <asp:TextBox ID="edEndDate" runat="server" ClientIDMode="Static" Width="130" TabIndex="9" TextMode="Date" Text='<%# Eval("EndDate","{0:yyyy-MM-dd}") %>' onkeypress="return false;" AutoPostBack="true" OnTextChanged="editItem_TextChanged" />
                                                                        </td>
                                                                        <td class="text-center">
                                                                        ...
                                                                        <td class="text-center"><%#  String.Format("{0:0.00}", Convert.ToDecimal(Eval("UnitPrice")) *  Convert.ToDecimal(Eval("Quantity"))) %></td>
                                                                    
                                                                        <td class="text-center hide">
                                                                            <asp:DropDownList ID="edOrderNo" runat="server" ClientIDMode="Static" class="select2-theme browser-default hide" AutoPostBack="true" OnSelectedIndexChanged="editItem_TextChanged" />
                                                                        </td>
                                                                ...
                                                                <FooterTemplate>
                                                                    <tr style="padding: 5px;">
                                                                        ...
                                                                        <td class="text-center">
                                                                            <asp:TextBox ID="txtStartDate" runat="server" ClientIDMode="Static" Width="130" TabIndex="9" TextMode="Date" />
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <asp:TextBox ID="txtEndDate" runat="server" ClientIDMode="Static" Width="130" TabIndex="9" TextMode="Date" />
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <asp:TextBox ID="txtUnitPrice" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="80" TabIndex="9" />
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <asp:TextBox ID="txtQuantity" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="80" TabIndex="10" MaxLength="15" />
                                                                        </td>
                                                                        <td class="text-center">
                                                                        ...
                                                                        <td class="text-center hide">
                                                                            <asp:DropDownList ID="drpOrderNo" runat="server" ClientIDMode="Static" class="select2-theme browser-default hide" />
                                                                        </td>
                                                                        <td class="center-align">
                                        ...
                                        <div id="pnl_TNC" class="col m12 mt-1" runat="server" clientidmode="Static" enableviewstate="true" style="display: none;">
                                            <div class="row">
                                                ...
                                                <div class="input-field col m12">
                                                    ...
                                                    <asp:TextBox ID="txtContractFooter" MaxLength="500" runat="server" class="form-control" ClientIDMode="Static" TabIndex="15" TextMode="MultiLine" Rows="14" Height="300px" placeholder="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
