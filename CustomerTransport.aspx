<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerTransport.aspx.cs" Inherits="StarsProject.CustomerTransport" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function validateForm() {
            ...
            var validflag = true;
            // ----------------------------------------
            if (jQuery("#txtTransportName").val() == "") {

                if (jQuery("#txtTransportName").val() == "")
                    errmsg += "<li>Transport Name required</li>";
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="input-field col m12">
                                        <asp:TextBox ID="txtTransportName" runat="server" ClientIDMode="Static" class="form-control" PlaceHolder=" " MaxLength="50" TabIndex="1"></asp:TextBox>
                                        <label class="active" for="txtTransportName">Customer Transport <span class="materialize-red-text font-weight-800">*</span></label>
                                    </div>
                                </div>
                            </div>
