<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="Customers.aspx.cs" Inherits="StarsProject.Customers" MaintainScrollPositionOnPostback="true"  ValidateRequest="false" EnableEventValidation ="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function setHiddenControls() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    // ---------------------------------------------------------------
                    $('#frmCustomer *').filter(':input').each(function () {
        ...
        function openCustomerCategoryInfo(cat) {
            //document.getElementById('spnModuleHeader').innerText = "Customer Category Information";
            var keyid = "0";
            var pageUrl = "CustomerCategory.aspx?mode=view&id=0";
            $('#ifrModule').attr('src', pageUrl);
            $find("mpe").show();
        }
        ...
        function retainTabPosition() {
            ...
            if ($("#hdnCurrentTab").val() == 'custdocs') {
                $('#lnkcustRemarks').addClass('active');
                $('#custRemarks').css("display", "block");
            }
...
<body class="loginpage">
    <form id="frmCustomer" runat="server" autocomplete="off">
                    ...
                    <div class="modal-body" style="min-height:300px;">
                        <div class="row">
                            ...
                            <div class="input-field col m2">
                                ...
                                <label class="active" for="drpCustomerType">Category <span class="materialize-red-text font-weight-800">*</span>
                                    <a href="javascript:openCustomerCategoryInfo('add');">
                        ...
                        <div class="row">
                            <div class="input-field col m4">
                                <label class="active" for="drpTransport">Transport</label>
                                <asp:DropDownList ID="drpTransport" runat="server" class="select2-theme browser-default" ClientIDMode="Static" TabIndex="4"></asp:DropDownList>
                            </div>
                            <div class="input-field col m3">
                                <label class="active" for="drpAccountHead">Under Group</label>
                                <asp:DropDownList ID="drpAccountHead" runat="server" class="select2-theme browser-default" ClientIDMode="Static" TabIndex="4"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col m9">
                                <asp:UpdatePanel ID="uPnlBasicInfo" runat="server">
                                    ...
                                    <div class="card-content">
                                        <div class="row">
                                            <div class="input-field col m2">
                                                <asp:TextBox ID="txtContactNo1" class="form-control" runat="server" ClientIDMode="Static" Placeholder=""  TabIndex="6"/>
                                                <label class="active" for="txtContactNo1">Contact #1 <span class="materialize-red-text font-weight-800">*</span></label>
                                            </div>
                                            <div class="input-field col m2">
                                                <asp:TextBox ID="txtContactNo2" runat="server" TabIndex="7" class="form-control"  ClientIDMode="Static" Placeholder="" MaxLength="16" />
                                                <label class="active" for="txtContactNo2">Contact #2</label>
                                            </div>
                                            <div class="input-field col m5">
                                                <label class="active" for="txtEmailAddress">Email Address</label>
                                                <asp:TextBox ID="txtEmailAddress" class="form-control" runat="server" ClientIDMode="Static"  MaxLength="100" Placeholder="" TabIndex="8"  />
                                            </div>
                                            <div class="input-field col m3">
                                                <label class="active" for="txtWebsite">Website</label>
                                                <asp:TextBox ID="txtWebsite" class="form-control" runat="server" ClientIDMode="Static" MaxLength="50" TabIndex="9"  Placeholder="" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col m2">
                                                <asp:TextBox ID="txtGSTNo" class="form-control" runat="server"   ClientIDMode="Static" Placeholder="" MaxLength="50" TabIndex="10"
                                                    AutoPostBack="true" OnTextChanged="txtGSTNo_TextChanged"/>
                                                <label class="active" for="txtGSTNo">GST #</label>
                                            </div>
                                            <div class="input-field col m2">
                                                <asp:TextBox ID="txtPANNo" class="form-control" runat="server" TabIndex="11" MaxLength="50"  ClientIDMode="Static" Placeholder="" />
                                                <label class="active" for="txtPANNo">PAN #</label>
                                            </div>
                                            <div class="input-field col m2">
                                                <asp:TextBox ID="txtCINNo" class="form-control" runat="server" TabIndex="12" MaxLength="50" ClientIDMode="Static" Placeholder="" />
                                                <label class="active" for="txtCINNo">
                                           ...
                                           <% if (hdnSerialKey.Value != "JAYJ-ALAR-AMBR-ICKS")
                                            ...
                                            <div class="input-field col m3" visible="false">
                                                ...
                                                <asp:TextBox ID="txtBirthDate" class="form-control" runat="server" ClientIDMode="Static" TabIndex="13"  Placeholder="" TextMode="Date"  />
                                            </div>
                                            <div class="input-field col m3">
                                                <label class="active" for="txtAnniversaryDate">Anniver.Date</label>
                                                <asp:TextBox ID="txtAnniversaryDate" class="form-control" runat="server" ClientIDMode="Static" TabIndex="14"  Placeholder=""  TextMode="Date"/>
                                            </div>
                                            <% } %>
                                        </div>
                                         <div class="row">
                                            <div class="input-field col m2">
                                                <asp:TextBox ID="txtTinVatNo" class="form-control" runat="server" ClientIDMode="Static" Placeholder="" MaxLength="15" TabIndex="15" />
                                                <label class="active" for="txtTinVatNo">TIN VAT No. </label>
                                            </div>
                                            <div class="input-field col m2">
                                                <asp:TextBox ID="txtTinCstNo" runat="server" TabIndex="16" class="form-control"  ClientIDMode="Static" Placeholder="" MaxLength="15" />
                                    ...
                                    <div class="row">
                                        <div class="col m12 pt-1">
                                            ...
                                            <div class="input-field inline mt-0 float-right">
                                                <asp:TextBox ID="txtOpening" class="form-control OnlyDecimal m-0 right-align" runat="server" ClientIDMode="Static" TabIndex="22"  Placeholder="" AutoPostBack="true" OnTextChanged="txtOpening_TextChanged" MaxLength="12"/>
                                            </div>
                                        </div>
                                        <div class="col m12">
                                            Debit
                                            <div class="input-field inline mt-0 float-right">
                                                <asp:TextBox ID="txtDebit" class="form-control m-0 right-align" runat="server" ClientIDMode="Static" ReadOnly="true" TabIndex="23"  Placeholder="" MaxLength="12"/>
                                            </div>
                                        </div>
                                        <div class="col m12">
                                            Credit
                                            <div class="input-field inline mt-0 float-right">
                                                <asp:TextBox ID="txtCredit" class="form-control m-0 right-align" runat="server" ClientIDMode="Static" ReadOnly="true" TabIndex="24" Placeholder="" MaxLength="12"/>
                                            </div>
                                        </div>
                                        <div class="col m12">
                                            Closing
                                            <div class="input-field inline mt-0 float-right">
                                                <asp:TextBox ID="txtClosing" class="form-control m-0 right-align" runat="server" ClientIDMode="Static" ReadOnly="true" TabIndex="25"  Placeholder="" MaxLength="12"/>
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                            ...
                            <div class="col m9">
                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                    ...
                                    <div class="card-content">
                                        <div class="row">
                                            <div class="input-field col m2">
                                                <asp:TextBox ID="txtCrDays" class="form-control OnlyNumeric" runat="server" ClientIDMode="Static" Placeholder="" MaxLength="15" TabIndex="17" />
                                                <label class="active" for="txtCrDays">CR Days <span class="materialize-red-text font-weight-800"></span></label>
                                            </div>
                                            <div class="input-field col m2">
                                                <asp:TextBox ID="txtCrLimit" runat="server" TabIndex="18" class="form-control OnlyDecimal"  ClientIDMode="Static" Placeholder="" MaxLength="15" />
                                                <label class="active" for="txtCrLimit">CR Limit</label>
                                            </div>
                                        </div>
                                    </div>
                                    </ContentTemplate>
                            ...
                            <div class="input-field col m12">
                                <div class="card small" style="height:100px;">
                                    ...
                                    <div class="card-content row" style="padding:5px !important;">
                                        <div class="input-field col m3">
                                            <asp:TextBox ID="txtNextFollowupDate" class="form-control" runat="server" ClientIDMode="Static" Placeholder="" TabIndex="19" TextMode="Date"/>
                                            <label class="active" for="txtNextFollowupDate">Next Followup</label>
                                        </div>
                                        <div class="input-field col m3">        
                                            <asp:DropDownList ID="drpFollowupType" class="select2-theme browser-default" runat="server" ClientIDMode="Static" TabIndex="20"></asp:DropDownList>
                                            <label class="active" for="drpFollowupType">Followup Type</label>
                                        </div>
                                        <div class="input-field col m6">
                                            <asp:TextBox ID="txtMeetingNotes" class="materialize-textarea" runat="server" ClientIDMode="Static" TabIndex="21" Placeholder="" MaxLength="500" Rows="4" />
                                ...
                                <div class="card user-card-negative-margin z-depth-0" id="feed" style="margin:0px;">
                                    <div class="card-content card-border-gray" style="height:500px;padding-top: 5px;">
                                        <div class="row">
                                          ...
                                          <% if (hdnSerialKey.Value == "PRUM-VJMC-PG7L-RPL3" || hdnSerialKey.Value == "ACCU-TEKT-ECHN-GIES" )
                                              { %>
                                                <li class="tab col m3 p-0"><a id="lnkcustRemarks" class="left" runat="server" clientidmode="Static" href="#custRemarks">Remarks</a></li>
                                           <% } %>
                                                                ...
                                                                <div class="card small" style="height:350px;">
                                                                    ...
                                                                    <div class="card-content" style="padding:10px 5px 5px 5px  !important;">
                                                                        <div class="row" style="width:100%">
                                                                            <div class="input-field col m12">
                                                                                <asp:TextBox ID="txtAddress" runat="server" class="form-control" Placeholder="" TabIndex="26" MaxLength="100"  ClientIDMode="Static" TextMode="MultiLine"/>
                                                                               <label class="active" for="txtAddress">Address </label> <%--<span class="materialize-red-text font-weight-800">*</span></label>--%>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row" style="width:100%">
                                                                            <div class="input-field col m4">
                                                                                <asp:TextBox ID="txtArea" runat="server" TabIndex="27" class="form-control"  ClientIDMode="Static" Placeholder="" MaxLength="100"/>
                                                                                <label class="active" for="txtArea">Area</label>
                                                                            </div>
                                                                            <div class="input-field col m4">
                                                                                <asp:DropDownList ID="drpCountry" class="select2-theme browser-default"  runat="server"  ClientIDMode="Static" TabIndex="28" AutoPostBack="true"  OnSelectedIndexChanged="drpCountry_SelectedIndexChanged"/>
                                                                            ...
                                                                            <div class="input-field col m4">
                                                                                <asp:DropDownList ID="drpState" class="select2-theme browser-default"  runat="server"  ClientIDMode="Static" TabIndex="29" AutoPostBack="true"  OnSelectedIndexChanged="drpState_SelectedIndexChanged"/>
                                                                        ...
                                                                        <div class="row" style="width:100%">
                                                                            <div class="input-field col m6">
                                                                                <asp:DropDownList ID="drpCity" class="select2-theme browser-default" runat="server"  ClientIDMode="Static" TabIndex="30" />
                                                                                <% if (hdnSerialKey.Value.Contains("PRI9-DG8H-G6GF-TP5V"))
                                                                                    { %>
                                                                            ...
                                                                            <div class="input-field col m6">
                                                                                <asp:TextBox ID="txtPincode" runat="server" TabIndex="31" class="form-control"  ClientIDMode="Static" Placeholder="" MaxLength="24"/>
                                                             ...
                                                             <div class="col m6 pr-0">
                                                                <div class="card small" style="height:400px;">  
                                                                    ...
                                                                    <div class="card-content" style="padding:10px 5px 5px 5px  !important;">
                                                                        <div class="row" style="width:100%">
                                                                            <div class="input-field col m6">
                                                                                <asp:TextBox ID="txtShipToCompName" runat="server" TabIndex="32" class="form-control"  ClientIDMode="Static" Placeholder="" MaxLength="100"  />
                                                                                <label class="active" for="txtShipToCompName"><% if (hdnSerialKey.Value == "BLUE-CHEM-56JK-BC88")
                      { %>Transportation <% }
                                                                                                                                                                                                          else
                                                                                                                                                                                                          {%> Company Name <%} %> </label>
                                                                            </div>
                                                                            <div class="input-field col m6">
                                                                                <asp:TextBox ID="txtShipToGSTNo" runat="server" TabIndex="33" class="form-control"  ClientIDMode="Static" Placeholder="" MaxLength="20" />
                                                                                <label class="active" for="txtShipToGSTNo"><% if (hdnSerialKey.Value == "BLUE-CHEM-56JK-BC88")
              { %>Branch <% }
                                                                            else
                                                                            {%> GST No. <%} %> </label>
                                                                            </div>
                                                                        ...
                                                                        <div class="row" style="width:100%">
                                                                            <div class="input-field col m12">
                                                                                <asp:TextBox ID="txtAddress1" runat="server" class="form-control" Placeholder="" TabIndex="34" MaxLength="100"  ClientIDMode="Static" TextMode="MultiLine"/>
                                                                                <label class="active" for="txtAddress1">Address </label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row" style="width:100%">
                                                                            <div class="input-field col m4">
                                                                                <asp:TextBox ID="txtArea1" runat="server" TabIndex="35" class="form-control"  ClientIDMode="Static" Placeholder="" MaxLength="100"  />
                                                                                <label class="active" for="txtArea1">Area</label>
                                                                            </div>
                                                                            <div class="input-field col m4">
                                                                                <asp:DropDownList ID="drpCountry1" class="select2-theme browser-default"  runat="server"  ClientIDMode="Static" TabIndex="36" AutoPostBack="true"  OnSelectedIndexChanged="drpCountry1_SelectedIndexChanged"/>
                                                                            ...
                                                                            <div class="input-field col m4">
                                                                                <asp:DropDownList ID="drpState1" class="select2-theme browser-default"  runat="server"  ClientIDMode="Static" TabIndex="37" AutoPostBack="true"  OnSelectedIndexChanged="drpState1_SelectedIndexChanged"/>
                                                                        ...
                                                                        <div class="row" style="width:100%">
                                                                            <div class="input-field col m6">
                                                                                <asp:DropDownList ID="drpCity1" class="select2-theme browser-default" runat="server"  ClientIDMode="Static" TabIndex="38" />
                                                                            ...
                                                                            <div class="input-field col m6">
                                                                                <asp:TextBox ID="txtPincode1" runat="server" TabIndex="39" class="form-control"  ClientIDMode="Static" Placeholder="" MaxLength="10"/>
                                        ...
                                        <div id="custRemarks" class="row" runat="server" clientidmode="Static" enableviewstate="true" style="display:block;">
                                            <div class="input-field col m12" style="height:400px; overflow-y:auto;">
                                                    ...
                                                    <ContentTemplate>
                                                        <div class="row">
                                                            <div class="input-field col m12">
                                                                ...
                                                                <asp:TextBox ID="txtRemarks" runat="server" class="form-control" Placeholder="" TabIndex="26" MaxLength="100"  ClientIDMode="Static" TextMode="MultiLine"/>
                                                            </div>   
                                                        </div>
                                                    </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                                    ...
                                                                    <div class="card-reveal gradient-45deg-light-blue-teal gradient-shadow black-text">
                                                                        ...
                                                                        <div id="profile-card1" class="card animate fadeRight mb-0">
                                                                            <div class="card-content p-0 col m12">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="input-field col m4">
                                                                                        <asp:TextBox ID="txtContactNumber1" runat="server" class="form-control" ClientIDMode="Static" placeholder=" "  TabIndex="33" />
