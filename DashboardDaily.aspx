...
<%--    <script type="text/javascript" src="js/jquery-3.3.1.js"></script>
    ...
    <script type="text/javascript">
        ...
        // -----------------------------------------------------------------
        function viewCRMSummaryList(type, userid) {
            Sys.UI.DomElement.getElementById('<%= spnModuleHeader.ClientID%>').innerHTML = "CRM Summary : " + type.toUpperCase();
            var t11, t12;
            t11 = ($("#drpDailyMonth").val() != '') ? $("#drpDailyMonth").val() : 0;
            t12 = ($("#drpDailyYear").val() != '') ? $("#drpDailyYear").val() : 0;

            pageUrl = "myCustomView.aspx?view=crmsummary&para1=" + type + "&para2=" + userid + "&para3=" + t11 + "&para4=" + t12;
        ...
        function openTimeline(xView, xCustID, xCustName) {
            Sys.UI.DomElement.getElementById('<%= spnModuleHeader.ClientID%>').innerHTML = "FollowUp Timeline";
        ...
        function openToDO(mode, pkid) {
            Sys.UI.DomElement.getElementById('<%= spnModuleHeader.ClientID%>').innerHTML = "Manage ToDO Task";
     ...
     <script>
        ...
        $(function () {
            ...
            const config = {
                ...
                apiKey: "AIzaSyDc7aLam2GNnp620m1C8cNaOhh_VClQ5NQ",
                authDomain: "jatin-test-7bd28.firebaseapp.com",
                databaseURL: "https://jatin-test-7bd28-default-rtdb.firebaseio.com",
                projectId: "jatin-test-7bd28",
                storageBucket: "jatin-test-7bd28.appspot.com",
                messagingSenderId: "854101628648",
                appId: "1:854101628648:web:c7819325279f0351e89b5d",
                measurementId: "G-BDMF32LJ5H"
            };
            ...
            function getRegtoken() {
                ...
                messaging.getToken().then((Token) => {
                    ...
                    $.ajax({
                    type: 'POST',
                    url: "DashboardDaily.aspx/SetFirebaseToken",
            ...
            messaging.onMessage(function (payload) {
             //var xmsg = 'Title' + payload.notification.title + 'Message' + payload.notification.body;
             //showcaseError(xmsg);
             debugger;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hdnToDOPage" runat="server" ClientIDMode="Static" Value="1" />
    <asp:HiddenField ID="hdnFollwPage" runat="server" ClientIDMode="Static" Value="1" />
    <asp:HiddenField ID="FirebaseToken" runat="server" ClientIDMode="Static"  />
<%--    <audio controls>
                        ...
                        <div class="card user-statistics-card cardRound mb-1">
                            <div class="card-content p-0">
                                ...
                                <h5 class="h5Round">
                                    ...
                                    <asp:DropDownList ID="drpOwnerToDO" runat="server" class="myDropDownClass select2-theme browser-default mr-2 float-right" ClientIDMode="Static" OnSelectedIndexChanged="drpOwnerToDO_SelectedIndexChanged" TabIndex="5" AutoPostBack="true"  style="width:160px;" >
                                        <asp:ListItem Text="-- All --" Value="" />
                                        <asp:ListItem Text="Initiate By Me" Value="Initiate" />
                                        <asp:ListItem Text="Assign To Me" Value="Assign" />
                                    </asp:DropDownList>
                                </h5>
                        ...
                        <div class="card user-statistics-card cardRound mb-1">
                            <div class="card-content p-0">
                                ...
                                <h5 class="h5Round">
                                    ...
                                    <asp:DropDownList ID="drpLeadEmployee" runat="server" ClientIDMode="Static" CssClass="myDropDownClass select2-theme browser-default mr-2 float-right" OnSelectedIndexChanged="drpLeadEmployee_SelectedIndexChanged" TabIndex="5" AutoPostBack="false">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="drpLeadType" runat="server" ClientIDMode="Static" CssClass="myDropDownClass select2-theme browser-default mr-2 float-right" OnSelectedIndexChanged="drpLeadEmployee_SelectedIndexChanged" TabIndex="5" AutoPostBack="false">
                                        <asp:ListItem Text="Lead" Value="Lead" />
                                        <asp:ListItem Text="External" Value="External" />
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="drpLeadOption" runat="server" ClientIDMode="Static" CssClass="myDropDownClass select2-theme browser-default mr-2 float-right" OnSelectedIndexChanged="drpLeadEmployee_SelectedIndexChanged" TabIndex="5" AutoPostBack="false">
                                        <asp:ListItem Text="Initiated By" Value="initiate" />
        ...
        function openDashboardBox(view, mode, id) {
            ...
            if (view == 'inquirybyno') {
                if (mode == 'Lead' || mode == 'lead')
                {
                    ...
                    if (mode == 'TeleCaller' || mode == 'telecaller' || mode == 'Telecaller')
                    {
                        Sys.UI.DomElement.getElementById('<%= spnModuleHeader.ClientID%>').innerHTML = "Manage TeleCaller Leads";
                        var pageUrl = "TeleCaller.aspx?mode=view&source=telecaller&id=" + id;
                        $('#ifrModuleDaily').attr('src', pageUrl);
                        $find("mpe").show();
                    }
                    else {
                        Sys.UI.DomElement.getElementById('<%= spnModuleHeader.ClientID%>').innerHTML = "Manage External Leads";
                        var pageUrl = "ExternalLeads.aspx?mode=view&source=telecaller&id=" + id;
                        $('#ifrModuleDaily').attr('src', pageUrl);
                        $find("mpe").show();
                    }
                }
