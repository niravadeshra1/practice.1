<%@ Page Title="" Language="C#" MasterPageFile="~/StarsSite.Master" AutoEventWireup="true" CodeBehind="DashboardDailyBluetone.aspx.cs" Inherits="StarsProject.DashboardDailyBluetone" %>
...
<%@ Register Src="~/myFollowupBluetone.ascx" TagPrefix="uc1" TagName="myFollowupBluetone" %>
                    ...
                    <ContentTemplate>
                        <div class="card user-statistics-card cardRound mb-1">
                            <div class="card-content p-0">
                                ...
                                <div style="width: 100%; min-height: 350px; max-height: 350px; padding: 2px 10px 0px 10px; overflow-x: hidden; overflow-y: auto;">
                                    <uc1:myFollowupBluetone runat="server" id="myFollowupBluetone" />
                                </div>
                            </div>
                        ...
                        <div class="card user-statistics-card cardRound mb-1">
                            <div class="card-content p-0">
                                ...
                                <h5 class="h5Round">
                                    ...
                                    <asp:DropDownList ID="drpLeadType" runat="server" ClientIDMode="Static" CssClass="myDropDownClass select2-theme browser-default mr-2 float-right" OnSelectedIndexChanged="drpLeadEmployee_SelectedIndexChanged" TabIndex="5" AutoPostBack="true">
                                        <asp:ListItem Text="Lead" Value="Lead" />
                                        <asp:ListItem Text="External" Value="External" />
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="drpLeadOption" runat="server" ClientIDMode="Static" CssClass="myDropDownClass select2-theme browser-default mr-2 float-right" OnSelectedIndexChanged="drpLeadEmployee_SelectedIndexChanged" TabIndex="5" AutoPostBack="true">
