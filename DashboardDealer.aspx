...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="card user-statistics-card mb-0">
                    <div class="card-content p-0">
                        <h5 class="h5RoundHead">
                            ...
                            <asp:DropDownList ID="drpDealer" runat="server" ClientIDMode="Static" class="select2-theme browser-default ml-1 myDropDownClass" AutoPostBack="true" OnSelectedIndexChanged="drpDealer_SelectedIndexChanged" Width="350" style="display:inline-block;"></asp:DropDownList>
    ...
    <script type="text/javascript">
        window.onload = function () {
            document.getElementById('<%=((Label)Master.FindControl("lblModule")).ClientID %>').innerText = "Dealer Management";
        }
