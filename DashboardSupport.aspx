...
<%@ Register Src="~/myComplaintFollowup.ascx" TagPrefix="uc1" TagName="myComplaintFollowup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function complaintReAssign(id)
        {
            $("#hdnReAssignpkID").val(id);
        ...
        function openContFollowup(mode, pkid) {
            ...
            var pageUrl = "ComplaintFollowup.aspx?mode=" + mode + "&id=0&pkID=" + pkid
            $('#ifrModule').attr('src', pageUrl);
            $find("mpe").show();
        }
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="upLeadSection" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div id="divComplaint" style="background: linear-gradient(45deg, silver, #f9e3b1); margin-bottom: 10px; padding-left: 10px; padding-right: 10px;">
                ...
                <div id="cardLeadSummary" class="pt-0 hide">
                    <div class="row">
                        <div class="col m6">
                ...
                <div class="row">
                            ...
                            <div class="card-content padding-2" style="min-height: 275px;">
                                ...
                                <div class="card-content p-0">
                                    ...
                                    <h5 class="h5Round">
                                        ...
                                        &nbsp;<span id="spnOpen" runat="server" clientidmode="Static" class="badge gradient-45deg-yellow-green black-text" style="line-height: 25px; float: none; line-height: 25px; vertical-align: text-top; padding: 5px 10px; border-radius: 8px;"></span>
                    ...
                    <div class="col m6">
                        ...
                        <div class="card user-statistics-card cardRound mb-0">
                            <div class="card-content padding-2" style="min-height: 275px;">
                                <div class="card-content p-0">
                                    <a class="material-icons background-round gradient-45deg-red-pink white-text float-left p-0 adddialog" data-position="center" data-tooltip="New Sales Target" href="javascript:openDashboardBox('amc', 'add', 0);" style="margin: 8px 0 8px 8px;"><i class="material-icons" style="font-size: 20px; padding: 5px;">add</i></a>
                                    <h5 class="h5Round">
                    ...
                    <div class="col m6" style="margin-top:15px;">
                        ...
                        <div class="card user-statistics-card cardRound mb-0">
                            <div class="card-content padding-2" style="min-height: 275px;">
                                <%--<div class="select-action">--%>
                                <div class="card-content p-0">
                                    <%--<a class="material-icons background-round gradient-45deg-red-pink white-text float-left p-0 adddialog" data-position="center" data-tooltip="New Follow Up" href="javascript:openDashboardBox('followup', 'add', 0);" style="margin: 8px 0 8px 8px;"><i class="material-icons" style="font-size: 20px; padding: 5px;">add</i></a>--%>
                                    <h5 class="h5Round">
                                        <span id="Span5" runat="server" clientidmode="Static" class="titleHead text-top" style="color: white; margin-left: 15px;">Complaint Follow Up
                                        ...
                                        <asp:DropDownList ID="drpEmployee" runat="server" class="myDropDownClass select2-theme browser-default mr-2 float-right hide" ClientIDMode="Static" OnSelectedIndexChanged="drpEmployee_SelectedIndexChanged" TabIndex="5" AutoPostBack="true">
                                        </asp:DropDownList>
                                    </h5>
                                </div>
                                 <div class="user-statistics-container" style="width: 100%; min-height: 350px; max-height: 350px; padding: 2px 10px 0px 10px; overflow-x: hidden; overflow-y: auto;">
                                    <uc1:myComplaintFollowup runat="server" ID="myComplaintFollowup" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <br />
    <%--*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*--%>
    <div id="myNotificationModal" class="modal" style="width:40% !important;">
        <asp:HiddenField ID="hdnReAssignpkID" runat="server" ClientIDMode="Static" />
        <div class="modal-content">
            <h4>Re-Assign Complaint
            ...
            <div class="row mt-3">
                <div class="input-field col m12 p-0">
                    <label class="active" for="drpAssignTo">Re-Assign To <span class="materialize-red-text font-weight-800">*</span></label>
        ...
        <div class="modal-footer">
            <button id="btnReAssign" type="button" runat="server" clientidmode="Static" tabindex="11" class="btn cyan right mr-1" onserverclick="btnReAssign_Click">Load Order</button>
        </div>
    </div>
    <script type="text/javascript">
        ...
        function openDashboardBox(view, mode, id) {
            if (view == 'amc') {
                Sys.UI.DomElement.getElementById('<%= spnModuleHeader.ClientID%>').innerHTML = "Manage AMC Contracts";
                var pageUrl = "ContractInfo.aspx?mode=add" + mode + "&id=" + id;
                $('#ifrModule').attr('src', pageUrl);
                $find("mpe").show();
            }
                ...
                Sys.UI.DomElement.getElementById('<%= spnModuleHeader.ClientID%>').innerHTML = "Manage Complaints Follow Up";
                var pageUrl = "ComplaintFollowup.aspx?mode=" + mode + "&id=" + id;
                $('#ifrModule').attr('src', pageUrl);
                $find("mpe").show();
            }
        }
