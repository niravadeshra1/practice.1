                                    ...
                                    <div class="row">
                                        <div class="col m12">
                                            <div class="row">
                                                ...
                                                <div class="input-field col m2">
                                                    <label class="active" for="drpBankID">Select Bank<span class="materialize-red-text font-weight-800">*</span></label>
                                                    <asp:DropDownList ID="drpBankID" runat="server" ClientIDMode="Static" TabIndex="4" class="select2-theme browser-default" Style="height: inherit;" />
                                                </div>
                                            </div>
                                                        ...
                                                        <asp:Repeater ID="rptOrderDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptOrderDetail_ItemCommand" OnItemDataBound="rptOrderDetail_ItemDataBound">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td class="right-align width-6">
                                                                        <asp:TextBox ID="edUnitQty" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("UnitQty") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex="6" />
                                                                    </td>
                                                                    <% } %>
                                                                    <td class="right-align width-6">
                                                                        <asp:TextBox ID="edQuantity" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("Qty") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex="7" />
                                                                    </td>
                                                                    <td class="center-align width-5"><%# Eval("Unit") %></td>
                                                                    <td class="right-align width-7">
                                                                        <asp:TextBox ID="edUnitRate" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("Rate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;" TabIndex="8" />
                                                                    </td>
                                                                    <td class="right-align width-5">
                                                                        <asp:TextBox ID="edDiscountPercent" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountPer") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="9" />
                                                                    </td>
                                                                    <td class="right-align width-6">
                                                                        <asp:TextBox ID="edDiscountAmt" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountAmt") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Enabled="false" Style="width: 80px; text-align: right;" TabIndex="10" />
                                                                    </td>
                                                                    <td class="right-align width-6">
                                                                        <asp:TextBox ID="edNetRate" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("NetRate") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex="11" />
                                                                    </td>
                                                                    <td class="right-align width-7">
                                                                        <asp:TextBox ID="edHeaderDiscAmt" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("HeaderDiscAmt") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex="12" />
                                                                    </td>
                                                                    <td class="right-align width-6">
                                                                        <asp:TextBox ID="edAmount" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("Amount") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex="13" />
                                                                    </td>
                                                                    <td class="right-align width-5">
                                                                        ...
                                                                        <asp:TextBox ID="edTaxRate" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# (Eval("TaxRate") ) %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="14" />
                                                                    </td>
                                                                    <td class="right-align width-7">
                                                                        ...
                                                                        <asp:TextBox ID="edTaxAmount" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# (Eval("TaxAmount") ) %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex="15" />
                                                                    </td>
                                                                    <td class="right-align hide">
                                                                        <asp:TextBox ID="edAddTaxPer" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("AddTaxPer") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="16" />
                                                                    </td>
                                                                    <td class="right-align hide">
                                                                        <asp:TextBox ID="edAddTaxAmt" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("AddTaxAmt") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex="17" />
                                                                    </td>
                                                                    <td class="right-align width-7">
                                                                        <asp:TextBox ID="edNetAmount" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("NetAmt") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex="18" />
                                                                    </td>
                                                            ...
                                                            <FooterTemplate>
                                                                <tr style="background-color: #dde8f3;">
                                                                    ...
                                                                    <td class="right-align width-5">
                                                                        <asp:TextBox ID="txtDiscountPercent" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="50" TabIndex="26" AutoPostBack="true" OnTextChanged="txtDiscountPercent_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align width-6">
                                                                        <asp:TextBox ID="txtDiscountAmt" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="80" TabIndex="27" AutoPostBack="true" OnTextChanged="txtDiscountAmt_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align width-6">
                                                                        <asp:TextBox ID="txtNetRate" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="80" TabIndex="28" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align width-7">
                                                                        <asp:TextBox ID="txtHeaderDiscAmt" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="80" TabIndex="29" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align width-6">
                                                                        <asp:TextBox ID="txtAmount" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="90" TabIndex="30" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align width-5">
                                                                        ...
                                                                        <asp:TextBox ID="txtTaxRate" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="50" TabIndex="31" AutoPostBack="true" OnTextChanged="txtTaxRate_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align width-7">
                                                                        ...
                                                                        <asp:TextBox ID="txtTaxAmount" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="90" TabIndex="32" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align hide">
                                                                        <asp:TextBox ID="txtAddTaxPer" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="50" TabIndex="33" AutoPostBack="true" OnTextChanged="txtAddTaxPer_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align hide">
                                                                        <asp:TextBox ID="txtAddTaxAmt" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="90" TabIndex="34" Enabled="false" />

                                                                    </td>
                                                                    <td class="right-align width-7">
                                                                        <asp:TextBox ID="txtNetAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="90" TabIndex="35" Enabled="false" />
                                                                    </td>
                                                                    <%--<td class="right-align width-10">
                                                    ...
                                                    <table id="tblCharge" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt1" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="35" AutoPostBack="true" OnTextChanged="txtOthChrgAmt1_TextChanged" Style="text-align: right;" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt2" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="38" AutoPostBack="true" OnTextChanged="txtOthChrgAmt2_TextChanged" Style="text-align: right;" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt3" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="41" AutoPostBack="true" OnTextChanged="txtOthChrgAmt3_TextChanged" Style="text-align: right;" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt4" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="44" AutoPostBack="true" OnTextChanged="txtOthChrgAmt4_TextChanged" Style="text-align: right;" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt5" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="47" AutoPostBack="true" OnTextChanged="txtOthChrgAmt5_TextChanged" Style="text-align: right;" />
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table id="tblSummary" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tbody>
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtHeadDiscount" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="42" AutoPostBack="true" OnTextChanged="txtHeadDiscount_TextChanged" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-80 right-align">Basic Amount</td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotBasicAmt" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="45" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotOthChrgBeforeGST" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="48" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20">
                                                                    ...
                                                                    <asp:TextBox ID="txtTotGST" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="51" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotAddTaxAmt" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="54" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotOthChrgAfterGST" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="55" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-80 right-align">Round Off</td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtRoff" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="56" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-80 right-align">Net Amount</td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotNetAmt" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="57" ReadOnly="true" Style="font-weight: bold;" />
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <div class="container" style="max-width: none; width: 98%; margin: 5px !important;">
                                                <div class="row">
                                                    <div class="input-field col m3">
                                                        ...
                                                        <asp:TextBox ID="txtDeliveryNote" runat="server" class="form-control" ClientIDMode="Static" TabIndex="58" placeholder="" />
                                                    </div>
                                                    <div class="input-field col m3">
                                                        <label class="active" for="txtDeliveryDate">Delivery Note Date </label>
                                                        <asp:TextBox ID="txtDeliveryDate" runat="server" class="form-control" ClientIDMode="Static" TabIndex="59" placeholder="" TextMode="Date" />
                                                    </div>
                                                    <div class="input-field col m6">
                                                        <label class="active" for="txtTermsOfPayment">Terms Of Payment</label>
                                                        <asp:TextBox ID="txtTermsOfPayment" runat="server" class="form-control" ClientIDMode="Static" TabIndex="59" placeholder="" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="input-field col m4">
                                                        <label class="active" for="txtDisatchedDocNo">Dispatch Doc. No</label>
                                                        <asp:TextBox ID="txtDisatchedDocNo" runat="server" class="form-control" ClientIDMode="Static" TabIndex="60" placeholder="" />
                                                    </div>
                                                    <div class="input-field col m4">
                                                        <label class="active" for="txtVehicleNO">Vehicle  No</label>
                                                        <asp:TextBox ID="txtVehicleNO" runat="server" class="form-control" ClientIDMode="Static" TabIndex="61" placeholder="" />
                                                    </div>
                                                    <div class="input-field col m4">
                                                        <label class="active" for="txtDispatchThrough">Dispatch Through</label>
                                                        <asp:TextBox ID="txtDispatchThrough" runat="server" class="form-control"  ClientIDMode="Static" TabIndex="61" placeholder="" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
