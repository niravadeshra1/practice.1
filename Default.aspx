                ...
                <div id="login-page" class="row">
                    <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8" style="background-color: aliceblue;">
                        <form id="login" class="login-form" runat="server">
                            ...
                            <div id="divFINYEAR" class="row margin" runat="server" clientidmode="Static">
                                <div class="input-field col s12">
                                    <i class="material-icons prefix pt-2">person</i>
                                    <label class="active" for="drpFINYEAR">Financial Year</label>
                                    <asp:DropDownList ID="drpFINYEAR" class="select2-theme browser-default" runat="server" ClientIDMode="Static" style="margin-left:45px;width: 91%;">
                                    </asp:DropDownList>
                           ...
                           <%--Below section for AccuPanel--%>
                            ...
                            --%>
                            <asp:Label ID="lblMacAddress" runat="server" ClientIDMode="Static" />
                        </form>
                    </div>
                </div>
            </div>
