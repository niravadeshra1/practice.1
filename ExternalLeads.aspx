                                    ...
                                    <div class="card user-statistics-card float-right mt-0 padding-1" style="width: 40%;">
                                        <div class="card-content p-0" style="min-height: 200px;">
                                            ...
                                            <div id="panel2" runat="server" class="user-statistics-container">
                                                ...
                                                <div id="divInProcessRemark" runat="server" clientidmode="Static" class="input-field col m">
                                                    <label class="active required" for="txtInProcessRemark" style="color: black !important;">InProcess Remark</label>
                                                    <asp:TextBox ID="txtInProcessRemark" runat="server" Style="width: 248%;" class="form-control" ClientIDMode="Static" TabIndex="19" TextMode="MultiLine" Rows="3" MaxLength="500" placeholder="" />
                                                </div>
                                                            ...
                                                            <div class="card badge-primary">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="row" style="margin: 10px 0px 0px -10px;">
                                                                        ...
                                                                        <div runat="server" clientidmode="Static" class="input-field col m12">
                                                                            <label class="active required" for="txtDisQualifiedRemark" style="color: black !important;">DisQualified Remark</label>
                                                                            <asp:TextBox ID="txtDisRemark" runat="server" Style="width: 100%;" class="form-control" ClientIDMode="Static" TabIndex="19" TextMode="MultiLine" Rows="3" MaxLength="500" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
