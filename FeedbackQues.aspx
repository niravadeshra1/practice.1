<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeedbackQues.aspx.cs" Inherits="StarsProject.FeedbackQues" %>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="input-field col m12">
                                            <asp:TextBox ID="txtQuestion" runat="server" ClientIDMode="Static" class="form-control" TabIndex="1" MaxLength="50" placeholder="Enter Color Name" />
                                            <label class="active" for="txtQuestion">Questions<span class="materialize-red-text font-weight-800">*</span></label>
                                        </div>
                                        <div class="input-field col m12 hide">
                                            <asp:TextBox ID="txtAnsType" runat="server" ClientIDMode="Static" class="form-control" TabIndex="1" MaxLength="50" placeholder="Enter Color Name" />
                                            <label class="active" for="txtAnsType">Ans Type<span class="materialize-red-text font-weight-800">*</span></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
