                                        ...
                                        <div class="col m6" style="background-color: #efe6e6; padding: 15px; border: 2px solid silver; border-radius: 5px;">
                                            ...
                                            <div class="row">
                                                <div class="input-field col m6">
                                                    ...
                                                    <asp:TextBox ID="txtVoucherAmount" runat="server" class="form-control onlyDecimal" MaxLength="15" ClientIDMode="Static" TabIndex="8" OnTextChanged="txtVoucherAmount_TextChanged" placeholder="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col m6" style="background-color: #efe6e6; padding: 15px; border: 2px solid silver; border-radius: 5px;">
                                    ...
                                    <asp:Panel CssClass="row mt-1" ID="pnlPayment" runat="server" Visible="false" style="background-color: #eff1f3; padding: 15px; border: 2px solid silver; border-radius: 5px;">
                                        ...
                                        <div class="row">
                                            <div class="input-field col m4">
                                                ...
                                                <asp:TextBox ID="txtTotBasicAmt" class="form-control inputCalc onlyDecimal" MaxLength="15" runat="server" ClientIDMode="Static" TabIndex="16" ReadOnly="true" placeholder="" />
                                            </div>
                                            <div class="input-field col m4">
                                                <label class="active" for="txtTotGST">GST Amount</label>
                                                <asp:TextBox ID="txtTotGST" class="form-control inputCalc onlyDecimal" runat="server" MaxLength="15" ClientIDMode="Static" TabIndex="17" ReadOnly="true" placeholder="" />
                                            ...
                                            <div class="input-field col m4">
                                                ...
                                                <asp:TextBox ID="txtTotNetAmt" class="form-control inputCalc onlyDecimal" MaxLength="15" runat="server" ClientIDMode="Static" TabIndex="18" ReadOnly="true" placeholder="" Style="font-weight: bold;" />
                                            </div>
                                        </div>
                                    </asp:Panel>
