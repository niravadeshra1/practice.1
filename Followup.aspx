<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Followup.aspx.cs" Inherits="StarsProject.Followup" EnableEventValidation="false" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function GenerateQuot() {
            var inqno = "", newInqNo = "";
            inqno = $("#drpInquiry").val();
            // -------------------------------------------------
            if (inqno != "")
            {
                document.getElementById('spnModuleHeader').innerText = "Generate Quotation";
                var pageUrl = "Quotation.aspx?InquiryNo=" + inqno + "&mode=add&id=" + 0;
                $('#ifrModule').attr('src', pageUrl);
                $find("mpe").show();
            }
            else {
                showcaseError('Inquiry # is Missing !', 'toast-danger');
            }
        }
        ...
        function GenerateSO() {
            var inqno = "";
            var custid = 0;
            inqno = $("#drpInquiry option:selected").text();

            const myArray = inqno.split(" - ");
            var newInqNo = myArray[0].trim();
        
            custid = $('#hdnCustomerID').val();
            // -------------------------------------------------
            if (inqno != "" && newInqNo != "" && myArray.length>1 && custid > 0)
            {
                document.getElementById('spnModuleHeader').innerText = "Generate Sales Order";
                var pageUrl = "SalesOrder.aspx?CustomerId=" + custid + "&InquiryNo=" + newInqNo + "&mode=add&id=" + 0;
                $('#ifrModule').attr('src', pageUrl);
                $find("mpe").show();
            }
            else {
    ...
    <form id="frmEntry" runat="server" autocomplete="off">
        ...
        <div id="contentwrapper" class="contentwrapper">
                <div class="widgetbox">
                    ...
                    <asp:HiddenField ID="hdnfirewebtoken" runat="server" ClientIDMode="Static" />
                                ...
                                <div class="row">
                                    <div class="col m7 padding-1" style="min-height:450px; border-right:3px ridge silver;">
                                        ...
                                        <div class="row mt-2" id="divStatus" runat="server" clientidmode="Static" style="border-radius: 5px;">
                                            ...
                                            <div class="input-field col m6" id="divClosure" visible="true">
                                        ...
                                        <div id="divGenerate" runat="server" class="row mt-2 padding-1 gradient-45deg-blue-grey-blue-grey vertical-align-bottom">
                                            <button ID="btnGenQuot" type="button" runat="server"  clientidmode="Static" text="Reset" class="btn orange left" onclick="javascript:GenerateQuot();" tabindex="11"><i class="material-icons left">backspace</i>Generate Quotation</button>
                                            <button ID="btnGenSO" type="button" runat="server" clientidmode="Static" text="Save" class="btn cyan right mr-1" onclick="javascript:GenerateSO();" tabindex="12"><i class="material-icons left">save</i>Generate Performa</button>
                                        </div>
                                    </div>
                                    <div class="col m5">
                                        <div class="flex-lg-wrap">
                                            ...
                                            <div class="row">
                                                <div class="col m12 p-0">
                                                    ...
                                                    <div class="collapse multi-collapse padding-1" id="multiCollapseExample1" style="height:650px; overflow-x:hidden; overflow-y:auto;">
                                                                        ...
                                                                        <li id='liitem<%# Eval("pkID") %>' class="gradient-45deg-yellow-green mb-1" style="border-left: 2px solid #d6c7c7; padding:5px;">
                                                                            <span class="handle">
                                                                                <span class="text" style="color:black; font-weight:600; pointer-events: none;cursor: default !important;  text-transform:capitalize;">
                                                                                    <a title="Show Followup Info." href="javascript:void(0)" onclick="return false;"><%# Eval("CustomerName") %>&nbsp;&nbsp; <span><b> - </b></span><%# Eval("ContactNo1") %></a>
                                                                                </span>
