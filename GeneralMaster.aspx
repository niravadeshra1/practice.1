...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function retainTabPosition() {
            ...
            $('lnklocation1').removeClass('active');
            $('lnkErrorCode').removeClass('active');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="row">
                    <div class="col m3">
                        <table>
                            ...
                            <tr><td><a id="lnkCustTra1" class="left canceldisabled" href="#customertransport">Transport Type</a></td></tr>
                    ...
                    <div class="col m3">
                        <table>
                            ...
                            <tr><td><a id="lnklocation" class="left canceldisabled" href="#location">Location</a></td></tr>
                             <% if (hdnSerialKey.Value == "GR5T-E7K3-EN2G-LAP4")
                             {%>
                            <tr><td><a id="lnkErrorCode" class="left canceldisabled" href="#errorcode">Error Code</a></td></tr>
                            <%}%>
                            ...
                            <tr><td><a id="lnkType" class="left canceldisabled" href="#type">Type</a></td></tr>                            
                    ...
                    <div class="col m3">
                        <table>
                            ...
                            <tr><td><a id="lnkRegion1" class="left canceldisabled" href="#city">Manage Region - City</a></td></tr>
                            <tr><td><a id="lnkRegion2" class="left canceldisabled" href="#state">Manage Region - State</a></td></tr>
                            <tr><td><a id="lnkRegion3" class="left canceldisabled" href="#country">Manage Region - Country</a></td></tr>
                            ...
                            <tr><td><a id="lnkFeed" class="left canceldisabled" href="#feedback">Feedback Ques</a></td></tr>
                            <tr><td></td></tr>
                        </table>
                    </div>
                </div>
    ...
    <asp:Button ID="Button111" CssClass="hide" runat="server" Text="Fill Form in Popup" /> 
    <cc1:ModalPopupExtender ID="myModalPopup" BehaviorID="mpe" runat="server" ClientIDMode="Static" PopupControlID="Panl1" TargetControlID="Button111" CancelControlID="Button2" BackgroundCssClass="Background">  
    ...
    <script type="text/javascript">
        ...
        function gridSearchData(pos) {
            ...
            if (tmpVal != null && tmpVal != "") {
                ...
                dataurlsearchNew = dataurlsearchNew + "?ModuleName=" + varView + "&SearchKey=" + tmpVal;
                // ---------------------------------------------------
                var gridTable;
                jQuery.ajax({
        ...
        function openCustomerInfo(cat, keyid)
        {
            ...
            else if ($("#hdnSerialKey").val() == 'BLG3-AF78-TO5F-NW16')     //For Blueton
            {
                if (keyid != '' && keyid != undefined) {
                    jQuery.colorbox({ width: "100%", height: "100%", iframe: true, href: "CustomerQuick.aspx?mode=" + cat + "&id=" + keyid });
                }
            }
            else {
                if (keyid != '' && keyid != undefined) {
        ...
        function loadPageLayout() {
            ...
            if (viewmode == 'customer') {
                ...
                if ($("#hdnSerialKey").val() == "BLUE-CHEM-56JK-BC88" || "RA08-INS7-P1PE-IP5L")      // For Bluechem 
                {
                    colstructure = [
                    {
                    ...
                    { title: "Industry", data: "IndustryName", className: "right-align" },
                ...
                else if ($("#hdnSerialKey").val() == "JP08-LB94-MZ45-RY15")      // Jairam
                {
                    colstructure = [
                    {
                        title: "Customer Name", data: "CustomerName", className: "text-left limited", width: "230",
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:gridAction(\'edit\',\'' + row.CustomerID + '\');">' + data + '</a>';
                            return data;
                        }
                ...
                if ($("#hdnSerialKey").val() == "AC4G-46HJ-DRKL-S23B") //Kinco
                {
                    document.getElementById("btnupload").style.visibility = "visible";
                ...
                else if ($("#hdnSerialKey").val() == "HE43-SF8S-SDFC-AU9T")         // For HEMSAN
                {
                    colstructure = [
                        {
                            title: "Product Name", data: "ProductName", className: "left-align limited", width: "250",
                ...
                else if ($("#hdnSerialKey").val() == "AC4G-46HJ-DRKL-S23B")         //For Kinco
                {
                    colstructure = [
                        {
                            title: "Product Name", data: "ProductName", className: "left-align limited", width: "500",
                ...
                else if ($("#hdnSerialKey").val() == "BLG3-AF78-TO5F-NW16")         //For Blueton
                {
                    colstructure = [
                        ...
                        { title: "Category", data: "ProductGroupName", className: "center-align" },
                        { title: "HSN Code", data: "HSNCode", className: "center-align" },
                        { title: "Status", data: "ActiveFlagDesc", className: "center-align" }
                    ];
                }
                else {
            ...
            else if (viewmode == 'customertransport') {
                spnGeneralHeader.innerText = "Customer Transport";
                spnModuleHeader.innerText = "Customer Transport";
                dataurl = '/Services/NagrikService.asmx/webCustomerTransport?currPageNo=1';
                dataurlsearch = '/Services/NagrikService.asmx/webCustomerTransportSearch';
                colstructure = [
                    {
                        title: "Transport Name", data: "TransportName", className: "center", width: "300",
                        render: function (data, type, row, meta) {
                            data = '<a class="activator" href="javascript:gridAction(\'edit\',\'' + row.pkID + '\');">' + data + '</a>';
                            return data;
                        }
                ...
                colstructure = [
                    ...
                    { title: "State Code", data: "GSTStateCode" },
                ...
                colstructure = [
                    ...
                    { title: "Country ISO", data: "CountryISO" }
                    //{ title: "Country Telephonic Code", data: "TelephonicCode" }
                    //{ title: "Country Telephonic Code", data: "TelephonicCode" }
                ];
            }
                ...
                spnGeneralHeader.innerText = "Define Questions";
                spnModuleHeader.innerText = "Define Questions";
                dataurl = '/Services/NagrikService.asmx/webFeebackQuesList?currPageNo=1';
                dataurlsearch = '/Services/NagrikService.asmx/webFeebackQuesListSearch';
                colstructure = [
                    { title: "Questions", data: "Question" },
                    { title: "Ans. Type", data: "AnsType" }
                ];
            }
                ...
                colstructure = [
                    ...
                    {
                        title: "Campaign Header", data: "CampaignHeader", className: "contentBox", 
                        render: function (data, type, row, meta) {
            ...
            else if (viewmode == 'errorcode') {
                spnGeneralHeader.innerText = "ErrorCode";
                spnModuleHeader.innerText = "ErrorCode";
                dataurl = '/Services/NagrikService.asmx/webErrorCode?currPageNo=1';
                dataurlsearch = '/Services/NagrikService.asmx/webErrorCodeSearch';
                colstructure = [


                    { title: "Error Code", data: "ErrorCode1", className: "center" },
                ...
                spnGeneralHeader.innerText = "Manage Types";
                spnModuleHeader.innerText = "Manage Types";
                dataurl = '/Services/NagrikService.asmx/webType?currPageNo=1';
                dataurlsearch = '/Services/NagrikService.asmx/webTypeSearch';
                colstructure = [
                    { title: "Type Name", data: "TypeName", className: "center" },
                    { title: "Test Potential", data: "TestPotential", className: "center" },
                    { title: "Working Potential", data: "WorkingPotential", className: "center" },
                    { title: "Rupees", data: "RS", className: "center" },
                    { title: "Packing Bags", data: "PackingBags", className: "center" },
                ...
                if (viewmode == 'customer' || viewmode == 'customerhexagon') {
                    colstructure.splice(0, 0, {
                        title: "Action", className: "center", width: "60", mRender: function (data, type, row) {
                            ...
                            if ($("#hdnSerialKey").val() == 'JP08-LB94-MZ45-RY15' || $("#hdnSerialKey").val() == 'PRUM-VJMC-PG7L-RPL3')
                               rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'print\',\'' + row.CustomerID + '\');"/>';
                           rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;</div>';
                            return rtnval;
                        }
                    });
        ...
        function gridAction(mode, id) {
            ...
            if (varView == 'customer')
            {
                ...
                else if ($("#hdnSerialKey").val() == 'JP08-LB94-MZ45-RY15')  //Jairam Customer
                {
                    pageUrl = "Customers.aspx?mode=" + mode + "&id=" + id;
                    deleteUrl = 'Customers.aspx/DeleteCustomer';
                }
                else if ($("#hdnSerialKey").val() == 'BLG3-AF78-TO5F-NW16')  //Blueton
                {
                    pageUrl = "CustomerQuick.aspx?mode=" + mode + "&id=" + id;
                    deleteUrl = 'CustomerQuick.aspx/DeleteCustomer';
                }
                else
                {
                    pageUrl = "Customers.aspx?mode=" + mode + "&id=" + id;
            ...
            else if (varView == 'products')
            {
                ...
                else if ($("#hdnSerialKey").val() == 'AC4G-46HJ-DRKL-S23B')  //Kinco
                {
                    pageUrl = "Product_Quick.aspx?mode=" + mode + "&id=" + id;
                    deleteUrl = 'Product_Quick.aspx/DeleteProduct';
                }
                else if ($("#hdnSerialKey").val() == 'BLG3-AF78-TO5F-NW16')  //Blueton
                {
                    pageUrl = "Product_Blueton.aspx?mode=" + mode + "&id=" + id;
                    deleteUrl = 'Product_Blueton.aspx/DeleteProduct';
                }
                else if ($("#hdnSerialKey").val() == 'SYNC-SIOF-DFGH-09JH')  //Synchro Product
                {
                    pageUrl = "ProductsSync.aspx?mode=" + mode + "&id=" + id;
                    deleteUrl = 'ProductsSync.aspx/DeleteProduct';
                }
                else
                {
                ...
                cbWidth = "40%";
                cbHeight = "50%";
                if (($("#hdnSerialKey").val() == 'MES6-TECH-LSR7-S8JL')) // M-Tech
                {
                    pageUrl = "ProductGroupM_Tech.aspx?mode=" + mode + "&id=" + id;
                    deleteUrl = 'ProductGroupM_Tech.aspx/DeleteProductGroup';
                }
                else
                {
            ...
            else if (varView == 'customertransport') {
                cbWidth = "40%";
                cbHeight = "65%";
                pageUrl = "CustomerTransport.aspx?mode=" + mode + "&id=" + id;
                deleteUrl = 'CustomerTransport.aspx/DeleteCustomerTransport';
                deletePara = '{pkID:' + id + '}';
            }
            ...
            else if (varView == 'feedback') {
                var cbWidth = "70%";
                var cbHeight = "75%";
                pageUrl = "FeedbackQues.aspx?mode=" + mode + "&id=" + id;
                deleteUrl = 'FeedbackQues.aspx/DeleteQuestion';
                deletePara = '{pkID:\'' + id + '\'}';
                debugger;
            }
                ...
                //--------------------ErrorCode-----------------
            else if (varView == 'errorcode') {
                var cbWidth = "60%";
                var cbHeight = "75%";
                pageUrl = "ErrorCode.aspx?mode=" + mode + "&id=" + id;
                deleteUrl = 'ErrorCode.aspx/DeleteErrorCode';
                deletePara = '{pkID:\'' + id + '\'}';
            }
                //--------------------grade-----------------
                ...
                //--------------------Type-----------------
            else if (varView == 'type') {
                var cbWidth = "60%";
                var cbHeight = "75%";
                pageUrl = "Type.aspx?mode=" + mode + "&id=" + id;
                deleteUrl = 'Type.aspx/DeleteType';
                deletePara = '{pkID:\'' + id + '\'}';
            }
            ...
            //---------------------------------- Printing for Customer Detail ---------------------
            if (mode == 'print' && varView == 'customer') {
                var SOPageUrl = '';
                SOPageUrl = 'Customers.aspx/GenerateCustomerDetail';
                // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
