<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InquiryInfoBlue.aspx.cs" Inherits="StarsProject.InquiryInfoBlue" %>

<%@ Register Src="~/myModuleAttachment.ascx" TagPrefix="uc1" TagName="myModuleAttachment" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/myMultiEmailSend.ascx" TagPrefix="uc1" TagName="myMultiEmailSend" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        /*---------------------------------------------------------*/
        function openSizeList(pProdID, pkID) {
            var t11;
            t11 = jQuery("#txtInquiryNo").val();
            var pageUrl = "InquiryProductSize.aspx?InquiryNo=" + t11 + "&ProductID=" + pProdID + "&pkID=" + pkID;
        ...
        function openCustomerInfo(cat) {
            ...
            if ($("#hdnSerialKey").val() == 'BLG3-AF78-TO5F-NW16')          //For Blueton
            {
                var keyid = (cat == 'view') ? jQuery('#hdnCustomerID').val() : "0";
                document.getElementById('spnModuleHeader').innerText = "Manage Customer";
                var pageUrl = (cat == 'view') ? "CustomerQuick.aspx?mode=view&id=" + keyid : "CustomerQuick.aspx?mode=view&id=0";
                $('#ifrModule').attr('src', pageUrl);
                $find("mpe").show();
            }
            else {
        ...
        function openLeadSource(cat) {
                var keyid = 0;
                document.getElementById('spnModuleHeader').innerText = "Define Status";
                //GeneralMaster.aspx#inquirystatus
                var pageUrl = "InquiryStatus.aspx?mode=add&id=0";
                $('#ifrModule').attr('src', pageUrl);
                $find("mpe").show();
            }
        ...
        function openProductInfo(cat) {
            if ($("#hdnSerialKey").val() == 'HEXA-09PM-56JK-KG88')          //For Hexagon
            {
                ...
                var keyid = "0";
                var pageUrl = "Product_Blueton.aspx?mode=view&id=0";
                $('#ifrModule').attr('src', pageUrl);
                $find("mpe").show();
            }
        }
...
<body class="loginpage" style="background-color: transparent;">
    <form id="frmEntry" runat="server" autocomplete="off">
        ...
        <div id="contentwrapper" class="contentwrapper">
                        ...
                        <div class="modal-body col m12">
                            <div class="row">
                                <div class="col m5" style="border-right: 3px ridge silver;">
                                    ...
                                    <div class="row">
                                        <div class="input-field col m8">
                                            ...
                                            <asp:TextBox ID="txtCustomerName" runat="server" ClientIDMode="Static" placeholder="Minimum 3 chars to activate search" class="form-control" onKeyup="bindDDLTo('#txtCustomerName')" OnTextChanged="txtCustomerName_TextChanged" TabIndex="3" MaxLength="50" />
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col m6">
                                            <label class="active" for="drpInquirySource">Lead Source <span class="materialize-red-text font-weight-800">*</span>
                                                 <a href="javascript:openLeadSource('add');">
                                                    <img src="images/addCustomer.png" width="30" height="20" alt="Add New Customer" title="Add New Customer" />
                                                </a>
                                            </label>
                                    ...
                                    <div id="divNextFollowup" runat="server" clientidmode="Static" style="background-color: aliceblue; border: 1px solid silver; border-radius: 8px; padding: 10px 0px 0px 0px;">
                                        <div class="row">
                                            <div class="input-field col m12" id="divFollowupNotes" runat="server" clientidmode="Static">
                                                <label class="active" for="txtFollowupNotes">Followup Notes<span class="materialize-red-text font-weight-800">*</span></label>
                                    ...
                                    <div class="row mt-2" id="divSharedParent" runat="server" clientidmode="Static">
                                        <h5 class="card-title padding-1 m-0 float-left left-align width-100 gradient-45deg-yellow-teal">&nbsp;Shared With...</h5>
                                        <div class="input-field col m12" id="divShared" runat="server" clientidmode="Static"></div>
                                    </div>
                                ...
                                <div class="col m7">
                                                            ...
                                                            <HeaderTemplate>
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="right-align hide">Quantity<span class="materialize-red-text font-weight-800">*</span></th>
                                                                        <th class="right-align hide">Amount</th>
                                                                        <th class="right-align hide">Size List</th>
                                                                        <th class="right-align hide">Listing</th>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr class="blueShed">
                                                                    ...
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="tdUnitPrice" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("UnitPrice") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;"></asp:TextBox>
                                                                    </td>
                                                                    <td class="right-align hide">
                                                                        <asp:TextBox ID="tdQuantity" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;"></asp:TextBox>
                                                                    </td>
                                                                    <td class="right-align hide"><%#  String.Format("{0:0.00}", Convert.ToDecimal(Eval("UnitPrice")) *  Convert.ToDecimal(Eval("Quantity"))) %></td>
                                                                ...
                                                                <tr>
                                                                    <td class="center-align" colspan ="10">
                                                                        <asp:CheckBoxList ID="chkSizeList" runat="server" CssClass="chkToCompare" RepeatDirection="Horizontal" ClientIDMode="Static" style="color:black;" AutoPostBack="true" OnSelectedIndexChanged="chkSizeList_SelectedIndexChanged" ></asp:CheckBoxList>
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                <tr style="padding: 5px;">
                                                                    <td class="left-align">
                                                                        ...
                                                                        <asp:DropDownList ID="drpProductName" runat="server" class="select2-theme browser-default" ClientIDMode="Static" TabIndex="6" OnKeyup="bindDDLProductTo('#drpProductName')" AutoPostBack="true" OnSelectedIndexChanged="drpProductName_SelectedIndexChanged"/>
                                                                ...
                                                                <tr>
                                                                    <td class="center-align" colspan="10">
                                                                        <asp:CheckBoxList ID="chkSizeListbind" runat="server" CssClass="chkToCompare" RepeatDirection="Horizontal" ClientIDMode="Static" style="color:black;"></asp:CheckBoxList>
                                                                    </td>
                                                                </tr>
                                    ...
                                    <div id="pnl_Attachment" class="col m12 mt-1 hide" runat="server" clientidmode="Static" enableviewstate="true">
            ...
            <div class="row padding-1 gradient-45deg-blue-grey-blue-grey vertical-align-bottom" style="margin-top: 10px;">
                <div class="col m12">
                    ...
                    <%--<a id="btnSaveEmail"  runat="server" class="waves-effect waves-light gradient-45deg-deep-purple-blue btn modal-trigger z-depth-4 right ml-1 mr-1" href="#myNotificationModal"><i class="material-icons left">email</i>Save & Send Notfication</a>--%>
        ...
        <div id="myNotificationModal" class="modal">
            <uc1:myMultiEmailSend runat="server" id="myMultiEmailSend" />
        </div>        
        <script type="text/javascript">
