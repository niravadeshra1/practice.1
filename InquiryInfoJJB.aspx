                                                        ...
                                                        <asp:Repeater ID="rptInquiryProductGroup" runat="server" ClientIDMode="Static" OnItemCommand="rptInquiryProductGroup_ItemCommand" OnItemDataBound="rptInquiryProductGroup_ItemDataBound">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr class="blueShed">
                                                                    ...
                                                                    <td class="text-right ">
                                                                        <asp:TextBox id="tdQuantity" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text = '<%# Eval("Quantity") %> ' AutoPostBack="true" OnTextChanged="editItem_TextChanged" width="80" Style="text-align: right;"></asp:TextBox>
                                                                    </td>
                                                                    <td class="text-left ">
                                                            ...
                                                            <FooterTemplate>
                                                                <tr style="padding: 5px;">
                                                                    ...
                                                                    <td class="text-right">
                                                                        <asp:TextBox ID="txtQuantity" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="80" TabIndex="15" />
                                                                    </td>
                                                                    <td class="text-right">
