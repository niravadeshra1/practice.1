...
<%--    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function openProductSerialNo(pProdID, pRefNo, pProductName) {
            ...
            var t11 = jQuery("#txtInwardNo").val();
            var pageUrl = "ProductSerialNo.aspx?FromPage=inward&Module=In&InvoiceNo=" + t11 + "&ProductID=" + pProdID + "&RefNo=" + pRefNo + "&ProductName=" + pProductName;
            $('#ifrModule').attr('src', pageUrl);
            $find("mpe").show();
        }
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div id="divSupplier" runat="server" class="input-field col m4">
                                        ...
                                        <% if (hdnLocationStock.Value == "yes" || (hdnLocationStockWisePosting.Value == "yes"))
                                           {%>
                                            <div class="input-field col m2">
                                            ...
                                            <div class="input-field col m2">
                                                <label class="active" for="drpRef">Select Ref #</label>
                                                <asp:listbox runat="server" id="drpRef" style="width: 200px;" ClientIDMode="Static" EnableViewState="true" TabIndex="4" CssClass="select2-size-sm browser-default" AutoPostBack="true" OnSelectedIndexChanged="drpRef_SelectedIndexChanged" >
                                                    <asp:ListItem Text="Purchase Order" value="po" Selected="true" />
                                    ...
                                    <div id="dvLoadItems" runat="server" class="row" visible="false">
                                        <div class="input-field col m3">
                                            <label id="lblPOOut" runat="server" class="active" for="drpReferenceNo">Select P.O #</label>
<%--                                            <asp:DropDownList ID="drpReferenceNo" runat="server" ClientIDMode="Static" EnableViewState="true" TabIndex="4" CssClass="select2-size-sm browser-default" multiple="multiple"/>--%>
                                                <%--<asp:DropDownList ID="drpReferenceNo" runat="server" ClientIDMode="Static" EnableViewState="true" TabIndex="4" CssClass="select2-size-sm browser-default" multiple="multiple"/>--%>
                                                <asp:listbox runat="server" id="drpReferenceNo" style="width: 200px;" ClientIDMode="Static" EnableViewState="true" TabIndex="4" CssClass="select2-size-sm browser-default" AutoPostBack="true" OnSelectedIndexChanged="drpReferenceNo_SelectedIndexChanged" onchange="YourChangeEventJS(this)"></asp:listbox>
                                        </div>
                                        <div class="input-field col m2">
                                            <label id="lblpro" runat="server" class="active" for="lstOrderProduct">Select P.O Product</label>
...
<%--                                            <button id="Button3" type="button" runat="server" clientidmode="Static" class="btn cyan right mr-1" onclick="javascript:getSelectedOrders();" onserverclick="btnLoadItems_Click" TabIndex="5"><i class="material-icons left">save</i>Load Products</button>--%>
                                    ...
                                    <div class="row">
                                        <div class="col m12">
                                            <ul id="Ul1" class="tabs" runat="server" clientidmode="Static" enableviewstate="true" style="background-color:antiquewhite; color:navy;">
                                                ...
                                                <% if (hdnSerialKey.Value == "ACCU-TEKT-ECHN-GIES")
                                                    { %>
                                                    <li class="tab col p-0"><a id="lnkAttachment" class="left" href="#pnl_Attachment">Attachment</a></li>
                                                <% } %>
                                            </ul>
                                        </div>
                                        <div id="pnl_Products" class="col m12 mt-1" runat="server" clientidmode="Static" enableviewstate="true" style="display:block;">
                                                        ...
                                                        <asp:Repeater ID="rptInwardDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptInwardDetail_ItemCommand" OnItemDataBound="rptInwardDetail_ItemDataBound">
                                                            <HeaderTemplate>
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="center-align">Confirm Quantity <span class="materialize-red-text font-weight-800">*</span></th>
                                                                        <th class="center-align">Unit</th>
                                                                        <th class="center-align">Date Code</th>
                                                                        ...
                                                                        <th id="thSerialNo" runat="server" class="center-align width-5">Serial No #</th>
                                                                         <% } %>
                                                                        <th class="center-align width-5">Action</th>
                                                                    </tr>
                                                                </thead>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td class="center-align">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edSampleQuantity" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("SampleQuantity") %>' ReadOnly="true" Style="width: 80px; text-align: right;"  TabIndex="6"/>
                                                                    </td>
                                                                    <td class="center-align">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edQuantity" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;"  TabIndex="6"/>
                                                                    </td>
                                                                    <td class="center-align width-7"><%# Eval("Unit") %></td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edDateCode" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("DateCode") %>' Style="width: 80px; text-align: right;"  TabIndex="7"/>
                                                                    </td>
                                                                    <% if (hdnProductionWithoutCustomer.Value != "yes")
                                                                        { %>
                                                                    <td class="right-align">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edUnitRate" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("UnitRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;"  TabIndex="7"/>
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edDiscountPercent" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountPercent") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;"  TabIndex="8"/>
                                                                    </td>
                                                                    <td class="right-align hide">
                                                                        <asp:TextBox ID="edDiscountAmt"  CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountAmt") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Enabled="false" Style="width: 80px; text-align: right;" TabIndex="9"/>
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="edNetRate" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("NetRate") %>' AutoPostBack="true" Style="width: 80px; text-align: right;" Enabled="false" TabIndex="10"/>
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="edAmount" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("Amount") %>' AutoPostBack="true" Style="width: 100px; text-align: right;" Enabled="false"  TabIndex="11"/>
                                                                    </td>
                                                                    <td class="right-align">
                                                                        ...
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edTaxRate" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("TaxRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;"  TabIndex="12"/>
                                                                    </td>
                                                                    <td class="right-align">
                                                                        ...
                                                                        <asp:TextBox ID="edTaxAmount" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("TaxAmount") %>' AutoPostBack="true" Style="width: 100px; text-align: right;" Enabled="false" TabIndex="13"/>
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="edNetAmount" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("NetAmount") %>' AutoPostBack="true" Style="width: 100px; text-align: right;" Enabled="false" TabIndex="14"/>
                                                                    </td>
                                                                    <% } %>
                                                            ...
                                                            <FooterTemplate>
                                                                <tr style="background-color: #dde8f3;">
                                                                    <td>
                                                                        <asp:HiddenField ID="hdnSerialNoFlag" runat="server" ClientIDMode="Static" />
                                                                    ...
                                                                    <td class="center-align">
                                                                        <asp:TextBox ID="txtQuantity" MaxLength="15" runat="server" ClientIDMode="Static" CssClass="form-control onlyDecimal" Width="80" TabIndex="18" OnTextChanged="txtQuantity_TextChanged" onblur="javascript:calcQuotation();" />
                                                                    </td>
                                                                    <td class="center-align">
                                                                        <asp:TextBox MaxLength="15" ID="txtUnit" runat="server" ClientIDMode="Static" Width="80" TabIndex="19" Enabled="false" />
                                                                     </td>
                                                                    <td class="center-align">
                                                                        <asp:TextBox MaxLength="15" ID="txtDateCode" runat="server" ClientIDMode="Static" Width="80" TabIndex="19" AutoPostBack="true" OnTextChanged="txtUnitRate_TextChanged" />
                                                                     </td>
                                                                    <% if (hdnProductionWithoutCustomer.Value != "yes")
                                                                        { %>
                                                                    <td class="text-right">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="txtUnitRate" MaxLength="15" runat="server" ClientIDMode="Static" Width="80" TabIndex="20"  OnTextChanged="txtUnitRate_TextChanged" onblur="javascript:calcQuotation();" />
                                                                    </td>
                                                                    <td class="text-right">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="txtDiscountPercent" MaxLength="15" runat="server" ClientIDMode="Static" Width="80" TabIndex="21" OnTextChanged="txtDiscountPercent_TextChanged" onblur="javascript:calcQuotation();" />
                                                                    </td>
                                                                    <td class="text-right hide">
                                                                        <asp:TextBox ID="txtDiscountAmt" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="80" TabIndex="22" />
                                                                    </td>
                                                                    <td class="text-right">
                                                                        <asp:TextBox ID="txtNetRate" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Width="80" TabIndex="23" Enabled="false" />
                                                                    </td>
                                                                    <td class="text-right">
                                                                        <asp:TextBox ID="txtAmount"  CssClass="onlyDecimal" MaxLength="15" runat="server" ClientIDMode="Static" Width="100" TabIndex="24" Enabled="false" />
                                                                    </td>
                                                                    <td class="text-right">
                                                                        ...
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="txtTaxRate" MaxLength="15" runat="server" ClientIDMode="Static" Width="80" TabIndex="25" OnTextChanged="txtTaxRate_TextChanged" onblur="javascript:calcQuotation();" />
                                                                    </td>
                                                                    <td class="text-right">
                                                                        ...
                                                                        <asp:TextBox ID="txtTaxAmount" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Width="100" TabIndex="26" Enabled="false" />
                                                                    </td>
                                                                    <td class="text-right">
                                                                        <asp:TextBox ID="txtNetAmount" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Width="100" TabIndex="27" Enabled="false" />
                                                                    </td>
                                                                    <%} %>
                                                                    ...
                                                                    <td class="center-align width-5" style="vertical-align: top;">
                                            ...
                                            <div class="row">
                                                <div id="divSummary" runat="server" class="col m12">
