<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InwardAccutek.aspx.cs" Inherits="StarsProject.InwardAccutek" %>
...
<%--    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        /*---------------------------------------------------------*/
        function openQCTestReport(pInwardNo, pProdID) {
            var id = jQuery('#hdnpkID').val();
            var pageUrl = "InwardQCTest.aspx?Module= id=" + id + "&InwardNo=" + pInwardNo + "&ProductID=" + pProdID + "&pkID=" + id;
            $('#ifrModule').attr('src', pageUrl);
            $find("mpe").show();
        }
        /*---------------------------------------------------------*/
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="edDateCode" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("DateCode") %>' Style="width: 80px; text-align: right;"  AutoPostBack="true" OnTextChanged="editItem_TextChanged" TabIndex="7"/>
                                                                    </td>
                                                                    <% if (hdnProductionWithoutCustomer.Value != "yes")
                                                                        { %>
                                                                    <td class="right-align">
                                                                    ...
                                                                    <% } %>
                                                                    <td class="center-align">
                                                                        <a id="lnkQCTest" href="javascript:openQCTestReport('<%# Eval("InwardNo") %>','<%# Eval("ProductID") %>');" tabindex="19"><small>QC Test</small></a>
                                                                    </td>
