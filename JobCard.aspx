                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="right-align" style="width: 15%;">
                                                                <asp:TextBox ID="edQuantity" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 150px; text-align: right;" TabIndex="15" />
                                                            </td>
                                                            <td class="right-align" style="width: 15%;">
                                                                <asp:TextBox ID="edUnitRate" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("UnitRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 150px; text-align: right;" TabIndex="16" />
                                                            </td>
                                                            <td class="right-align" style="width: 15%;">
                                                                <asp:TextBox ID="edAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("Amount") %>' Style="width: 150px; text-align: right;" Enabled="false" TabIndex="21" />
                                                            </td>
