                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div id="divCustomer" runat="server" class="input-field col m4">
                                            ...
                                            <asp:TextBox ID="txtCustomerName" runat="server" ClientIDMode="Static" class="form-control" onKeyup="bindDDLTo('#txtCustomerName')" TabIndex="3" placeholder="" AutoPostBack="true" OnTextChanged="txtCustomerName_TextChanged" />
                                        </div>
                                        <div class="input-field col m2">
                                            <label class="active" for="drpOutwardNo">Outward No</label>
                                            <asp:DropDownList id="drpOutwardNo" runat="server" class="select2-theme browser-default" AutoPostBack="true" OnSelectedIndexChanged="drpOutwardNo_SelectedIndexChanged" />
                                        </div>
                                                ...
                                                <HeaderTemplate>
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="center-align">Outward No</th>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="center-align">
                                                            <asp:TextBox ID="edQuantity" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="edQuantity_TextChanged" Style="width: 150px;" />
                                                        </td>
                                                        <td class="center-align">
                                                                 <asp:TextBox ID="edOutwardNo" runat="server" ClientIDMode="Static" Text='<%# Eval("OutwardNo") %>' Style="width: 200px;" Enabled="false" TabIndex="15" />
                                                            </td>
                                                        <td class="center-align">
                                                ...
                                                <FooterTemplate>
                                                    <tr style="background-color: #dde8f3;">
                                                        ...
                                                        <td class="text-center center-align">
                                                            <asp:TextBox ID="txtQuantity" MaxLength="15" runat="server" ClientIDMode="Static" CssClass="form-control onlyDecimal" Width="150px" TabIndex="52" OnTextChanged="txtQuantity_TextChanged" onblur="javascript:calcQuotation();" />
                                                        </td>
