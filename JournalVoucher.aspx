                                ...
                                <div class="col m5" style="border-right: 3px ridge silver;">
                                    ...
                                    <div class="row">
                                        <div class="input-field col m12">
                                            ...
                                            <asp:TextBox ID="txtVoucherAmount" runat="server" placeholder="" class="form-control onlyDecimal" ClientIDMode="Static" TabIndex="3" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col m12">
                                                        ...
                                                        <asp:Repeater ID="rptJournal" runat="server" ClientIDMode="Static" OnItemCommand="rptJournal_ItemCommand">
                                                            ...
                                                            <FooterTemplate>
                                                                <tr style="padding: 5px;">
                                                                    ...
                                                                    <td class="text-right">
                                                                        <asp:TextBox ID="txtVoucherAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="80" TabIndex="15" MaxLength="15" />
                                                                    </td>
                                                                    <td class="text-center">
