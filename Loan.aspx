                                ...
                                <div class="row mt-1 mb-1" style="border-bottom:4px solid;">
                                    <div class="row">
                                        ...
                                        <div class="input-field col m2 pr-0">
                                            ...
                                            <asp:TextBox ID="txtLoanAmount" runat="server" class="form-control width-70 onlyDecimal" ClientIDMode="Static" TabIndex="4" placeholder="" AutoPostBack="true" OnTextChanged="txtLoanAmount_TextChanged"/>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="divInstallment1" runat="server" class="input-field col m2 pr-0">
                                            ...
                                            <asp:TextBox ID="txtNoOfInstallments" Enabled="false" runat="server" class="form-control onlyNumeric" ClientIDMode="Static" TabIndex="9" placeholder="" style="width:100px;"/>
                                        </div>
                                        <div id="divInstallment2" runat="server" class="input-field col m2 pr-0">
                                            ...
                                            <asp:TextBox ID="txtInstallmentAmount" Enabled="false" runat="server" class="form-control" onlyDecimal ClientIDMode="Static" TabIndex="10" placeholder="" style="width:150px;"/>
                                        </div>
                                    </div>
                                    <div class="row">
