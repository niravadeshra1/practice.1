                        ...
                        <div id="myModal" style="display: block; width: 100%;">
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div class="row padding-1 gradient-45deg-blue-grey-blue-grey vertical-align-bottom hide">
                                        <div class="col m4">
                                            <button ID="btnSave1" type="button" runat="server" Text="Save" class="btn cyan right mr-1" onserverclick="btnSave_Click" TabIndex="4"><i class="material-icons left">save</i>Add City</button>
                                        </div>
                                        <div class="col m4 hide">
