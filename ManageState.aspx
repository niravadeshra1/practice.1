                                ...
                                <div class="modal-body">                                    
                                    <div class="row">
                                        <div class="input-field col m4">
                                            ...
                                            <asp:DropDownList ID="drpCountry" runat="server" ClientIDMode="Static" TabIndex="9" class="select2-theme browser-default" Style="height: inherit;" />                                            
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col m4">
                                            <label class="active required" for="txtStateName">State Name</label>
                                            <asp:TextBox ID="txtStateName" runat="server" ClientIDMode="Static" class="form-control" TabIndex="1" MaxLength="1000" Placeholder=" "/>
                                        </div>
                                    </div>
                                    <div class="row">                                    
                                        <div class="input-field col m4">
                                            <label class="active" for="txtGSTStateCode">GST State Code</label>
                                            <asp:TextBox ID="txtGSTStateCode" runat="server" ClientIDMode="Static" class="form-control" TabIndex="3" Placeholder=" "/>
                                        </div>
                                    </div>
                                    <div class="row">
