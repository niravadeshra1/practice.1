<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialMovementAssembly.aspx.cs" Inherits="StarsProject.MaterialMovementAssembly" %>
...
<%--    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function openAssembly(pProdID,OrderNO) {
            ...
            var pageUrl = "MovementOutwardAssembly.aspx?ParentID=" + t11 + "&ProductID=" + pProdID + "&RefNo=" + OrderNO;
            $('#ifrModule').attr('src', pageUrl);
            $find("mpe").show();
        }
    ...
    <form id="frmEntry" runat="server">
        ...
        <div id="contentwrapper" class="contentwrapper">
            <div class="widgetbox">
                ...
                <asp:HiddenField ID="hdnProductWithSerialNo" runat="server" ClientIDMode="Static" EnableViewState="true" Value="pnl_Products" />
                                ...
                                <div class="col m12" style="border-right: 3px ridge silver;">
                                   <div class="row">
                                       ...
                                       <% if (hdnLocationStock.Value == "yes" || (hdnLocationStockWisePosting.Value == "yes"))
                                        ...
                                        <%}%>
                                        <div class="input-field col m2">
                                            <label class="active" for="rdblOption">Select Loading Option</label>
...
<%--                                                <asp:ListItem Text="Sales Order" Value="SO" />
                                                <asp:ListItem Text="Repairing Inward" Value="RI" />
                                                <asp:ListItem Text="Planning" Value="PL" /> --%>                                                                                                                                              
                                            </asp:DropDownList>
                                        </div>                                     
                                        <div id="divCust" runat="server" class="input-field col m3">
                                    ...
                                    <div id="divSelection" class="row" runat="server" visible="true">
                                        <div class="input-field col m3">
                                            <label id="lblLabel" class="active" for="drpReferenceNo">Select P.O #</label>
                                        ...
                                        <div class="input-field col m2">
                                            <label id="lblSelection" class="active" for="lstOrderProduct">Select P.O Product</label>
                                                            ...
                                                            <asp:Repeater ID="rptProductDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptProductDetail_ItemCommand">
                                                                <HeaderTemplate>
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th class="center-align width-10">Reference No</th>
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr class="blueShed">
                                                                        ...
                                                                        <td class="center-align width-10">
                                                                            <asp:TextBox ID="tdQuantity" Text='<%# Eval("Quantity") %>' runat="server" ClientIDMode="Static" Width="80" TabIndex="8" MaxLength="15" AutoPostBack="true" OnTextChanged="tdQuantity_TextChanged" />
                                                                        </td>
                                                                        <td id="tdOrderNo" runat="server" class="center-align width-10"><%# Eval("OrderNo") %></td>
                                                                        <td class="center-align width-10">
                                                                ...
                                                                <FooterTemplate>
                                                                    <tr style="padding: 5px;">
                                                                        <td class="left-align">
                                                                            <asp:HiddenField ID="hdnProductIDFoot" runat="server" ClientIDMode="Static" />
                                                                        ...
                                                                        <td class="center-align width-10">
                                                                            <asp:TextBox ID="txtQuantity" runat="server" ClientIDMode="Static" Width="80" TabIndex="8" MaxLength="15" AutoPostBack="true" OnTextChanged="txtQuantity_TextChanged" />
                                                                        </td>
                                                                        <td class="center-align width-10">
                            ...
                            success: function (data) {
                                ...
                                $(selector).autoComplete({
                                    ...
                                    onSelect: function (e, term, item) {
                                        console.log('Item "' + item.data('langname') + ' (' + item.data('lang') + ')" selected by ' + (e.type == 'keydown' ? 'pressing enter or tab' : 'mouse click') + '.');
                                        $(selector).val(item.html());
                                        $("#hdnProductIDFoot").val(item.data('langname'));
