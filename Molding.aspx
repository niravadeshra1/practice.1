                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="input-field col m2">
                                            ...
                                            <asp:DropDownList ID="drpWType" runat="server" ClientIDMode="Static" TabIndex="28" data-placeholder="Select ..." CssClass="select2-theme browser-default" AutoPostBack="true" OnSelectedIndexChanged="drpWType_SelectedIndexChanged" >
                                        ...
                                        <div class="input-field col m2">
                                            ...
                                            <asp:DropDownList ID="drpOrder" runat="server" ClientIDMode="Static" TabIndex="28" data-placeholder="Select ..." CssClass="browser-default" AutoPostBack="true" OnSelectedIndexChanged="drpOrder_SelectedIndexChanged1">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="input-field col m2">
                                            <label class="active" for="drpLocation">Location <span class="materialize-red-text font-weight-800">*</span> </label>
                                            <asp:DropDownList ID="drpLocation" runat="server" ClientIDMode="Static" TabIndex="28" data-placeholder="Select ..." CssClass="browser-default">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="row">
                                                        ...
                                                        <asp:Repeater ID="rptMoldingDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptMoldingDetail_ItemCommand" OnItemDataBound="rptMoldingDetail_ItemDataBound">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <asp:HiddenField ID="edWName" runat="server" ClientIDMode="Static" Value='<%# Eval("WorkerName") %>' />
                                                                    ...
                                                                    <td class="text-center center-align">
                                                                        <asp:DropDownList ID="edWorker" runat="server" ClientIDMode="Static" CssClass="browser-default" Width="250" TabIndex="18" AutoPostBack="true" OnSelectedIndexChanged="editItem_TextChanged"/>
                                                                    </td>
                                                                    <td class="center-align hide"><%# Eval("OrderNo") %></td>
                                                                    <td class="left-align"><%# Eval("ProductName") %></td>
                                                                    <%  if(hdnType.Value.ToLower() == "molding"){%>
                                                                        <td class="text-center center-align">
                                                                            <asp:TextBox ID="edDie" Text='<%# Eval("Die") %>' runat="server" ClientIDMode="Static" CssClass="form-control" Width="150" TabIndex="18" AutoPostBack="true" OnTextChanged="edDie_TextChanged"/>
                                                                        </td>
                                                                        <td class="text-center center-align">
                                                                        ...
                                                                        <td class="text-center center-align">
                                                                            <asp:TextBox ID="edCavity" Text='<%# Eval("Cavity") %>' runat="server" ClientIDMode="Static" CssClass="form-control" Width="150" TabIndex="18" AutoPostBack="true" OnTextChanged="edDie_TextChanged"/>
                                                                        </td>
                                                                        <td class="text-center center-align">
                                                            ...
                                                            <FooterTemplate>
                                                                <tr style="background-color: #dde8f3;">
                                                                    ...
                                                                    <td class="text-center center-align">
                                                                        <asp:DropDownList ID="txtWorker" MaxLength="15" runat="server" ClientIDMode="Static" CssClass="browser-default" Width="250" TabIndex="18" />
                                                                    </td>
