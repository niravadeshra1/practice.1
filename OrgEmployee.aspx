                                ...
                                <div id="divPersonal" runat="server" class="col m5 padding-1" style="min-height:520px; box-shadow: navy -6px 8px 6px -6px;">
                                    ...
                                    <div class="row">
                                        <div class="input-field col m6">
                                            ...
                                            <asp:TextBox ID="txtEmpCode" runat="server"  ClientIDMode="Static" class="form-control onlyNumeric" placeholder=" " TabIndex="12" MaxLength="15" />
                                        </div>
                                        <div class="input-field col m6">
                                                        ...
                                                        <div id="container1" runat="server" clientidmode="Static" class="container p-0" style="min-height:250px;">
                                                            ...
                                                            <div class="row">
                                                                <div class="input-field col m4">
                                                                    ...
                                                                    <asp:TextBox ID="txtCardNo" runat="server" ClientIDMode="Static" class="form-control onlyNumeric" MaxLength="15" placeholder=" " TabIndex="18" />
                                                                </div>
                                                                <div class="input-field col m4">
                                                            ...
                                                            <div class="row">
                                                                <div class="input-field col m4">
                                                                    ...
                                                                    <asp:TextBox ID="txtFixedSalary" runat="server" ClientIDMode="Static" class="form-control onlyDecimal" MaxLength="15" placeholder=" " TabIndex="21" />
                                                                </div>
                                                                <div class="input-field col m4">
                                                                    <label class="active navy-text" for="txtFixedBasic">Fixed Basic</label>
                                                                    <asp:TextBox ID="txtFixedBasic" runat="server" ClientIDMode="Static" class="form-control onlyDecimal" MaxLength="15" placeholder=" " TabIndex="22" />
                                                                </div>
                                                                <div class="input-field col m4">
                                                                    <label class="active navy-text" for="txtFixedHRA">Fixed H.R.A</label>
                                                                    <asp:TextBox ID="txtFixedHRA" runat="server" ClientIDMode="Static" class="form-control onlyDecimal" MaxLength="15" placeholder=" " TabIndex="23" />
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="input-field col m4">
                                                                    <label class="active navy-text" for="txtFixedConv">Fixed Conveyance</label>
                                                                    <asp:TextBox ID="txtFixedConv" runat="server" ClientIDMode="Static" class="form-control onlyDecimal" MaxLength="15" placeholder=" " TabIndex="24" />
                                                                </div>
                                                                <div class="input-field col m4">
                                                                    <label class="active navy-text" for="txtFixedDA">Fixed D.A</label>
                                                                    <asp:TextBox ID="txtFixedDA" runat="server" ClientIDMode="Static" class="form-control onlyDecimal" MaxLength="15" placeholder=" " TabIndex="25" />
                                                                </div>
                                                                <div class="input-field col m4">
                                                                    <label class="active navy-text" for="txtFixedSpecial">Fixed Special Allow</label>
                                                                    <asp:TextBox ID="txtFixedSpecial" runat="server" ClientIDMode="Static" class="form-control onlyDecimal" MaxLength="15" placeholder=" " TabIndex="26" />
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="input-field col m4">
                                                                    ...
                                                                    <asp:TextBox ID="txtWorkingHours" runat="server" ClientIDMode="Static" class="form-control onlyDecimal" MaxLength="15" placeholder=" " TabIndex="29" />
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="input-field col m4">
