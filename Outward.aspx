...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function openProductSerialNo(pProdID, pRefNo, pProductName) {
            ...
            var t11 = jQuery("#txtOutwardNo").val();
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="input-field col m2">
                                    ...
                                    <asp:TextBox ID="txtOutwardDate" runat="server" class="form-control" ClientIDMode="Static" placeholder="" TabIndex="2" TextMode="Date" />
                                </div>
                                                ...
                                                <asp:Repeater ID="rptOutwardDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptOutwardDetail_ItemCommand" OnItemDataBound="rptOutwardDetail_ItemDataBound">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="text-left">
                                                                <a href="javascript:openProductInfo('view','<%# Eval("ProductID") %>');"><%# Eval("ProductNameLong") %></a>
                                                                <asp:HiddenField ID="edProductName" runat="server" ClientIDMode="Static" Value='<%# Eval("ProductName") %>' />
                                                            </td>
                                                            <td class="center-align">
                                                                <asp:TextBox CssClass="onlyDecimal" ID="edQuantity" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;" />
                                                            </td>
                                                            <td class="center-align">
                                                            ...
                                                            <td id="ITWeight" runat="server" class="center-align">
                                                                <asp:TextBox CssClass="onlyDecimal" ID="edQuantityWeight" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("QuantityWeight") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 120px; text-align: right;" />
                                                            </td>
                                                            <td class="center-align">
                                                    ...
                                                    <FooterTemplate>
                                                        <tr style="background-color: #dde8f3;">
                                                            ...
                                                            <td class="center-align">
                                                                <asp:TextBox ID="txtQuantity" runat="server" ClientIDMode="Static" CssClass="form-control onlyDecimal" Width="80" TabIndex="52" />
                                                            </td>
                                                            <td class="center-align">
                                                            ...
                                                            <td id="FTWeight" runat="server" class="center-align">
                                                                <asp:TextBox CssClass="onlyDecimal" ID="txtQuantityWeight" runat="server" ClientIDMode="Static" Width="120" TabIndex="54" />
                                                            </td>
                                                            <td class="center-align">
                                ...
                                <div id="pnl_Shipment" class="col m12 mt-1" runat="server" clientidmode="Static" enableviewstate="true" style="display: none;">
                                    ...
                                    <div class="row">
                                        <div class="input-field col m4">
                                            ...
                                            <asp:TextBox CssClass="onlyDecimal" ID="txtNetWeight" runat="server" class="form-control" ClientIDMode="Static" TabIndex="89" placeholder="" />
                                        </div>
                                        <div class="input-field col m4">
                                            <label class="active" for="txtGrossWeight">Gross Weight(KGs)</label>
                                            <asp:TextBox CssClass="onlyDecimal" ID="txtGrossWeight" runat="server" class="form-control" ClientIDMode="Static" TabIndex="90" placeholder="" />
                                        </div>
                                        <div class="input-field col m4">
