<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackingAssembly.aspx.cs" Inherits="StarsProject.PackingAssembly" %>
...
<body>
    <form id="frmOutwardAssembly" runat="server" autocomplete="off">
        ...
        <asp:HiddenField ID="hdnPackingNo" runat="server" ClientIDMode="Static" />
                                ...
                                <asp:Repeater ID="rptOutwardDetailAssembly" runat="server" ClientIDMode="Static" OnItemCommand="rptOutwardDetailAssembly_ItemCommand">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <asp:HiddenField ID="edAssemblyID" runat="server" ClientIDMode="Static" Value='<%# Eval("FinishProductID") %>' />
                                            <td class="text-left">
                                                <%# Eval("FinishProductName") %>
                                                <asp:HiddenField ID="edAssemblyName" runat="server" ClientIDMode="Static" Value='<%# Eval("FinishProductName") %>' />
                                            </td>
