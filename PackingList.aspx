<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackingList.aspx.cs" Inherits="StarsProject.PackingList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function openAssembly(pProdID) {
            var t11;
            t11 = jQuery("#txtPackingNo").val();
            var pageUrl = "PackingAssembly.aspx?PackingNo=" + t11 + "&ProductID=" + pProdID;
            $('#ifrModule').attr('src', pageUrl);
            $find("mpe").show();
        }
        ...
        function openProductSerialNo(pProdID, pRefNo, pProductName) {
            ...
            var t11 = jQuery("#txtPackingNo").val();
            var pageUrl = "ProductSerialNo.aspx?FromPage=outward&Module=Out&InvoiceNo=" + t11 + "&ProductID=" + pProdID + "&RefNo=" + pRefNo + "&ProductName=" + pProductName;
            $('#ifrModule').attr('src', pageUrl);
            $find("mpe").show();
        }
    </script>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="input-field col m2">
                                    <label class="active" for="txtPackingNo">Packing #</label>
                                    <asp:TextBox ID="txtPackingNo" runat="server" class="form-control" MaxLength="20" ClientIDMode="Static" TabIndex="1" ReadOnly="true" placeholder="" />
                                </div>
                                <div class="input-field col m2">
                                    <label class="active" for="txtOutwardDate">Packing Date <span class="materialize-red-text font-weight-800">*</span></label>
                                    <asp:TextBox ID="txtPackingDate" runat="server" class="form-control" ClientIDMode="Static" onkeypress="return false;" onpaste="return false" placeholder="" TabIndex="2" TextMode="Date" />
                                </div>
                                <div id="divCustomer" runat="server" class="input-field col m4">
                                ...
                                <div class="input-field col m2 hide">
                                    ...
                                    <asp:DropDownList ID="drpOrderStatus" runat="server" class="select2-size-sm browser-default" EnableViewState="true" ClientIDMode="Static" TabIndex="5" />
                                </div>
                            ...
                            <div class="row">
                                <div class="input-field col m2">
                                    <label class="active" for="txtManualPackingNo">Manual Outward #</label>
                                                <asp:TextBox ID="txtManualPackingNo" runat="server" class="form-control" MaxLength="20" ClientIDMode="Static" TabIndex="6"  placeholder=""/>
                                </div>
                            </div>
                            <%}%>
                            <div class="row">
                                <div class="col s12">
                                    <ul id="Ul1" class="tabs" runat="server" clientidmode="Static" enableviewstate="true" style="background-color: antiquewhite;">
                                        ...
                                        <li class="tab col m3 p-0"><a id="lnkTransport" class="left hide" href="#pnl_Transport">Transport Detail</a></li>
                                    </ul>
                                </div>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="center-align">
                                                                <asp:TextBox ID="edQuantity" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="edQuantity_TextChanged" Style="width: 80px; text-align: right;" />
                                                            </td>
                                                            <td class="center-align">
                                                            ...
                                                            <td class="center-align" style="width: 8%;">
                                                             ...
                                                             <% if(hdnProductWithSerialNo.Value == "yes") { %>
                                                                <td id="lnkSerial" runat="server" clientidmode="static" class="right-align width-5 hide">
