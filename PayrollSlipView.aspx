                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <%if (hdnSerialKey.Value != "HEMA-AUTO-SI08-NVRL")
                                                     {%>
                                                      ...
                                                      <%} %>
                                                        <div class="input-field col m6">
                                                            <label class="active" for="txtSpecial"> <% if (hdnSerialKey.Value == "HEMA-AUTO-SI08-NVRL") { %> Uniform Expenses <% } else {%> Special Allow. <%} %>  </label>
                                                    ...
                                                    <div class="row" style="padding: 15px 0px 0px 0px; width: 100%;">
                                                        <div class="input-field col m6">
                                                            <label class="active" for="txtOverTime"> <% if (hdnSerialKey.Value == "HEMA-AUTO-SI08-NVRL") { %> Mobile Expenses<% } else {%> O.T Allow. <%} %>  </label>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row" style="padding: 15px 0px 0px 0px; width: 100%;">
                                                        ...
                                                        <div class="input-field col m6">
                                                            <label class="active" for="txtTDS"> <% if (hdnSerialKey.Value == "HEMA-AUTO-SI08-NVRL") { %> Misc. Deduction <% } else {%> Tax Deduction Scheme <%} %> </label>
                                                    ...
                                                    <div class="row" style="padding: 15px 0px 0px 0px; width: 100%;">
                                                        <div class="input-field col m6">
                                                            <label class="active" for="txtPT"> <% if (hdnSerialKey.Value == "HEMA-AUTO-SI08-NVRL") { %> Medical Premium <% } else {%> Loan Installment/Upad <%} %> </label>
