<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerformaInvoice.aspx.cs" Inherits="StarsProject.PerformaInvoice" %>
                ...
                <ContentTemplate>
                                        ...
                                        <div class="col m12">
                                            <div class="row">
                                                <div class="input-field col m2">
                                                    <label class="active" for="txtOrderNo">Performa Invoice #</label>
                                                    <asp:TextBox ID="txtOrderNo" runat="server" class="form-control" ClientIDMode="Static" TabIndex="1" ReadOnly="true" placeholder="" />
                                                </div>
                                                <div class="input-field col m2">
                                                    <label class="active" for="txtOrderDate">PI Date <span class="materialize-red-text font-weight-800">*</span></label>
                                                ...
                                                <div class="row">
                                                    <table id="tblQuotationDetail" class="table responsive-table striped width-100">
                                                        <asp:Repeater ID="rptOrderDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptOrderDetail_ItemCommand" OnItemDataBound="rptOrderDetail_ItemDataBound">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr id="itemRow<%# Container.ItemIndex + 1 %>">
                                                                    ...
                                                                    <td class="text-center">
                                                                        <asp:TextBox ID="edUnit" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("Unit") %>' onblur='<%# String.Format("return editItem({0}, \"{1}\", \"{2}\");", Eval("pkID"), "Unit", (Container.ItemIndex+1).ToString()) %>' Style="width: 70px; text-align: right;" TabIndex="12"  />
                                                                    </td>
                                                                    <% if (hdnSerialKey.Value == "SA98-6HY9-HU67-LORF")
                                                                        { %>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox ID="edUnitQty" runat="server" ClientIDMode="Static" Text='<%# Eval("UnitQty") %>' onblur='<%# String.Format("return editItem({0}, \"{1}\", \"{2}\");", Eval("pkID"), "UnitQty", (Container.ItemIndex+1).ToString()) %>' Style="width: 70px; text-align: right;" TabIndex="14" />
                                                                    </td>
                                                                    <% } %>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox ID="edQuantity" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' onblur='<%# String.Format("return editItem({0}, \"{1}\", \"{2}\");", Eval("pkID"), "Quantity", (Container.ItemIndex+1).ToString()) %>' Style="width: 70px; text-align: right;" TabIndex="15" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox ID="edUnitRate" runat="server" ClientIDMode="Static" Text='<%# Eval("UnitRate") %>' onblur='<%# String.Format("return editItem({0}, \"{1}\", \"{2}\");", Eval("pkID"), "UnitRate", (Container.ItemIndex+1).ToString()) %>' Style="width: 70px; text-align: right;" TabIndex="16" />
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="edDiscountPercent" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountPercent") %>' onblur='<%# String.Format("return editItem({0}, \"{1}\", \"{2}\");", Eval("pkID"), "DiscountPercent", (Container.ItemIndex+1).ToString()) %>' Style="width: 50px; text-align: right;" TabIndex="17" />
                                                                    </td>
                                                                    <td class="right-align hide">
                                                                        <asp:TextBox ID="edDiscountAmt" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountAmt") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex="18" />
                                                                    </td>
                                                                    <td class="right-align hide">
                                                                    ...
                                                                    <td class="right-align width-5">
                                                                        ...
                                                                        <asp:TextBox ID="edTaxRate" runat="server" ClientIDMode="Static" Text='<%# Eval("TaxRate") %>' onblur='<%# String.Format("return editItem({0}, \"{1}\", \"{2}\");", Eval("pkID"), "TaxRate", (Container.ItemIndex+1).ToString()) %>' Style="width: 50px; text-align: right;" TabIndex="22" />
                                                                    </td>
                                                                    <td class="right-align width-7">
                                                                        ...
                                                                        <asp:TextBox ID="edTaxAmount" runat="server" ClientIDMode="Static" Text='<%# Eval("TaxAmount") %>' Style="width: 90px; text-align: right;" Enabled="false" TabIndex="23" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                        <asp:TextBox ID="edNetAmount" runat="server" ClientIDMode="Static" Text='<%# Eval("NetAmount") %>' Style="width: 90px; text-align: right;" Enabled="false" TabIndex="24" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                        <asp:TextBox ID="edDelDate" runat="server" ClientIDMode="Static" Text='<%# Eval("DeliveryDate","{0:yyyy-MM-dd}") %>' onblur='<%# String.Format("return editItem({0}, \"{1}\", \"{2}\");", Eval("pkID"), "DeliveryDate", (Container.ItemIndex+1).ToString()) %>' Style="width: 130px; text-align: right;" TabIndex="25" placeholder="" TextMode="Date"  /> 
                                                                    </td>
                                                                    <% if (hdnQuotationSpecification.Value.ToLower() == "yes")
                                                                        { %>
                                                            ...
                                                            <FooterTemplate>
                                                                <tr id="footerRow" style="background-color: #dde8f3; border-bottom: 5px solid navy;">
                                                                    <td class="left-align" style="width: 25%;">
                                                                    ...
                                                                    <% } %>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox ID="txtQuantity" runat="server" ClientIDMode="Static" Width="70" TabIndex="31" onblur="javascript:editFooter();" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox ID="txtUnitRate" runat="server" ClientIDMode="Static" Width="80" TabIndex="32" onblur="javascript:editFooter();" />
                                                                    </td>
                                                                    <td class="right-align">
                                                ...
                                                <div class="col m3">
                                                    ...
                                                    <table id="tblCharge" class="table responsive-table striped width-100" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td class="width-70">
                                                                    <asp:DropDownList ID="drpOthChrg1" runat="server" class="select2-theme browser-default" EnableViewState="true" ClientIDMode="Static" TabIndex="15" onchange='javascript:editItem(0, "", "0");' />
                                                                </td>
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt1" class="form-control inputOther" runat="server" ClientIDMode="Static" TabIndex="16" onblur='javascript:editItem(0, "", "0");' Style="text-align: right;" MaxLength="12" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                    <asp:DropDownList ID="drpOthChrg2" runat="server" class="select2-theme browser-default" EnableViewState="true" ClientIDMode="Static" TabIndex="17" onchange='javascript:editItem(0, "", "0");' />
                                                                </td>
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt2" class="form-control inputOther" runat="server" ClientIDMode="Static" TabIndex="18" onblur='javascript:editItem(0, "", "0");' Style="text-align: right;" MaxLength="12"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                    <asp:DropDownList ID="drpOthChrg3" runat="server" class="select2-theme browser-default" EnableViewState="true" ClientIDMode="Static" TabIndex="19" onchange='javascript:editItem(0, "", "0");' />
                                                                </td>
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt3" class="form-control inputOther" runat="server" ClientIDMode="Static" TabIndex="20" onblur='javascript:editItem(0, "", "0");' Style="text-align: right;" MaxLength="12"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                    <asp:DropDownList ID="drpOthChrg4" runat="server" class="select2-theme browser-default" EnableViewState="true" ClientIDMode="Static" TabIndex="21" onchange='javascript:editItem(0, "", "0");' MaxLength="12"/>
                                                                </td>
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt4" class="form-control inputOther" runat="server" ClientIDMode="Static" TabIndex="22" onblur='javascript:editItem(0, "", "0");' Style="text-align: right;" MaxLength="12"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                    <asp:DropDownList ID="drpOthChrg5" runat="server" class="select2-theme browser-default" EnableViewState="true" ClientIDMode="Static" TabIndex="23" onchange='javascript:editItem(0, "", "0");' />
                                                                </td>
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt5" class="form-control inputOther" runat="server" ClientIDMode="Static" TabIndex="24" onblur='javascript:editItem(0, "", "0");' Style="text-align: right;" MaxLength="12"/>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table id="tblSummary" class="table responsive-table striped" border="0">
                                                        <tbody>
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtHeadDiscount" class="form-control inputCalc" runat="server" ClientIDMode="Static" TabIndex="25" onblur='<%# String.Format("return editItem({0}, \"{1}\", \"{2}\");", 0, "", 0) %>' MaxLength="12"/>
                                                                </td>
                                                            </tr>
                                        ...
                                        <div id="pnl_Email" class="col m12 mt-1" runat="server" clientidmode="Static" enableviewstate="true" style="display: none;">
                                            ...
                                            <div class="row">
                                                <div class="input-field col m2">
                                                    ...
                                                    <asp:DropDownList ID="drpEmailCategory" runat="server" ClientIDMode="Static" class="select2-theme browser-default" EnableViewState="true" TabIndex="34" Width="200px" AutoPostBack="true" OnSelectedIndexChanged="drpEmailCategory_SelectedIndexChanged" />
                                                </div>
                    ...
                    <script type="text/javascript">
                        ...
                        function editItem(id, fldName, element) {
                            var ctrlValue = event.target.value.toString();
                            // ---------------------------------------------------------
                            if (ctrlValue == null || ctrlValue == '') {
                                if (fldName != 'Unit' && fldName != 'DeliDate') {
                                    var tmpName = "";
                                    ctrlValue = "0.00";

                                    if (parseInt(element) < 10)
                                        tmpName = "rptQuotationDetail$ctl0" + element + "$ed" + fldName;
                                    else
                                        tmpName = "rptQuotationDetail$ctl" + element + "$ed" + fldName;
                                    // ----------------------------------------------------------------
                                    document.getElementsByName(tmpName)[0].value = "0.00";
                                }
                            }
                            // ---------------------------------------------------------
                            var custstateid = $("#hdnCustStateID").val();
                            var OthChrg1, OthChrg2, OthChrg3, OthChrg4, OthChrg5;
                            var OthAmt1, OthAmt2, OthAmt3, OthAmt4, OthAmt5;

                            var hdamt = $("#txtHeadDiscount").val();

                            OthChrg1 = $("#drpOthChrg1").val();
                            if ($("#drpOthChrg1").val() == '' || $("#drpOthChrg1").val() == '0')
                                OthAmt1 = '0';
                            else 
                                OthAmt1 = $("#txtOthChrgAmt1").val();


                            OthChrg2 = $("#drpOthChrg2").val();
                            if ($("#drpOthChrg2").val() == '' || $("#drpOthChrg2").val() == '0')
                                OthAmt2 = '0';
                            else
                                OthAmt2 = $("#txtOthChrgAmt2").val();

                            OthChrg3 = $("#drpOthChrg3").val();
                            if ($("#drpOthChrg3").val() == '' || $("#drpOthChrg3").val() == '0')
                                OthAmt3 = '0';
                            else
                                OthAmt3 = $("#txtOthChrgAmt3").val();

                            OthChrg4 = $("#drpOthChrg4").val();
                            if ($("#drpOthChrg4").val() == '' || $("#drpOthChrg4").val() == '0')
                                OthAmt4 = '0';
                            else
                                OthAmt4 = $("#txtOthChrgAmt4").val();

                            OthChrg5 = $("#drpOthChrg5").val();
                            if ($("#drpOthChrg5").val() == '' || $("#drpOthChrg5").val() == '0')
                                OthAmt5 = '0';
                            else
                                OthAmt5 = $("#txtOthChrgAmt5").val();
                            // -----------------------------------------------------------------------------------------------------
                            var xHeadDis = 0;
                            xHeadDis = (($("#txtHeadDiscount").val() != '') ? $("#txtHeadDiscount").val() : "0")
                            // -----------------------------------------------------------------------------------------------------
                            var link = 'PerformaInvoice.aspx/AutoSaveDetail'
                            var myUrl = '{pID:' + id.toString() + ', pFieldName:\'' + fldName + '\', pFieldValue:\'' + ctrlValue + '\', pCustStateID:\'' + custstateid +
                                    '\', pHeaderDiscAmt:\'' + xHeadDis + '\',' +
                                    ' OthChrg1:\'' + OthChrg1 + '\',' + ' OthAmt1:\'' + OthAmt1 + '\',' +
                                    ' OthChrg2:\'' + OthChrg2 + '\',' + ' OthAmt2:\'' + OthAmt2 + '\',' +
                                    ' OthChrg3:\'' + OthChrg3 + '\',' + ' OthAmt3:\'' + OthAmt3 + '\',' +
                                    ' OthChrg4:\'' + OthChrg4 + '\',' + ' OthAmt4:\'' + OthAmt4 + '\',' +
                                    ' OthChrg5:\'' + OthChrg5 + '\',' + ' OthAmt5:\'' + OthAmt5 + '\' }';
                            ...
                            jQuery.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    // ---------------------------------------------------------------------------
                                    var myrow = $('#itemRow' + element.toString());

                                    myrow.find("#edAmount").val(resultdata[0].rowAmount.toFixed(2).toString());
                                    myrow.find("#edTaxAmount").val(resultdata[0].rowTaxAmount.toFixed(2).toString());
                                    myrow.find("#edNetAmount").val(resultdata[0].rowNetAmount.toFixed(2).toString());
                                    // ---------------------------------------------------------------------------
                                    var totcgst, totsgst, totigst, totbasic

                                    totcgst = resultdata[0].totCGST;
                                    totsgst = resultdata[0].totSGST;
                                    totigst = resultdata[0].totIGST;
                                    totbasic = resultdata[0].totAmount;
                                    totnetamt = resultdata[0].totNetAmount;
                                    // ---------------------------------------------------------------------------
                                    $("#hdnOthChrgGST1").val(resultdata[0].OthChrgGST1.toString());
                                    $("#hdnOthChrgBasic1").val(resultdata[0].OthChrgBasic1.toString());

                                    $("#hdnOthChrgGST2").val(resultdata[0].OthChrgGST2.toString());
                                    $("#hdnOthChrgBasic2").val(resultdata[0].OthChrgBasic2.toString());

                                    $("#hdnOthChrgGST3").val(resultdata[0].OthChrgGST3.toString());
                                    $("#hdnOthChrgBasic3").val(resultdata[0].OthChrgBasic3.toString());

                                    $("#hdnOthChrgGST4").val(resultdata[0].OthChrgGST4.toString());
                                    $("#hdnOthChrgBasic4").val(resultdata[0].OthChrgBasic4.toString());

                                    $("#hdnOthChrgGST5").val(resultdata[0].OthChrgGST5.toString());
                                    $("#hdnOthChrgBasic5").val(resultdata[0].OthChrgBasic5.toString());

                                    // ---------------------------------------------------------------------------
                                    $("#hdnTotCGSTAmt").val(parseFloat(totcgst).toFixed(2).toString());
                                    $("#hdnTotSGSTAmt").val(parseFloat(totsgst).toFixed(2).toString());
                                    $("#hdnTotIGSTAmt").val(parseFloat(totigst).toFixed(2).toString());

                                    $("#txtTotOthChrgBeforeGST").val(
                                                                  (((parseFloat($("#hdnOthChrgGST1").val()) <= 0) ? 0 : (parseFloat($("#hdnOthChrgBasic1").val()))) +
                                                                  ((parseFloat($("#hdnOthChrgGST2").val()) <= 0) ? 0 : (parseFloat($("#hdnOthChrgBasic2").val()))) +
                                                                  ((parseFloat($("#hdnOthChrgGST3").val()) <= 0) ? 0 : (parseFloat($("#hdnOthChrgBasic3").val()))) +
                                                                  ((parseFloat($("#hdnOthChrgGST4").val()) <= 0) ? 0 : (parseFloat($("#hdnOthChrgBasic4").val()))) +
                                                                  ((parseFloat($("#hdnOthChrgGST5").val()) <= 0) ? 0 : (parseFloat($("#hdnOthChrgBasic5").val())))
                                                                  ).toFixed(2).toString());

                                    $("#txtTotBasicAmt").val(parseFloat(totbasic).toFixed(2).toString());

                                    $("#hdnTotItemGST").val((parseFloat(totcgst) + parseFloat(totsgst) + parseFloat(totigst)).toFixed(2).toString());
                                    $("#txtTotGST").val((parseFloat($("#hdnTotCGSTAmt").val()) + parseFloat($("#hdnTotSGSTAmt").val()) + parseFloat($("#hdnTotIGSTAmt").val()) +
                                                      parseFloat($("#hdnOthChrgGST1").val()) + parseFloat($("#hdnOthChrgGST2").val()) + parseFloat($("#hdnOthChrgGST3").val()) +
                                                      parseFloat($("#hdnOthChrgGST4").val()) + parseFloat($("#hdnOthChrgGST5").val())).toFixed(2).toString());

                                    $("#txtTotOthChrgAfterGST").val(
                                                                  (((parseFloat($("#hdnOthChrgGST1").val()) <= 0) ? 0 : (parseFloat($("#hdnOthChrgBasic1").val()))) +
                                                                  ((parseFloat($("#hdnOthChrgGST2").val()) <= 0) ? 0 : (parseFloat($("#hdnOthChrgBasic2").val()))) +
                                                                  ((parseFloat($("#hdnOthChrgGST3").val()) <= 0) ? 0 : (parseFloat($("#hdnOthChrgBasic3").val()))) +
                                                                  ((parseFloat($("#hdnOthChrgGST4").val()) <= 0) ? 0 : (parseFloat($("#hdnOthChrgBasic4").val()))) +
                                    ...
                                    var NetAmt = 0;
                                    NetAmt = (parseFloat(totnetamt) + (parseFloat($("#hdnOthChrgGST1").val())) - xHeadDis
                                                                    + (parseFloat($("#hdnOthChrgGST2").val())) + (parseFloat($("#hdnOthChrgGST3").val())) + (parseFloat($("#hdnOthChrgGST4").val()))
                                                                    + (parseFloat($("#hdnOthChrgGST5").val())) + (parseFloat($("#hdnOthChrgBasic1").val())) + (parseFloat($("#hdnOthChrgBasic2").val()))
                                                                    + (parseFloat($("#hdnOthChrgBasic3").val())) + (parseFloat($("#hdnOthChrgBasic4").val())) + (parseFloat($("#hdnOthChrgBasic5").val()))
                                            );

                                    $("#txtTotNetAmt").val(Math.round(NetAmt).toFixed(2).toString());
                                    $("#txtRoff").val((parseFloat(Math.round(NetAmt).toFixed(2)) - NetAmt).toFixed(2));
                                },
                                error: function (r) { alert('Error : ' + r.responseText); },
                                failure: function (r) { alert('failure'); }
                            });
                        ...
                        function editFooter() {
                            ...
                            var myrow = $('#footerRow');
                            var pTaxType = 0, pQty = 0, pRate = 0, pDisPer = 0, pTaxPer = 0;

                            if (myrow.find("#hdnTaxType").val() != '')
                                pTaxType = parseFloat(myrow.find("#hdnTaxType").val());

                            if (myrow.find("#txtQuantity").val() != '')
                                pQty = parseFloat(myrow.find("#txtQuantity").val());

                            if (myrow.find("#txtUnitRate").val() != '')
                                pRate = parseFloat(myrow.find("#txtUnitRate").val());

                            if (myrow.find("#txtDiscountPercent").val() != '')
                                pDisPer = parseFloat(myrow.find("#txtDiscountPercent").val());

                            if (myrow.find("#txtTaxRate").val() != '')
                                pTaxPer = parseFloat(myrow.find("#txtTaxRate").val());
                            // -----------------------------------------------------------------------------
                            var link = 'PerformaInvoice.aspx/AutoSaveFooterDetail'
                            var myUrl = '{pCustStateID:\'' + custstateid + '\',' +
                                        ' pTaxType:' + pTaxType.toString() + ',' +
                                        ' pQty:' + pQty.toString() + ',' +
                                        ' pRate:' + pRate.toString() + ',' +
                                        ' pDisPer:' + pDisPer.toString() + ',' +
                                        ' pTaxPer:' + pTaxPer.toString() +
                                        '}';
                            jQuery.ajax({
                                type: "POST",
                                url: link,
                                ...
                                success: function (data) {
                                    ...
                                    myrow.find("#txtAmount").val(resultdata[0].rowAmount.toFixed(2).toString());
                                    myrow.find("#txtTaxAmount").val(resultdata[0].rowTaxAmount.toFixed(2).toString());
                                    myrow.find("#txtNetAmount").val(resultdata[0].rowNetAmount.toFixed(2).toString());
                                },
                                error: function (r) { alert('Error : ' + r.responseText); },
                                failure: function (r) { alert('failure'); }
                            });
