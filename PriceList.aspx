                                                ...
                                                <FooterTemplate>
                                                    <tr>
                                                        <td class="left-align" style="width: 25%;">
                                                            ...
                                                            <asp:TextBox ID="txtProductName"  runat="server" ClientIDMode="Static" class="form-control" MaxLength="150" onKeyup="bindDDLProductTo('#txtProductName')" Width="100%" TabIndex="2" AutoPostBack="true" OnTextChanged="txtProductName_TextChanged" />
                                                        </td>
