            ...
            <div id="myModal" style="display:block; width:100%;">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="input-field col m12">
                                <label class="active required" for="txtProductGroupSpecs">Product Group Specification</label>
                                <asp:TextBox ID="txtProductGroupSpecs" runat="server" class="form-control" TextMode="MultiLine" ClientIDMode="Static" TabIndex="2" />
                            </div>
                        </div>                                                    
                        <div class="row">
