<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductSubAssemblySync.aspx.cs" Inherits="StarsProject.ProductSubAssemblySync" %>
...
<body>
    <form id="frmOutwardAssembly" runat="server" autocomplete="off">
        ...
        <asp:HiddenField ID="hdnSubFinishProductID" runat="server" ClientIDMode="Static" />
                                ...
                                <asp:Repeater ID="rptQuotationAssembly" runat="server" ClientIDMode="Static" OnItemCommand="rptQuotationAssembly_ItemCommand">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <asp:HiddenField ID="edSubFinishProductID" runat="server" ClientIDMode="Static" Value='<%# Eval("SubFinishProductID") %>' />
