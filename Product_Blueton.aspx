<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Product_Blueton.aspx.cs" Inherits="StarsProject.Product_Blueton" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        /*---------------------------------------------------------*/
        $(function () {
            var tabName = $("[id*=hdnCurrentTab]").val() != "" ? $("[id*=hdnCurrentTab]").val() : "prodsize";
            $("#myTab a").click(function () {
                var prevTab = $("[id*=hdnCurrentTab]").val() != "" ? $("[id*=hdnCurrentTab]").val() : "prodsize";
        ...
        function retainTabPosition() {
            ...
            // --------------------------------------------------- 
            if ($("#hdnCurrentTab").val() == 'prodsize') {
            //alert('3')
                $('#lnkprodsize').addClass('active');
                $('#prodsize').css("display", "block");
            }
            else if ($("#hdnCurrentTab").val() == 'prodspecs') {
                //alert('1')
...
<body class="loginpage">
    <form id="frmProduct" runat="server" autocomplete="off">
        ...
        <asp:HiddenField ID="hdnCurrentTab" runat="server" ClientIDMode="Static" Value="prodsize" EnableViewState="true" />
                        ...
                        <div class="row">
                            <div class="input-field col m5">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="input-field col m4 hide">
                                        <asp:TextBox ID="txtUnitQuantity" runat="server" class="form-control" Enabled="false" ClientIDMode="Static" Placeholder="" TabIndex="9"  MaxLength="5"/>
                                ...
                                <div id="dvCeraBox" runat="server" clientidmode="Static" class="row hide">
                                    <div class="input-field col m3">
                                        ...
                                        <div class="card-content card-border-gray" style="height:500px;padding-top: 5px;">
                                            <div class="row">
                                                <ul id="myTab" class="tabs card-border-gray" runat="server" clientidmode="Static" enableviewstate="true">
                                                    <li class="tab col m2 p-0"><a id="lnkprodsize" class="left active" href="#prodsize" tabindex="37">Size</a></li>                                                   
                                                    <li class="tab col m2.5 p-0 hide"><a id="lnkprodspecs" class="left" href="#prodspecs" tabindex="23">Specification</a></li>
                                                    <li class="tab col m2.5 p-0 hide"><a id="lnkshortdesc" class="left" href="#shortdesc" tabindex="35">Short Description</a></li>
                                                    <li class="tab col m2 p-0 hide"><a id="lnkproddetail" class="left" href="#proddetail" tabindex="37">Assembly</a></li>
                                                    <li class="tab col m2 p-0 hide"><a id="lnkprodacc" class="left" href="#prodacc" tabindex="41">Accessories</a></li>                                                    
                                                    <li id="liBrochure" runat="server" class="tab col m2.5 p-0 hide"><a id="lnkproddocs" class="left" href="#proddocs" tabindex="44" >Brochure</a></li>
                                                    <li id="liProdImages" runat="server" class="tab col m2.5 p-0 hide"><a id="lnkprodimg" class="left" href="#prodimg" tabindex="46">Image Gallery</a></li>
                                                </ul>
                                            </div>
                                                <div id="prodsize" class="row" runat="server" clientidmode="Static" enableviewstate="true" style="display:block;">
                                            ...
                                            <div id="prodspecs" class="row " runat="server" clientidmode="Static" enableviewstate="true" style="display:none;">
                                                <div class="input-field col m12" style="height:400px; overflow-y:auto;">
                                                                            ...
                                                                            <asp:Repeater ID="rptProductSpecs" runat="server" ClientIDMode="Static" OnItemDataBound="rptProductSpecs_ItemDataBound" OnItemCommand="rptProductSpecs_ItemCommand">
                                                                                ...
                                                                                <ItemTemplate>                                                                    
                                                                                    <tr class="blueShed">
                                                                                        ...
                                                                                        <td class="center-align">
                                                                                            <asp:TextBox class="form-control center" ID="newGroupHead" runat="server" ClientIDMode="Static" TabIndex="25" Text='<%# Eval("GroupHead") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" />
                                                                                        </td>
                                                                                        <td class="center-align">
                                                                                            <asp:TextBox class="form-control center" ID="newMaterialHead" runat="server" ClientIDMode="Static" TabIndex="26" Text='<%# Eval("MaterialHead") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" />
                                                                                        </td>
                                                                                        <td class="center-align">
                                                                                            <asp:TextBox class="form-control center" ID="newMaterialSpec" runat="server" ClientIDMode="Static" TabIndex="27" Text='<%# Eval("MaterialSpec") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" />
                                                                                        </td>
                                                                                        <td class="center-align">
                                                                                    ...
                                                                                    <tr class="blueShed">
                                                                                        <td class="center-align" colspan="3">
                                                                                            <asp:TextBox class="form-control center" ID="newMaterialRemarks" runat="server" ClientIDMode="Static" TabIndex="28" Text='<%# Eval("MaterialRemarks") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged"/>
                                                                                        </td>
                                                                                    </tr>
                                                                                </ItemTemplate>
                                                                            </asp:Repeater>
...
<%--                                                                </div>
                        ...
                        <div class="row border-radius-5 hide" style="border:2px solid navy;">
