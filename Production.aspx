                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div runat="server" clientidmode="Static" class="input-field col m1">
                                            ...
                                            <asp:TextBox ID="txtQuantity" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" class="form-control" AutoPostBack="true" OnTextChanged="txtQuantity_TextChanged" TabIndex="12" Width="95%" PlaceHolder=""/>
                                        </div>
                                                        ...
                                                        <asp:Repeater ID="rptPro" runat="server" ClientIDMode="Static" OnItemCommand="rptPro_ItemCommand" OnItemDataBound="rptPro_ItemDataBound">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td class="center-align width-10">
                                                                        <asp:TextBox ID="edQuantity" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>'  Style="width: 80px; text-align: center;" AutoPostBack="true" OnTextChanged="editItem_TextChanged" TabIndex="6"/>
                                                                    </td>
                                                                    <td class="center-align width-10">
                                                            ...
                                                            <FooterTemplate>
                                                                <tr style="background-color: #dde8f3;">
                                                                    ...
                                                                    <td class="center-align width-10">
                                                                        <asp:TextBox ID="txtQuantity"  MaxLength="15" runat="server" ClientIDMode="Static" CssClass="form-control onlyDecimal" Width="80" TabIndex="18" />
                                                                    </td>
                                                                    <td class="center-align width-10">
