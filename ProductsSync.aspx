<%@ Page Title="" Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="ProductsSync.aspx.cs" Inherits="StarsProject.ProductsSync" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function openAssembly(FProdID,SubFProdID) {
            var t11;
            t11 = jQuery("#txtQuotationNo").val();
            var pageUrl = "ProductSubAssemblySync.aspx?FinishProductID=" + FProdID + "&SubFinishProductID=" + SubFProdID;
                                                    ...
                                                    <div class="input-field col m12" style="height:400px; overflow-y:auto;">
                                                        <table class="stdtable" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <asp:Repeater ID="rptProductDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptProductDetail_ItemCommand">
                                                                <HeaderTemplate>
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th class="center-align" >Unit Qty.</th>
                                                                            <th class="center-align" >Feeder Qty.</th>
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr class="blueShed">
                                                                        <asp:HiddenField ID="detailProductID" runat="server" ClientIDMode="Static" Value='<%# Eval("ProductID")%>' />
                                                                        <td class="left-align" ><%# Eval("ProductName")%> 
                                                                            <br><a id="openAssembly" style="background-color:darkblue;color:white;border-radius:10px;padding-right:10px;padding-left:10px;" onclick="openAssembly(' <%# hdnpkID.Value %>','<%# Eval("ProductID") %>');" >Assembly</a>
                                                                        </td>
                                                                        <td class="center-align">
                                                                            <asp:TextBox class="form-control" Text='<%# Eval("CatNo")%>' ID="detailCatNo" runat="server" ClientIDMode="Static" Width="100px" TabIndex="40" style="display:inline-block;vertical-align:central;" AutoPostBack="true" OnTextChanged="detailFQuantity_TextChanged" />
                                                                        </td>
                                                                        <td class="center-align">
                                                                            <asp:TextBox class="form-control" Text='<%# Eval("Rating")%>' ID="detailRating" runat="server" ClientIDMode="Static" Width="100px" TabIndex="40" style="display:inline-block;vertical-align:central;" AutoPostBack="true" OnTextChanged="detailFQuantity_TextChanged" />
                                                                        </td>
                                                                        <td class="center-align">
                                                                            <asp:TextBox class="form-control" Text='<%# Eval("FeederQuantity")%>' ID="detailFQuantity" runat="server" ClientIDMode="Static" Width="50px" TabIndex="40" style="display:inline-block;vertical-align:central;" AutoPostBack="true" OnTextChanged="detailFQuantity_TextChanged" />
                                                                        </td>
                                                                        <td class="center-align">
                                                                            <asp:TextBox class="form-control" Text='<%# Eval("UnitQuantity")%>' ID="detailUQuantity" runat="server" ClientIDMode="Static" Width="50px" TabIndex="40" style="display:inline-block;vertical-align:central;" AutoPostBack="true" OnTextChanged="detailFQuantity_TextChanged" />
                                                                        </td>
                                                                        <td class="center-align">
                                                                            <asp:Label ID ="detailQty" runat="server" ClientIDMode="Static" > <%# Eval("Quantity")%> </asp:Label>
                                                                        </td>
                                                                        <td class="center-align">
                                                                            <asp:TextBox class="form-control" Text='<%# Eval("Rate")%>' ID="detailRate" runat="server" ClientIDMode="Static" Width="50px" TabIndex="40" style="display:inline-block;"  AutoPostBack="true" OnTextChanged="detailFQuantity_TextChanged" />
                                                                        </td>
                                                                        <td class="center-align">
                                                                            <asp:Label ID ="detailAmt" runat="server" ClientIDMode="Static" > <%# Eval("Amount")%> </asp:Label>
                                                                        </td>
                                                                        <td class="center-align">
                                                            ...
                                                            <tr class="blueShed">
                                                                ...
                                                                <td class="left-align">
                                                                    <asp:TextBox class="form-control" ID="newProductName" runat="server" ClientIDMode="Static" TabIndex="38" AutoPostBack="true" onKeyup="bindDDLProductTo('#newProductName')" placeholder="Min. 3 Char. To Search Product ..." OnTextChanged="newProductName_TextChanged" />
                                                                </td>
                                                                <td class="center-align">
                                                                    <asp:TextBox class="form-control" ID="newCatNo" runat="server" ClientIDMode="Static" Width="100px" TabIndex="39" style="display:inline-block;" />
                                                                </td>
                                                                <td class="center-align">
                                                                    <asp:TextBox class="form-control" ID="newRating" runat="server" ClientIDMode="Static" Width="100px" TabIndex="40" style="display:inline-block;" />
                                                                </td>
                                                                <td class="center-align">
                                                                    <asp:TextBox class="form-control" ID="newUnitQuantity" runat="server" ClientIDMode="Static" Width="50px" TabIndex="40" style="display:inline-block;" AutoPostBack="true" OnTextChanged="newFeederQuantity_TextChanged" />
                                                                </td>
                                                                <td class="center-align">
                                                                    <asp:TextBox class="form-control" ID="newFeederQuantity" runat="server" ClientIDMode="Static" Width="50px" TabIndex="40" style="display:inline-block;" AutoPostBack="true" OnTextChanged="newFeederQuantity_TextChanged" />
                                                                </td>
                                                                <td class="center-align">
                                                                    <asp:TextBox class="form-control" ID="newQuantity" runat="server" ClientIDMode="Static" Width="50px" TabIndex="40" style="display:inline-block;" ReadOnly="true" />
                                                                </td>
                                                                <td class="center-align">
                                                                    <asp:TextBox class="form-control" ID="newRate" runat="server" ClientIDMode="Static" Width="50px" TabIndex="40" style="display:inline-block;"  ReadOnly="true" />
                                                                </td>
                                                                <td class="center-align">
                                                                    <asp:TextBox class="form-control" ID="newAmount" runat="server" ClientIDMode="Static" Width="50px" TabIndex="40" style="display:inline-block;" />
                                                                </td>
                                                                <td class="center-align">
