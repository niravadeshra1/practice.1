                                                ...
                                                <table class="stdtable" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    ...
                                                    <tr class="blueShed">
                                                        ...
                                                        <td class="text-center center-align width-10">
                                                            <asp:TextBox ID="txtQuantity2" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="80" TabIndex="10" />
                                                        </td>
                                            ...
                                            <asp:Repeater ID="rptProject" runat="server" ClientIDMode="Static" OnItemCommand="rptProject_ItemCommand" OnItemDataBound="rptProject_ItemDataBound">
                                                ...
                                                <ItemTemplate>
                                                    <tr class="blueShed">
                                                        ...
                                                        <td class="text-center center-align width-20">
                                                            <asp:TextBox id="tdSysCapacity" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text = '<%# Eval("SysCapacity") %>' width="120"></asp:TextBox>
                                                        </td>
                                                        <td class="text-center center-align width-20">
                                                            <asp:TextBox id="tdPanalWattage" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text = '<%# Eval("PanalWattage") %>' width="120"></asp:TextBox>
                                                        </td>
                                                        <td class="text-center center-align width-10">
                                                ...
                                                <FooterTemplate>
                                                    <tr style="padding: 5px;">
                                                        ...
                                                        <td class="text-center center-align width-20">
                                                            <asp:TextBox ID="txtSysCapacity" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="120" TabIndex="15" />
                                                        </td>
                                                        <td class="text-center center-align width-20">
                                                            <asp:TextBox ID="txtPanalWattage" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="120" TabIndex="12" />
                                                        </td>
                                                        <td class="text-center center-align width-10">
                                                            <asp:ImageButton ID="imgBtnSave" runat="server" ClientIDMode="Static" ImageUrl="~/images/expand.png" ToolTip="Add Item" CommandName="Save" CommandArgument='0' Width="20" Height="20" TabIndex="13" />
                                                        </td>
