...
<%--            <asp:UpdatePanel ID="upUserPanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>--%>
                ...
                <div class="widgetbox">
                    ...
                    <asp:HiddenField ID="hdnPurchaseBillCurrency" runat="server" ClientIDMode="Static" Value="No" />
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col m8">
                                        ...
                                        <% if (hdnPurchaseBillCurrency.Value.ToLower() == "yes" || hdnPurchaseBillCurrency.Value.ToLower() == "y")
                                            { %>
                                        <div class="input-field col m2">
                                ...
                                <div class="row">
                                    <div class="col m12">
                                        <ul id="Ul1" class="tabs" runat="server" clientidmode="Static" enableviewstate="true" style="background-color:antiquewhite; color:navy;">
                                            ...
                                            <li class="tab col m3 p-0"><a id="lnkTNC" class="left" href="#pnl_TNC" tabindex="51">Terms & Conditions</a></li>
                                                    ...
                                                    <asp:Repeater ID="rptOrderDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptOrderDetail_ItemCommand" OnItemDataBound="rptOrderDetail_ItemDataBound">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td class="right-align width-7">
                                                                    <asp:TextBox CssClass="onlyDecimal" ID="edQuantity" runat="server" ClientIDMode="Static" Text='<%# Eval("Qty") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex="62" />
                                                                </td>
                                                                ...
                                                                <td class="right-align width-6">
                                                                    <asp:TextBox CssClass="onlyDecimal" ID="edUnitRate" runat="server" ClientIDMode="Static" Text='<%# Eval("Rate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;"  TabIndex="64"/>
                                                                </td>
                                                                <td class="text-right width-5">
                                                                    <asp:TextBox CssClass="onlyDecimal" ID="edDiscountPercent" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountPer") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 60px; text-align: right;" TabIndex="65" />
                                                                </td>
                                                                ...
                                                                <td class="right-align width-5">
                                                                    ...
                                                                    <asp:TextBox CssClass="onlyDecimal" ID="edTaxRate" runat="server" ClientIDMode="Static" Text='<%# (Eval("TaxRate") ) %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="70"/>
                                                                </td>
                                                                <td class="right-align width-7">
                                                                ...
                                                                <td class="right-align width-5">
                                                                    <asp:TextBox CssClass="onlyDecimal" ID="edAddTaxPer" runat="server" ClientIDMode="Static" Text='<%# Eval("AddTaxPer") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="72" />
                                                                </td>
                                                                <td class="right-align width-7">
                                                        ...
                                                        <FooterTemplate>
                                                            <tr style="background-color: #dde8f3;">
                                                                ...
                                                                <td class="right-align width-7">
                                                                    <asp:TextBox CssClass="onlyDecimal" ID="txtQuantity" runat="server" ClientIDMode="Static" Width="70" TabIndex="18" AutoPostBack="true" OnTextChanged="txtQuantity_TextChanged" MaxLength="10"/>
                                                                </td>
                                                                <td class="right-align width-5">
                                                                ...
                                                                <td class="text-right width-5">
                                                                    <asp:TextBox CssClass="onlyDecimal" ID="txtDiscountPercent" runat="server" ClientIDMode="Static" Width="60" TabIndex="21" AutoPostBack="true" OnTextChanged="txtDiscountPercent_TextChanged" MaxLength="12"/>
                                                                </td>
                                                                <td class="text-right width-6">
                                                                ...
                                                                <td class="right-align width-5">
                                                                    ...
                                                                    <asp:TextBox CssClass="onlyDecimal" ID="txtTaxRate" runat="server" ClientIDMode="Static" Width="50" TabIndex="26" AutoPostBack="true" OnTextChanged="txtTaxRate_TextChanged" />
                                                                </td>
                                                                <td class="right-align width-7">
                                                        ...
                                                        <table id="tblCharge" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="width-30">
                                                                        <asp:TextBox ID="txtOthChrgAmt1" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="34" AutoPostBack="true" OnTextChanged="txtOthChrgAmt1_TextChanged" Style="text-align: right;" MaxLength="12" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="width-70">
                                                                    ...
                                                                    <td class="width-30">
                                                                        <asp:TextBox ID="txtOthChrgAmt2" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="36" AutoPostBack="true" OnTextChanged="txtOthChrgAmt2_TextChanged" Style="text-align: right;" MaxLength="12"/>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="width-70">
                                                                    ...
                                                                    <td class="width-30">
                                                                        <asp:TextBox ID="txtOthChrgAmt3" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="38" AutoPostBack="true" OnTextChanged="txtOthChrgAmt3_TextChanged" Style="text-align: right;" MaxLength="12"/>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="width-70">
                                                                    ...
                                                                    <td class="width-30">
                                                                        <asp:TextBox ID="txtOthChrgAmt4" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="40" AutoPostBack="true" OnTextChanged="txtOthChrgAmt4_TextChanged" Style="text-align: right;" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="width-70">
                                                                    ...
                                                                    <td class="width-30">
                                                                        <asp:TextBox ID="txtOthChrgAmt5" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="42" AutoPostBack="true" OnTextChanged="txtOthChrgAmt5_TextChanged" Style="text-align: right;" MaxLength="12" />
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <table id="tblSummary" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <tbody>
                                                                <tr class="border-none">
                                                                    ...
                                                                    <td class="width-20">
                                                                        <asp:TextBox ID="txtHeadDiscount" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="43" AutoPostBack="true" OnTextChanged="txtHeadDiscount_TextChanged" MaxLength="12" />
                                                                    </td>
                                                                </tr>
                                                                <tr class="border-none">
