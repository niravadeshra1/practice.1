<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseQuotation.aspx.cs" Inherits="StarsProject.PurchaseQuotation" %>
...
<%--    <script type="text/javascript" src="app-assets/js/scripts/form-select2.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function openCustomerInfo(cat) {
            var keyid = (cat == 'view' || cat == 'edit') ? jQuery('#hdnCustomerID').val() : "0";
            var pageUrl = (cat == 'view') ? "customers.aspx?mode=view&id=" + keyid : (cat == 'edit') ? "customers.aspx?mode=edit&id=" + keyid : "customers.aspx?mode=view&id=0";
                            ...
                            <div class="row">
                                <div class="col m12">
                                    <div class="row">
                                        ...
                                        <div id="divLoad1" runat="server" clientidmode="Static" class="input-field col m2 hide">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col m2 hide">
                                            ...
                                            <asp:TextBox ID="txtExchangeRate" runat="server" MaxLength="15" placeholder="" class="form-control onlyDecimal" ClientIDMode="Static" TabIndex="8" />
                                        </div>
                                        <% } %>
                                        <div class="input-field col m2 ">
                                        ...
                                        <div class="input-field col m2 hide">
                                            ...
                                            <asp:TextBox ID="txtCreditDays" runat="server" placeholder="" MaxLength="20" class="form-control onlyNumeric" ClientIDMode="Static" TabIndex="4" Style="width: 150px;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col s12">
                                            <ul id="myTab" class="tabs" runat="server" clientidmode="Static" enableviewstate="true" style="background-color: antiquewhite;">
                                                ...
                                                <li class="tab col m2 p-0"><a id="lnkEmail" class="left hide" href="#pnl_Email">Email Content</a></li>
                                                <li class="tab col m2 p-0"><a id="lnkFollowUp" class="left hide" href="#pnl_FollowUp">Follow Up</a></li>
                                                <li class="tab col m2 p-0"><a id="lnkAssumption" class="left hide" href="#pnl_Assumption">Assumption / Other </a></li>
                                            </ul>
                                        </div>
                                                    ...
                                                    <asp:Repeater ID="rptQuotationDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptQuotationDetail_ItemCommand" OnItemDataBound="rptQuotationDetail_ItemDataBound">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td class="right-align" style="width: 3%;">
                                                                    <asp:TextBox ID="edUnitQty" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("UnitQty") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex="11" />
                                                                </td>
                                                                <% } %>
                                                                <td class="right-align" style="width: 8%;">
                                                                    <asp:TextBox ID="edQuantity" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex="12" />
                                                                </td>
                                                                <td class="right-align" style="width: 8%;">
                                                                    <asp:TextBox ID="edUnitRate" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("UnitRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex="13" />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox ID="edDiscountPercent" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountPercent") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="14" />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox ID="edDiscountAmt" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountAmt") %>' OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;" Enabled="false" TabIndex="15" />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox ID="edNetRate" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("NetRate") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex="16" />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox ID="edHeaderDiscAmt" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("HeaderDiscAmt") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex="17" />
                                                                </td>
                                                                <td class="right-align" style="width: 10%;">
                                                                    <asp:TextBox ID="edAmount" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("Amount") %>' Style="width: 90px; text-align: right;" Enabled="false" TabIndex="18" />
                                                                </td>
                                                                <td class="right-align" style="width: 8%;">
                                                                    ...
                                                                    <asp:TextBox ID="edTaxRate" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("TaxRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="19" />
                                                                </td>
                                                                <td class="right-align" style="width: 10%;">
                                                                    ...
                                                                    <asp:TextBox ID="edTaxAmount" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("TaxAmount") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" />
                                                                </td>
                                                                <td class="right-align" style="width: 10%;">
                                                                    <asp:TextBox ID="edNetAmount" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("NetAmount") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" />
                                                                </td>
                                                                <% if (hdnQuotationSpecification.Value.ToLower() == "yes")
                                                                    { %>
                                                        ...
                                                        <FooterTemplate>
                                                            <tr style="background-color: #dde8f3;">
                                                                ...
                                                                <% } %>
                                                                <td class="right-align" style="width: 8%;">
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" MaxLength="15" ID="txtQuantity" runat="server" ClientIDMode="Static" Width="70" TabIndex="25" AutoPostBack="true" OnTextChanged="txtQuantity_TextChanged" />
                                                                </td>
                                                                <td class="right-align" style="width: 8%;">
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" MaxLength="15" ID="txtUnitRate" runat="server" ClientIDMode="Static" Width="70" TabIndex="26" AutoPostBack="true" OnTextChanged="txtUnitRate_TextChanged" />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" MaxLength="15" ID="txtDiscountPercent" runat="server" ClientIDMode="Static" Width="50" TabIndex="27" AutoPostBack="true" OnTextChanged="txtDiscountPercent_TextChanged" />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox ID="txtDiscountAmt" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Width="80" TabIndex="28" Enabled="false" />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" ID="txtNetRate"  runat="server" ClientIDMode="Static" Width="80" TabIndex="29" Enabled="false" />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" MaxLength="15" ID="txtHeaderDiscAmt" runat="server" ClientIDMode="Static" Width="80" TabIndex="30" Enabled="false" AutoPostBack="true" />
                                                                </td>
                                                                <td class="right-align" style="width: 10%;">
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" MaxLength="15" ID="txtAmount" runat="server" ClientIDMode="Static" Width="90" TabIndex="31" Enabled="false" />
                                                                </td>
                                                                <td class="right-align" style="width: 8%;">
                                                                    ...
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" MaxLength="15" ID="txtTaxRate" runat="server" ClientIDMode="Static" Width="50" TabIndex="32" AutoPostBack="true" OnTextChanged="txtTaxRate_TextChanged" />
                                                                </td> 
                                                                <td class="right-align" style="width: 10%;">
                                                                    ...
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" MaxLength="15" ID="txtTaxAmount" runat="server" ClientIDMode="Static" Width="90" TabIndex="33" Enabled="false" />
                                                                </td>
                                                                <td class="right-align" style="width: 10%;">
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" MaxLength="15" ID="txtNetAmount" runat="server" ClientIDMode="Static" Width="90" TabIndex="34" Enabled="false" />
                                                                </td>
                                                            ...
                                                            <table id="tblCharge" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtOthChrgAmt1" MaxLength="15" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="41" AutoPostBack="true" OnTextChanged="txtOthChrgAmt1_TextChanged" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtOthChrgAmt2" MaxLength="15" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="43" AutoPostBack="true" OnTextChanged="txtOthChrgAmt2_TextChanged" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtOthChrgAmt3" MaxLength="15" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="45" AutoPostBack="true" OnTextChanged="txtOthChrgAmt3_TextChanged" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtOthChrgAmt4" MaxLength="15" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="47" AutoPostBack="true" OnTextChanged="txtOthChrgAmt4_TextChanged" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtOthChrgAmt5" MaxLength="15" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="49" AutoPostBack="true" OnTextChanged="txtOthChrgAmt5_TextChanged" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                            ...
                                                            <table id="tblSummary" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                <tbody>
                                                                    ...
                                                                    <tr class="border-none">
                                                                        ...
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtHeadDiscount" MaxLength="15" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="50" AutoPostBack="true" OnTextChanged="txtHeadDiscount_TextChanged" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr class="border-none">
                                                                        <td class="width-70 right-align">Basic Amount</td>
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtTotBasicAmt" MaxLength="15" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="51" ReadOnly="true" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr class="border-none">
                                                                        <td class="width-70 right-align">Other Charge <small style="color: navy; font-weight: 600;">(With Tax)</small></td>
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtTotOthChrgBeforeGST" MaxLength="15" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="52" ReadOnly="true" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr class="border-none">
                                                                        <td class="width-70 right-align">Total GST</td>
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtTotGST" MaxLength="15" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="53" ReadOnly="true" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr class="border-none">
                                                                        <td class="width-70 right-align">Other Charges <small style="color: Navy; font-weight: 600;">(Excluding Tax)</small></td>
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtTotOthChrgAfterGST" MaxLength="15" class="form-control inputCalc onlyDecimal"  runat="server" ClientIDMode="Static" TabIndex="54" ReadOnly="true" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr class="border-none">
                                                                        <td class="width-70 right-align">Rnd.Off</td>
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtRoff" class="form-control inputCalc onlyDecimal" MaxLength="15" runat="server" ClientIDMode="Static" TabIndex="55" ReadOnly="true" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr class="border-none">
                                                                        <td class="width-70 right-align">Net Amount</td>
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtTotNetAmt" MaxLength="15" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="56" ReadOnly="true" Style="font-weight: bold; text-align: right;" /></td>
                                                                    </tr>
