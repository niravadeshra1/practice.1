<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Quotation.aspx.cs" Inherits="StarsProject.QuotationEagle" ValidateRequest="false" %>
                                        ...
                                        <div class="col s12">
                                            <ul id="myTab" class="tabs" runat="server" clientidmode="Static" enableviewstate="true" style="background-color: antiquewhite;">
                                             ...
                                             <% } %>    
                                               ...
                                               <div id="divlnkfollowup" runat="server" clientidmode="Static">
                                                            ...
                                                            <table id="tblSummary" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" style="width:98% !important;">
                                                                <tbody>
                                                                    ...
                                                                    <tr class="border-none">
                                                                        ...
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtHeadDiscount" MaxLength="12" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="35" AutoPostBack="true" OnTextChanged="txtHeadDiscount_TextChanged" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr class="border-none">
