<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationDss.aspx.cs" Inherits="StarsProject.QuotationDss" ValidateRequest="false" %>
                                                    ...
                                                    <asp:Repeater ID="rptQuotationDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptQuotationDetail_ItemCommand" OnItemDataBound="rptQuotationDetail_ItemDataBound">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <asp:HiddenField ID="edProfitAmount" runat="server" ClientIDMode="Static" Value='<%# Eval("ProfitAmount") %>' />
                                                                ...
                                                                <td class="right-align">
                                                                    <asp:TextBox ID="edDiscountPercent" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountPercent") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex='<%# 5 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                        ...
                                                        <FooterTemplate>
                                                            <tr style="background-color: #dde8f3;">
                                                                ...
                                                                <td class="right-align">
                                                                    <asp:TextBox CssClass="right-align" MaxLength="12" ID="txtDiscountPercent" runat="server" ClientIDMode="Static" Width="50" TabIndex="17" AutoPostBack="true" OnTextChanged="txtDiscountPercent_TextChanged" onblur="javascript:setControlFocus('txtTaxRate');"   />
                                                                </td>
                                                                <td class="right-align hide">
                                                                ...
                                                                <td class="right-align hide">
                                                                    <asp:TextBox CssClass="right-align" MaxLength="12" ID="txtProfitAmt" runat="server" ClientIDMode="Static" Width="80" TabIndex="20" Enabled="false" AutoPostBack="true" />
                                                                </td>
                                                                <td class="right-align" style="width: 10%;">
                                                        ...
                                                        <div class="col m8">
                                                            <table id="tblSummary" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" style="width:98% !important;">
                                                                <tbody>
                                                                    ...
                                                                    <tr class="border-none">
                                                                        <td class="width-70 right-align">Profit OverHead Per %</td>
                                                                        <td class="width-30">
                                                                            <table class="table responsive-table striped">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <asp:TextBox ID="txtProfitPer" class="form-control" runat="server" ClientIDMode="Static" TabIndex="26" Style="font-weight: bold; width: 110px;" ToolTip="Profit Percentage" placeholder="" MaxLength="12" AutoPostBack="true" OnTextChanged="txtProfitPer_TextChanged" /></td>
                                                                                        <td class="right-align" ><span>Profit OverHead Amt</span></td>
                                                                                        <td>
                                                                                            <asp:TextBox ID="txtProfitAmt" class="form-control inputCalc" runat="server" ClientIDMode="Static" TabIndex="27" Style="font-weight: bold; width: 110px;" ToolTip="Profit Amount" ReadOnly="true" MaxLength="12"/></td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </td>
                                                                    ...
                                                                    <tr class="border-none">
                                                                        <td class="width-70 right-align">After Profit Amount</td>
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtAfterPrft" MaxLength="12" class="form-control inputCalc" runat="server" ClientIDMode="Static" TabIndex="36" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr class="border-none">
