<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationHema.aspx.cs" Inherits="StarsProject.QuotationHema" ValidateRequest="false" %>
                                                ...
                                                <table id="tblQuotationDetail" class="table responsive-table striped " cellpadding="0" cellspacing="0" border="0">
                                                    <asp:Repeater ID="rptQuotationDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptQuotationDetail_ItemCommand" OnItemDataBound="rptQuotationDetail_ItemDataBound">
                                                        <HeaderTemplate>
                                                            <thead>
                                                                <tr>
                                                                    <th class="left-align" style="width: 30%;">Product Name <span class="materialize-red-text font-weight-800">*</span>
                                                                        <%--/*Add Product view on Product Name Vikram Rajput 15-07-2020*/--%>
                                                                    ...
                                                                    <th class="right-align" style="width: 5%;">Rate <span class="materialize-red-text font-weight-800">*</span></th>
                                                                    <th class="right-align" style="width: 5%;">HA.Per.</th>
                                                                    <th class="right-align" style="width: 5%;">HA.Price</th>
                                                                    <th class="right-align" style="width: 5%;">HA.Amt</th>
                                                                    <th class="right-align" style="width: 5%;">Mar.Per.</th>
                                                                    <th class="right-align" style="width: 5%;">Mar.Amt.</th>
                                                                    <th class="right-align">Disc. %</th>
                                                                    <th class="right-align hide">Disc.Amt</th>
                                                                    <th class="right-align width-6">Net Rate</th>
                                                                    ...
                                                                    <th class="right-align width-6" style="padding: 0px 0px 0px 13px;">Tax Amount</th>
                                                                    <th class="right-align width-6" style="padding: 0px 8px 0px 0px;">Net Amount</th>
                                                                    ...
                                                                    <th class="center-align" style="width: 10%;">Modules</th>
                                                                    <% } %>
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td class="left-align limited" style="width: 30%;">
                                                                    <label style="color:black;font-size:15px;" ><%# Eval("ProductNameLong") %></label>
                                                                    <% if (hdnProductHistory.Value == "yes" || hdnProductHistory.Value == "y") {%>
                                                                        <br><a id="lnkHistory" class="open-pop-up" href="javascript:openHistory('<%# Eval("ProductID") %>',<%# (!String.IsNullOrEmpty(hdnCustomerID.Value) ? hdnCustomerID.Value : "0") %>);" >History</a>
                                                                    <%} %>
                                                                    <a id="lnkAssembly1" class="open-pop-up" href="javascript:openAssembly('<%# Eval("ProductID") %>');" tabindex="19"><small>Assembly</small></a>
                                                                     <% if (hdnQuotationSpecification.Value.ToLower() == "yes")
                                                                    { %>
                                                                        <a id="lnkSpecs1" class="open-pop-up" href="javascript:openSpecification('<%# Eval("ProductID") %>','<%# Eval("pkID") %>');" tabindex="19"><small>Specs</small></a>
                                                                    <% } %>
                                                                ...
                                                                <td class="center-align width-6" style="width: 8%;">
                                                                    <asp:TextBox ID="edUnit" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("Unit") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex='<%# 1 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <% if (hdnSerialKey.Value == "SA98-6HY9-HU67-LORF")
                                                                    { %>
                                                                <td class="right-align" style="width: 3%;">
                                                                    <asp:TextBox ID="edUnitQty" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("UnitQty") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex='<%# 2 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <% } %>
                                                                <% if (hdnSerialKey.Value == "DARS-SAFE-TA12-Y808")
                                                                    { %>
                                                                ...
                                                                <td class="right-align" style="width: 5%;">
                                                                    <asp:TextBox ID="edQuantity" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex='<%# 3 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align" style="width: 5%;">
                                                                    <asp:TextBox ID="edUnitRate" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("UnitRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex='<%# 4 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align" style="width: 5%;">
                                                                    <asp:TextBox ID="edHAPer" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("HAPer") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex='<%# 4 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align" style="width: 5%;">
                                                                    <asp:TextBox ID="edHARate" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("HARate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex='<%# 4 + (Container.ItemIndex+1)*100 %>' ReadOnly="true" />
                                                                </td>
                                                                <td class="right-align" style="width: 5%;">
                                                                    <asp:TextBox ID="edHAAmt" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("HAAmt") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex='<%# 4 + (Container.ItemIndex+1)*100 %>' ReadOnly="true" />
                                                                </td>
                                                                <td class="right-align" style="width: 5%;">
                                                                    <asp:TextBox ID="edMarginPer" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("MarginPer") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex='<%# 4 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align" style="width: 5%;">
                                                                    <asp:TextBox ID="edMarginAmt" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("MarginAmt") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex='<%# 4 + (Container.ItemIndex+1)*100 %>' ReadOnly="true" />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox ID="edDiscountPercent" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountPercent") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex='<%# 5 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align hide">
                                                                    <asp:TextBox ID="edDiscountAmt" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountAmt") %>' OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;" Enabled="false" TabIndex='<%# 6 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox ID="edNetRate" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("NetRate") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex='<%# 7 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align hide">
                                                                    <asp:TextBox ID="edHeaderDiscAmt" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("HeaderDiscAmt") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex='<%# 8 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align width-6">
                                                                    <asp:TextBox ID="edAmount" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("Amount") %>' Style="width: 90px; text-align: right;" Enabled="false" TabIndex='<%# 9 + (Container.ItemIndex+1)*100 %>'  />
                                                                </td>
                                                                <td class="center-align" style="width: 5%;">
                                                                    ...
                                                                    <asp:TextBox ID="edTaxRate" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("TaxRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex='<%# 10 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align" style="width: 6%;">
                                                                    ...
                                                                    <asp:TextBox ID="edTaxAmount" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("TaxAmount") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex='<%# 11 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align width-6">
                                                                    <asp:TextBox ID="edNetAmount" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("NetAmount") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex='<%# 12 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
<%--                                                                <% if (hdnQuotationSpecification.Value.ToLower() == "yes")
                                                                    { %>
                                                                ...
                                                                <td class="center-align" style="width: 10%;">
                                                                    <asp:ImageButton ID="ImgbtnDelete" runat="server" ClientIDMode="Static" ImageUrl="~/images/delete.png" ToolTip="Delete" CommandName="Delete" CommandArgument='<%# Eval("pkID") %>' Width="20" Height="20" OnClientClick="return delClientClick()" TabIndex='<%# 13 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                            <tr style="background-color: #dde8f3;">
                                                                <td class="left-align" style="width: 30%;">
                                                                ...
                                                                <td class="right-align" style="width: 5%;">
                                                                    <asp:TextBox CssClass="right-align" MaxLength="12" ID="txtHAPer" runat="server" ClientIDMode="Static" Width="70" TabIndex="16" AutoPostBack="true" OnTextChanged="txtHAPer_TextChanged" />
                                                                </td>
                                                                <td class="right-align" style="width: 5%;">
                                                                    <asp:TextBox CssClass="right-align" MaxLength="12" ID="txtHARate" runat="server" ClientIDMode="Static" Width="70" TabIndex="16" ReadOnly="true" />
                                                                </td>
                                                                <td class="right-align" style="width: 5%;">
                                                                    <asp:TextBox CssClass="right-align" MaxLength="12" ID="txtHAAmt" runat="server" ClientIDMode="Static" Width="70" TabIndex="16" ReadOnly="true" />
                                                                </td>
                                                                <td class="right-align" style="width: 5%;">
                                                                    <asp:TextBox CssClass="right-align" MaxLength="12" ID="txtMarginPer" runat="server" ClientIDMode="Static" Width="70" TabIndex="16" AutoPostBack="true" OnTextChanged="txtMarginPer_TextChanged" />
                                                                </td>
                                                                <td class="right-align" style="width: 5%;">
                                                                    <asp:TextBox CssClass="right-align" MaxLength="12" ID="txtMarginAmt" runat="server" ClientIDMode="Static" Width="70" TabIndex="16" ReadOnly="true" />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox CssClass="right-align" MaxLength="12" ID="txtDiscountPercent" runat="server" ClientIDMode="Static" Width="70" TabIndex="17" AutoPostBack="true" OnTextChanged="txtDiscountPercent_TextChanged" onblur="javascript:setControlFocus('txtTaxRate');"   />
                                                                </td>
                                                                <td class="right-align hide">
                                                                ...
                                                                <td class="center-align" style="width: 5%;">
                                                                    ...
                                                                    <asp:TextBox CssClass="right-align" MaxLength="12" ID="txtTaxRate" runat="server" ClientIDMode="Static" Width="50" TabIndex="22" AutoPostBack="true" OnTextChanged="txtTaxRate_TextChanged" onblur="javascript:setControlFocus('imgBtnSave');"/>
                                                                </td>
                                                                <td class="right-align" style="width: 6%;">
                                                            ...
                                                            <tr style="background-color: navy; min-height: 50px;">
                                                                <td class="right-align" style="color: White; font-size: 20px;">Grand Total: </td>
                                                                <td class="right-align" style="color: White; font-size: 10px;"></td>
                                                                <td class="center-align">
                                                                    <asp:Label ID="lblTotalQuantity" runat="server" ClientIDMode="Static" Width="50" TabIndex="38" Enabled="false" Style="color: White; font-size: 16px;" />
                                                                </td>
                                                                <td class="center-align">
                                                                    <asp:Label ID="lblTotalRate" runat="server" CssClass="hide" ClientIDMode="Static" Width="50" TabIndex="38" Enabled="false" Style="color: White; font-size: 16px;" />
                                                                </td>
                                                                <td class="right-align" style="color: White; font-size: 10px;">
                                                                ...
                                                                <td class="right-align" style="color: White; font-size: 10px;">
                                                                    <asp:Label ID="lblTotalHRA" runat="server" ClientIDMode="Static" Width="50" TabIndex="38" Enabled="false" Style="color: White; font-size: 16px;" />
                                                                </td>    
                                                                <td class="right-align" style="color: White; font-size: 10px;">

                                                                </td>       
                                                                <td class="center-align">
                                                                    <asp:Label ID="lblTotalMargin" CssClass="hide" runat="server" ClientIDMode="Static" Width="50" TabIndex="38" Enabled="false" Style="color: White; font-size: 16px;" />
                                                                </td>
                                                                <td class="right-align" style="color: White; font-size: 10px;"></td>    
                                                                <td class="center-align">
                                                                    <asp:Label ID="lblTotalNetRate" CssClass="hide" runat="server" ClientIDMode="Static" Width="50" TabIndex="38" Enabled="false" Style="color: White; font-size: 16px;" />
                                                                </td>
                                                                <td class="center-align">
                                                                    <asp:Label ID="lblTotalAmount" runat="server" ClientIDMode="Static" Width="50" TabIndex="38" Enabled="false" Style="color: White; font-size: 16px;" />
                                                                </td>
                                                                <td class="right-align" style="color: White; font-size: 10px;"></td>    
                                                                <td class="center-align">
                                                                    <asp:Label ID="lblTotalTaxAmount" runat="server" ClientIDMode="Static" Width="50" TabIndex="38" Enabled="false" Style="color: White; font-size: 16px;" />
                                                                </td>
                                                                <td class="center-align">
                                                                    <asp:Label ID="lblTotalNetAmount" runat="server" ClientIDMode="Static" Width="50" TabIndex="38" Enabled="false" Style="color: White; font-size: 16px;" />
                                                                </td>
                                                                <td class="center-align">
                                                                    <asp:Label ID="lblDiff" runat="server" ClientIDMode="Static" Width="100%" TabIndex="38" Enabled="false" Style="color: navy; font-size: 16px; background-color:white;" />
                                                                </td>
                                                            </tr>
                                                        </FooterTemplate>
                                                    </asp:Repeater>
                                            ...
                                            <div class="row">
                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        ...
                                                        <div class="col m3">
                                                            <table id="tblDiff" class="table responsive-table striped">
                                                                <tbody>
                                                                    <tr> <td></td><td></td> </tr>
                                                                    <tr> <td></td><td></td> </tr>
                                                                    <tr class="border-none">
                                                                        <td class="width-70 right-align " style="color:black;font-size:35px;">Client Price</td>
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtCPrice" MaxLength="12" class="form-control inputCalc" runat="server" ClientIDMode="Static" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr class="border-none">
                                                                        <td class="width-70 right-align" style="color:black;font-size:35px;">Our Price</td>
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtOurPrice" MaxLength="12" class="form-control inputCalc" runat="server" ClientIDMode="Static" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr class="border-none">
                                                                        <td class="width-70 right-align" style="color:black;font-size:35px;">Difference</td>
                                                                        <td class="width-30">
                                                                            <asp:TextBox ID="txtDiff" MaxLength="12" class="form-control inputCalc" runat="server" ClientIDMode="Static" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                        ...
                                        <div id="pnl_TNC" class="col m12 mt-1" runat="server" clientidmode="Static" enableviewstate="true">
                                            <div class="row">
                                                ...
                                                <div class="input-field col m12">
                                                    ...
                                                    <asp:TextBox ID="txtQuotationFooter" Style="height: 7rem !important;" MaxLength="500" runat="server" class="form-control" ClientIDMode="Static" TabIndex="47" TextMode="MultiLine" Rows="13" placeholder="" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="pnl_Assumption" class="col m12 mt-1" runat="server" clientidmode="Static" enableviewstate="true">
                                            <div class="row">
                                                <div class="input-field col m6">
                                                    <label class="active" for="txtQuotationFooter">Ref. Enquiry</label>
