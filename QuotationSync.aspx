<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationSync.aspx.cs" Inherits="StarsProject.QuotationSync" ValidateRequest="false"%>
...
<%--    <script type="text/javascript" src="app-assets/js/scripts/form-select2.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function openAssembly(pProdID) {
            var t11;
            t11 = jQuery("#txtQuotationNo").val();
            var pageUrl = "QuotationAssemblySync.aspx?QuotationNo=" + t11 + "&FinishProductID=" + pProdID;
            $('#ifrModule').attr('src', pageUrl);
            $find("mpe").show();
        }
