<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationVMS.aspx.cs" Inherits="StarsProject.QuotationVMS" ValidateRequest="false" %>
                            ...
                            <div class="row">
                                <div class="col m12">
                                    <div class="row">
                                        ...
                                        <% if (hdnSerialKey.Value == "VMS7-HJLK-SATR-4LNK")
                                            { %>
                                                <div class="input-field col m2">
                                                    <label class="active" for="drpQuotationTypeUniversal">Quotation Type</label>
                                                    <asp:DropDownList ID="drpQuotationTypeUniversal" runat="server" ClientIDMode="Static" TabIndex="6" class="select2-theme browser-default left-align" Style="height: inherit;" >
                                                        <asp:ListItem Text="---Select Quotation Type---" Value="" Selected="True" />
                                                    </asp:DropDownList>
                                                </div>
                                        <% } %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="left-align limited" style="width: 20%;">
                                                                    <% if (hdnProductHistory.Value == "yes" || hdnProductHistory.Value == "y") {%>
                                                                        <a id="lnkHistory" style="font-size:15px;color:black" class="btn cyan right mr-1" href="javascript:openHistory('<%# Eval("ProductID") %>',<%# (!String.IsNullOrEmpty(hdnCustomerID.Value) ? hdnCustomerID.Value : "0") %>);" tabindex="30">History</a>
                                                                    <%} %>
                                                                ...
                                                                <td class="right-align" style="width: 3%;">
                                                                    <asp:TextBox CssClass="onlyDecimal" ID="edUnitQty" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("UnitQty") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex='<%# 2 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <% } %>
                                                                <% if (hdnSerialKey.Value == "DARS-SAFE-TA12-Y808")
                                                                    { %>
                                                                ...
                                                                <td class="right-align" style="width: 8%;">
                                                                    <asp:TextBox CssClass="onlyDecimal" ID="edQuantity" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex='<%# 3 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align" style="width: 8%;">
                                                                    <asp:TextBox CssClass="onlyDecimal" ID="edUnitRate" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("UnitRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex='<%# 4 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox CssClass="onlyDecimal" ID="edDiscountPercent" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountPercent") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex='<%# 5 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align hide">
                                                                    <asp:TextBox ID="edDiscountAmt" CssClass="onlyDecimal" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountAmt") %>' OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;" Enabled="false" TabIndex='<%# 6 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox ID="edNetRate" MaxLength="12" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("NetRate") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex='<%# 7 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align hide">
                                                                    <asp:TextBox ID="edHeaderDiscAmt" MaxLength="12" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("HeaderDiscAmt") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex='<%# 8 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align hide">
                                                                    <asp:TextBox ID="edAdditionalDiscAmt" MaxLength="12" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("AdditionalDiscAmt") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex='<%# 8 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align width-10">
                                                                    <asp:TextBox ID="edAmount" CssClass="onlyDecimal" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("Amount") %>' Style="width: 90px; text-align: right;" Enabled="false" TabIndex='<%# 9 + (Container.ItemIndex+1)*100 %>'  />
                                                                </td>
                                                                <td class="right-align" style="width: 8%;">
                                                                    ...
                                                                    <asp:TextBox CssClass="onlyDecimal" ID="edTaxRate" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("TaxRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex='<%# 10 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align" style="width: 10%;">
                                                                    ...
                                                                    <asp:TextBox ID="edTaxAmount" CssClass="onlyDecimal" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("TaxAmount") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex='<%# 11 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <td class="right-align width-10">
                                                                    <asp:TextBox ID="edNetAmount" CssClass="onlyDecimal" MaxLength="12" runat="server" ClientIDMode="Static" Text='<%# Eval("NetAmount") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex='<%# 12 + (Container.ItemIndex+1)*100 %>' />
                                                                </td>
                                                                <% if (hdnQuotationSpecification.Value.ToLower() == "yes")
                                                                    { %>
                                                                ...
                                                                <% if (hdnSerialKey.Value == "SI08-SB94-MY45-RY15")
                                                                    ...
                                                                    <td class="center-align" style="width: 10%;">
                                                                        <a id="lnkModules" href="javascript:openERPModules('<%# Eval("ProductID") %>');" tabindex="19"><small>Modules</small></a>
                                                                    </td>
                                                                <% } %>
                                                        ...
                                                        <FooterTemplate>
                                                            <tr style="background-color: #dde8f3;">
                                                                ...
                                                                <td class="center-align" style="width: 6%;">
                                                                    <asp:TextBox CssClass="center-align" MaxLength="12" ID="txtUnit" runat="server" ClientIDMode="Static" Width="70" TabIndex="13" />
                                                                </td>
                                                                <% if (hdnSerialKey.Value == "SA98-6HY9-HU67-LORF")
                                                                    { %>
                                                                <td class="right-align" style="width: 3%;">
                                                                ...
                                                                <% } %>
                                                                <td class="right-align" style="width: 8%;">
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" MaxLength="12" ID="txtQuantity" runat="server" ClientIDMode="Static" Width="70" TabIndex="15" />
                                                                </td>
                                                                <td class="right-align" style="width: 8%;">
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" MaxLength="12" ID="txtUnitRate" runat="server" ClientIDMode="Static" Width="70" TabIndex="16" />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" MaxLength="12" ID="txtDiscountPercent" runat="server" ClientIDMode="Static" Width="50" TabIndex="17" onblur="javascript:setControlFocus('txtTaxRate');"   />
                                                                </td>
                                                                <td class="right-align hide">
                                                                    <asp:TextBox ID="txtDiscountAmt" CssClass="onlyDecimal"  MaxLength="12" runat="server" ClientIDMode="Static" Width="80" TabIndex="18" Enabled="false" />
                                                                </td>
                                                                <td class="right-align hide">
                                                                    <asp:TextBox ID="txtAddDiscAmt" CssClass="onlyDecimal"  MaxLength="12" runat="server" ClientIDMode="Static" Width="80" TabIndex="18" Enabled="false" />
                                                                </td>
                                                                <td class="right-align">
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" ID="txtNetRate" MaxLength="12" runat="server" ClientIDMode="Static" Width="80" TabIndex="19" Enabled="false" />
                                                                </td>
                                                                <td class="right-align hide">
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" MaxLength="12" ID="txtHeaderDiscAmt" runat="server" ClientIDMode="Static" Width="80" TabIndex="20" Enabled="false" AutoPostBack="true" />
                                                                </td>
                                                                <td class="right-align" style="width: 10%;">
                                                                ...
                                                                <td class="right-align" style="width: 8%;">
                                                                    ...
                                                                    <asp:TextBox CssClass="right-align onlyDecimal" MaxLength="12" ID="txtTaxRate" runat="server" ClientIDMode="Static" Width="50" TabIndex="22" onblur="javascript:setControlFocus('imgBtnSave');"/>
                                                                </td>
                                                                <td class="right-align" style="width: 10%;">
                                                        ...
                                                        <div class="col m4">
                                                            <table id="tblCharge" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                <thead>
                                                                    ...
                                                                    <th class="center-align hide">Percentage</th>
                                                                    <th class="center-align">Amount</th>
                                                                    <th class="center-align">Total Amount</th>
                                                                </thead>
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="width-50 right-align">
                                                                            <h5>Sq. Ft.</h5></td>
                                                                        <td class="width-50" colspan="2">
                                                                            <asp:TextBox ID="txtSqFt" MaxLength="12" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="26" AutoPostBack="true" OnTextChanged="txtSqFt_TextChanged" Style="text-align: right;" /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td id="tdOthChrg1" runat="server" class="width-20 right-align"></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td id="tdOthChrg2" runat="server" class="width-20 right-align"></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td id="tdOthChrg3" runat="server" class="width-20 right-align"></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="width-30">
                                                                         ...
                                                                         <td id="tdOthChrg4" runat="server" class="width-20 right-align"></td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td id="tdOthChrg5" runat="server" class="width-20 right-align"></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                        <div class="col m8">
                                                            <table id="tblSummary" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" style="width:98% !important;">
                                                                <tbody>
                                                                    ...
                                                                    <tr class="border-none">
                                                                        <td class="width-70 right-align">Additional Discount Per</td>
                                                                        <td class="width-30">
                                                                            <table class="table responsive-table striped">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <asp:TextBox ID="txtAdditionalDiscountPer" MaxLength="12" Width="100px" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="35" AutoPostBack="true" OnTextChanged="txtAdditionalDiscountPer_TextChanged" Style="text-align: right;" /></td>
                                                                                        <td><span>Amount</span></td>
                                                                                        <td>
                                                                                            <asp:TextBox ID="txtAdditionalDiscountAmt" ReadOnly="true" MaxLength="12" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="35"  Style="text-align: right;" /></td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </td>
