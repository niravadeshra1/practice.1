<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepairingInward.aspx.cs" Inherits="StarsProject.RepairingInward" %>
                                                        ...
                                                        <asp:Repeater ID="rptInwardDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptInwardDetail_ItemCommand" OnItemDataBound="rptInwardDetail_ItemDataBound">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="edQuantity" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;"  TabIndex="6"/>
                                                                    </td>
                                                                    <td class="center-align width-7"><%# Eval("Unit") %></td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="edUnitRate" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("UnitRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;"  TabIndex="7"/>
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="edDiscountPercent" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountPercent") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;"  TabIndex="8"/>
                                                                    </td>
                                                                    ...
                                                                    <td class="right-align">
                                                                        ...
                                                                        <asp:TextBox ID="edTaxRate" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("TaxRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;"  TabIndex="12"/>
                                                                    </td>
                                                                    <td class="right-align">
                                                            ...
                                                            <FooterTemplate>
                                                                <tr style="background-color: #dde8f3;">
                                                                    ...
                                                                    <td class="text-right"> CssClass="onlyDecimal" 
                                                                    ...
                                                                    <td class="text-right">
                                                                        <asp:TextBox ID="txtDiscountPercent" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Width="80" TabIndex="21" OnTextChanged="txtDiscountPercent_TextChanged" onblur="javascript:calcQuotation();" />
                                                                    </td>
                                                                    ...
                                                                    <td class="text-right">
                                                                        ...
                                                                        <asp:TextBox ID="txtTaxRate" CssClass="onlyDecimal"  MaxLength="15" runat="server" ClientIDMode="Static" Width="80" TabIndex="25" OnTextChanged="txtTaxRate_TextChanged" onblur="javascript:calcQuotation();" />
                                                                    </td>
                                                                    <td class="text-right">
