<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepairingOutward.aspx.cs" Inherits="StarsProject.RepairingOutward" %>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="input-field col m2">
                                    <label class="active" for="drpReferenceNo">Inward #</label>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="center-align">
                                                                <asp:TextBox ID="edQuantity"  CssClass="onlyDecimal" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;" />
                                                            </td>
                                                            <td class="center-align">
                                                            ...
                                                            <td id="ITWeight" runat="server" class="center-align">
                                                                <asp:TextBox ID="edQuantityWeight" CssClass="onlyDecimal" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("QuantityWeight") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 120px; text-align: right;" />
                                                            </td>
                                                            <td class="center-align">
                                                    ...
                                                    <FooterTemplate>
                                                        <tr style="background-color: #dde8f3;">
                                                            ...
                                                            <td id="FTWeight" runat="server" class="center-align">
                                                                <asp:TextBox ID="txtQuantityWeight" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="120" TabIndex="54" />
                                                            </td>
                                                            <td class="center-align">
