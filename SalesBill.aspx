            ...
            <asp:UpdatePanel ID="upUserPanel" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                                    ...
                                    <div class="row">
                                        <div class="col m12">
                                            ...
                                            <div class="row" id="divSupplierRef1" runat="server" clientidmode="Static">
                                                ...
                                                <div class="input-field col m1">
                                                    <button id="btnShowOrders" type="button" runat="server" clientidmode="Static" tabindex="11" class="btn cyan right mr-1" onserverclick="btnShowOrders_Click">Show Order</button>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="input-field col m2" style="display: block;">
                                                    <label class="active" for="txtDisDocNo">Dispatch Doc.No.</label>
                                                ...
                                                <div class="input-field col m1">
                                                    ...
                                                    <asp:TextBox ID="txtCRDays" class="form-control onlyDecimal" runat="server" ClientIDMode="Static" Placeholder="" MaxLength="15" TabIndex="6" onblur="calculateDueDate()" />
                                                </div>
                                                <div class="input-field col m1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="input-field col m1">
                                                    <label class="active" for="txtChallanDate">Challan Date</label>
                                                    <asp:TextBox ID="txtChallanDate" runat="server" class="form-control" ClientIDMode="Static" TabIndex="1" placeholder="" TextMode="Date" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12">
                                            <ul id="Ul1" class="tabs" runat="server" clientidmode="Static" enableviewstate="true" style="background-color: antiquewhite;">
                                                ...
                                                <li class="tab col m1.5 p-0"><a id="lnkEmail" class="left" href="#pnl_Email">Email Content</a></li>
                                                <li class="tab col m2 p-0"><a id="lnkTNC" class="left" href="#pnl_TNC" tabindex="65">Terms & Conditions</a></li>
                                                ...
                                                <li class="tab col m1.5 p-0"><a id="lnkAttachment" class="left" href="#pnl_Attachment" tabindex="79">Attachment</a></li>
                                                    ...
                                                    <table id="tblQuotationDetail" class="table responsive-table striped width-100" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <asp:Repeater ID="rptOrderDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptOrderDetail_ItemCommand" OnItemDataBound="rptOrderDetail_ItemDataBound">
                                                            <HeaderTemplate>
                                                                <thead>
                                                                    <tr>
                                                                        <th class="left-align" style="width: 22%;">Product Name <span class="materialize-red-text font-weight-800">*</span>
                                                                        ...
                                                                        <th class="right-align width-8">Tax Amount</th>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td class="left-align" style="width: 22%;">
                                                                    ...
                                                                    <% } %>
                                                                    <td class="right-align width-7">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edQuantity" runat="server" ClientIDMode="Static" Text='<%# Eval("Qty") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex="17" />
                                                                    </td>
                                                                    ...
                                                                    <td class="right-align width-8">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edUnitRate" runat="server" ClientIDMode="Static" Text='<%# Eval("Rate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;" TabIndex="18" />
                                                                    </td>
                                                                    <td class="right-align width-5">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edDiscountPercent" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountPer") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 40px; text-align: right;" TabIndex="19" />
                                                                    </td>
                                                                    ...
                                                                    <td class="right-align width-5">
                                                                        ...
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edTaxRate" runat="server" ClientIDMode="Static" Text='<%# (Eval("TaxRate") ) %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="24" />
                                                                    </td>
                                                                    <td class="right-align width-8">
                                                                    ...
                                                                    <td class="right-align hide">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edAddTaxPer" runat="server" ClientIDMode="Static" Text='<%# Eval("AddTaxPer") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="26" />
                                                                    </td>
                                                                    <td class="right-align hide">
                                                            ...
                                                            <FooterTemplate>
                                                                <tr style="background-color: #dde8f3;">
                                                                    ...
                                                                    <% if (hdnSerialKey.Value == "SA98-6HY9-HU67-LORF")
                                                                        { %>
                                                                    <td class="right-align width-7">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="txtUnitQty" runat="server" ClientIDMode="Static" Width="70" AutoPostBack="true" OnTextChanged="txtUnitQty_TextChanged" TabIndex="33" />
                                                                    </td>
                                                                    <% } %>
                                                                    <td class="right-align width-7">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="txtQuantity" runat="server" ClientIDMode="Static" Width="70" AutoPostBack="true" OnTextChanged="txtQuantity_TextChanged" TabIndex="34" />
                                                                    </td>
                                                                    <td class="center-align width-6">
                                                                    ...
                                                                    <td class="right-align width-5">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="txtDiscountPercent" runat="server" ClientIDMode="Static" Width="50" TabIndex="37" AutoPostBack="true" OnTextChanged="txtDiscountPercent_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align hide">
                                                    ...
                                                    <table id="tblCharge" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt1" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="55" AutoPostBack="true" OnTextChanged="txtOthChrgAmt1_TextChanged" Style="text-align: right;" MaxLength="12" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt2" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="57" AutoPostBack="true" OnTextChanged="txtOthChrgAmt2_TextChanged" Style="text-align: right;" MaxLength="12" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt3" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="59" AutoPostBack="true" OnTextChanged="txtOthChrgAmt3_TextChanged" Style="text-align: right;" MaxLength="12" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt4" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="61" AutoPostBack="true" OnTextChanged="txtOthChrgAmt4_TextChanged" Style="text-align: right;" MaxLength="12" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt5" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="63" AutoPostBack="true" OnTextChanged="txtOthChrgAmt5_TextChanged" Style="text-align: right;" MaxLength="12" />
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table id="tblSummary" class="table responsive-table striped" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tbody>
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtHeadDiscount" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="64" AutoPostBack="true" OnTextChanged="txtHeadDiscount_TextChanged" MaxLength="12" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                        ...
                                        <div id="pnl_Transport" class="col m12 mt-1" runat="server" clientidmode="Static" enableviewstate="true" style="display: none;">
                                            <div class="container" style="max-width: none; width: 98%; margin: 5px !important;">
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col m3">
                                                        <label class="active" for="txtTransporterName">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <% if (hdnSerialKey.Value == "PN9F-NPA1-EQH3-PS1H")
                                                        { %>
                                                    <div class="input-field col m3">
                                                        <label class="active" for="txtDeliverTo">Transport GST No</label>
                                                    ...
                                                    <div class="input-field col m3">
                                                        ...
                                                        <asp:TextBox ID="TextBox1" runat="server" class="form-control" ClientIDMode="Static" TabIndex="78" placeholder="" MaxLength="50" />
                                                    </div>
                                                    <% } %>
                                                    <div class="input-field col m3">
                                        ...
                                        <div id="pnl_Shipment" class="col m12 mt-1" runat="server" clientidmode="Static" enableviewstate="true" style="display: none;">
                                            ...
                                            <div class="row">
                                                ...
                                                <% if (hdnSerialKey.Value == "PN9F-NPA1-EQH3-PS1H")
                                                    { %>
                                                <div class="input-field col m4">
                                                    <label class="active" for="txtFOB">Deliver By</label>
                                                ...
                                                <div class="input-field col m4">
                                                    ...
                                                    <asp:TextBox ID="TextBox2" runat="server" class="form-control" ClientIDMode="Static" TabIndex="91" placeholder="" />
                                                </div>
                                                <% } %>
                                            </div>
                                        </div>
                    ...
                    <div id="myNotificationModal" class="modal" style="width: 85% !important;">
                        <div class="modal-content">
                            <h4>Select Sales Order For Production
                                ...
                                <div class="col m12 p-0">
                                    <table id="tblProduction" class="table responsive-table striped width-100">
                                        <asp:Repeater ID="rptProduction" runat="server" ClientIDMode="Static">
                                            <HeaderTemplate>
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="center-align" style="width: 15%;">Reference #</th>
                                                        <th class="left-align" style="width: 30%;">Product Name</th>
                                                        <th class="right-align" style="width: 15%;">Order Qty</th>
                                                        <th class="right-align" style="width: 15%;">Book Qty</th>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <asp:HiddenField ID="hdnOrderpkID" runat="server" ClientIDMode="Static" Value='<%# Eval("pkID") %>' />
                                                    <asp:HiddenField ID="hdnProductID" runat="server" ClientIDMode="Static" Value='<%# Eval("ProductID") %>' />
                                                    <asp:HiddenField ID="hdnOrderNo" runat="server" ClientIDMode="Static" Value='<%# (hdnSerialKey.Value == "STX1-UP06-YU89-JK23") ?  Eval("ReferenceNo")  : Eval("OrderNo")  %>' />
                                                    <asp:HiddenField ID="hdnQuantity" runat="server" ClientIDMode="Static" Value='<%# Eval("Quantity") %>' />
                                                    <asp:HiddenField ID="hdnBookQty" runat="server" ClientIDMode="Static" Value='<%# Eval("BookQty") %>' />
                                                    <asp:HiddenField ID="hdnProdQty" runat="server" ClientIDMode="Static" Value='<%# Convert.ToDecimal(Eval("Quantity")) - Convert.ToDecimal(Eval("BookQty")) %>' />
                                                    ...
                                                    <td class="center-align vertical-align-top" style="width: 15%; color: navy;"><%# (hdnSerialKey.Value == "STX1-UP06-YU89-JK23") ?  Eval("ReferenceNo")  : Eval("OrderNo")  %></td>
                                                    <td class="left-align vertical-align-top" style="width: 30%; color: maroon;"><%# Eval("ProductNameLong") %></td>
                                                    <td class="right-align vertical-align-top black-text bold" style="width: 15%;"><%# Eval("Quantity") %></td>
                                                    <td class="right-align vertical-align-top black-text bold" style="width: 15%;"><%# Eval("BookQty") %></td>
                                                    <td class="right-align vertical-align-top black-text bold" style="width: 15%;"><%# Convert.ToDecimal(Eval("Quantity")) - Convert.ToDecimal(Eval("BookQty")) %></td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </table>
                        ...
                        <div class="modal-footer">
                            <button id="btnLoadOrders" type="button" runat="server" clientidmode="Static" tabindex="11" class="btn cyan right mr-1" onclick="javascript:getSelectedOrders();" onserverclick="btnLoadOrders_Click">Load Order</button>
                        </div>
                    </div>
