<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesBill_Piyush.aspx.cs" Inherits="StarsProject.SalesBill_Piyush" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function openProductSerialNo(pProdID, pOrderNo) {
            document.getElementById('spnModuleHeader').innerText = "Fill-Up Product Serial No";
            var t11, tmpInvoiceNo;
            tmpInvoiceNo = jQuery("#txtInvoiceNo").val();

            var pageUrl = "ProductSerialNo.aspx?FromPage=sales&Module=Sales&InvoiceNo=" + tmpInvoiceNo + "&ProductID=" + pProdID + "&RefNo=" + pOrderNo;

            //if ($("#hdnInvBasedOn").val() == "outward") {
            //    t11 = jQuery("#drpReferenceNo").val();
            //    var pageUrl = "ProductSerialNo.aspx?Module=Out&&DocNo=" + t11 + "&ProductID=" + pProdID;
            //}
            //else
            //{
            //    t11 = jQuery("#txtInvoiceNo").val();
            //    var pageUrl = "ProductSerialNo.aspx?Module=Sales&InvoiceNo=" + t11 + "&ProductID=" + pProdID;
            //}
            $('#ifrModule').attr('src', pageUrl);
            $find("mpe").show();
        }
                ...
                <ContentTemplate>
                    <div class="widgetbox">
                                    ...
                                    <div class="row">
                                        <div class="col m12">
                                            ...
                                            <div class="row" id="divSupplierRef1" runat="server" clientidmode="Static">
                                                <div id="divLoad0" runat="server" clientidmode="Static" class="input-field col m1 hide">
                                                ...
                                                <div id="divLoadNew" runat="server" clientidmode="Static" class="input-field col m3 hide">
                                                    <label class="active" for="drpFinish">Select Finishing No.</label>
                                                    <asp:DropDownList ID="drpFinish" runat="server" class="select2-theme browser-default" SelectionMode="Multiple" EnableViewState="true" ClientIDMode="Static" AutoPostBack="true" OnSelectedIndexChanged="drpFinish_SelectedIndexChanged" TabIndex="7">
                                                    </asp:DropDownList>
                                                </div>
                                                <div id="divLoad1" runat="server" clientidmode="Static" class="input-field col m3">
                                                    <label id="lblReferenceType" class="active" for="drpReferenceNo" runat="server" clientidmode="Static">Finishing No</label>
                                                    ...
                                                    <asp:ListBox runat="server" ID="drpReferenceNo" Style="width: 200px;" ClientIDMode="Static" EnableViewState="true" TabIndex="4" CssClass="select2-size-sm browser-default" AutoPostBack="true" onchange="YourChangeEventJS(this)" SelectionMode="Multiple"></asp:ListBox>
                                                </div>
                                                <%--<div class="input-field col m3">
                                                    <label class="active" for="lstOrderProduct">Select Product</label>
                                                ...
                                                <div id="divLoad2" runat="server" clientidmode="Static" class="input-field col m2">
                                                    <button id="btnLoadItems" type="button" runat="server" clientidmode="Static" tabindex="11" class="btn cyan right mr-1" onclick="javascript:getSelectedOrders();" onserverclick="btnLoadItems_ServerClick">Load Products</button>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="input-field col m3">
                                                    <label class="active" for="txtOtherRef">Bill No.</label>
                                                                    ...
                                                                    <tr>
                                                                        <th class="left-align width-20">Product Name <span class="materialize-red-text font-weight-800">*</span>
                                                                            <a href="javascript:openProductInfo('add');">
                                                                                <img src="images/expand.png" width="30" height="20" style="padding: 5px 5px 0px 5px;" alt="Add New Product" title="Add New Product" tabindex="21" />
                                                                            </a>
                                                                        </th>
                                                                        ...
                                                                        <% } %>
                                                                        <th class="center-align width-7">Quantity <span class="materialize-red-text font-weight-800">*</span></th>
                                                                        ...
                                                                        <th class="right-align width-8">Net Amount</th>
                                                                        <th id="tdOutwardNo" runat="server" class="center-align width-8">S.O #</th>
                                                                        <th class="center-align width-5 hide">Serial No</th>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td class="right-align width-8">
                                                                        ...
                                                                        <asp:TextBox ID="edTaxRate" runat="server" ClientIDMode="Static" Text='<%# (Eval("TaxRate") ) %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex="24" />
                                                                    </td>
                                                                    <td class="right-align width-7">
                                                                    ...
                                                                    <% } %>
                                                                    <td id="tdSerial" runat="server" class="center-align width-5 hide">
                                                                        <a id="lnkSerialNo" href="javascript:openProductSerialNo('<%# Eval("ProductID") %>','<%# Eval("ForOrderNo") %>');"><small>Serial No</small></a>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="11" class="badge gradient-45deg-yellow-green black-text gradient-shadow border-radius-5">
                                                                        <asp:Label ID="lblSerialNo" runat="server" ClientIDMode="Static" />
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                            <FooterTemplate >
                                                                <tr style="background-color: #dde8f3;">
                                                                    ...
                                                                    <td class="right-align width-8">
                                                                        ...
                                                                        <asp:TextBox ID="txtTaxRate" runat="server" ClientIDMode="Static" Width="70" TabIndex="42" AutoPostBack="true" OnTextChanged="txtTaxRate_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align width-7">
                                        ...
                                        <div id="pnl_Email" class="col m12 mt-1" runat="server" clientidmode="Static" enableviewstate="true" style="display: none;">
                                            ...
                                            <div class="row">
                                                <div class="input-field col m2">
                                                    ...
                                                    <asp:DropDownList ID="drpEmailCategory" runat="server" ClientIDMode="Static" class="select2-theme browser-default" EnableViewState="true" TabIndex="59" Width="200px" AutoPostBack="true" OnSelectedIndexChanged="drpEmailCategory_SelectedIndexChanged" />
                                                </div>
                                            ...
                                            <div class="container" style="max-width: none; width: 98%; margin: 5px !important;">
                                                ...
                                                <div class="row">
                                                    <div class="input-field col m6">
                                                        ...
                                                        <asp:TextBox ID="txtTransportRemark" runat="server" class="form-control" ClientIDMode="Static" TabIndex="77" placeholder="" TextMode="MultiLine" MaxLength="1000" Rows="4" />
                                                    </div>
                                                    <div class="input-field col m3">
                        ...
                        <div class="row padding-1 gradient-45deg-blue-grey-blue-grey vertical-align-bottom" style="margin-top: 10px;">
                            <div class="col m12">
                                <button type="button" id="btnReset" runat="server" clientidmode="Static" class="btn orange left" onserverclick="btnReset_ServerClick" tabindex="81"><i class="material-icons left">backspace</i>Clear & Add New</button>
                                <button type="button" id="btnSaveEmail" runat="server" clientidmode="Static" class="btn cyan  right mr-1" onserverclick="btnSaveEmail_ServerClick" tabindex="80"><i class="material-icons left">email</i>Save - Send Email</button>
                                <button type="button" id="btnSave" runat="server" clientidmode="Static" class="btn cyan right mr-1" onserverclick="btnSave_ServerClick" tabindex="79"><i class="material-icons left">save</i>Save</button>
                            </div>
                        </div>
                    </div>
