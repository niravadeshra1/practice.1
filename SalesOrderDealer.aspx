                                                        ...
                                                        <asp:Repeater ID="rptOrderDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptOrderDetail_ItemCommand" OnItemDataBound="rptOrderDetail_ItemDataBound">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox ID="edQuantity" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex="8" />
                                                                    </td>
                                                                    <td class="text-center hide"><%# Eval("Unit") %></td>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox ID="edUnitRate" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("UnitRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Enabled="false" Style="width: 70px; text-align: right;" TabIndex="9" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox ID="edDiscountPercent" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountPercent") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="10" />
                                                                    </td>
                                                                    <td class="right-align hide">
                                                                        <asp:TextBox ID="edDiscountAmt" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountAmt") %>' OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;" Enabled="false" TabIndex="11" />
                                                                    </td>
                                                                    <td class="right-align hide">
                                                                        <asp:TextBox ID="edNetRate" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("NetRate") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex="12" />
                                                                    </td>
                                                                    <td class="text-right hide">
                                                                        <asp:TextBox ID="edHeaderDiscAmt" runat="server" ClientIDMode="Static" Text='<%# Eval("HeaderDiscAmt") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex="12" CssClass="form-control onlyDecimal" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                        <asp:TextBox ID="edAmount"  CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Text='<%# Eval("Amount") %>' Style="width: 90px; text-align: right;" Enabled="false" TabIndex="13" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        ...
                                                                        <asp:TextBox ID="edTaxRate" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("TaxRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Enabled="false" Style="width: 50px; text-align: right;" TabIndex="14" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                    ...
                                                                    <td class="right-align" style="width: 10%;">
                                                                        <asp:TextBox ID="edNetAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("NetAmount") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex="16" />
                                                                    </td>
                                                                    <% if (hdnQuotationSpecification.Value.ToLower() == "yes")
                                                                       { %>
                                                            ...
                                                            <FooterTemplate>
                                                                <tr style="background-color: #dde8f3; border-bottom: 5px solid navy;">
                                                                    ...
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox ID="txtQuantity" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="70" TabIndex="19" AutoPostBack="true" OnTextChanged="txtQuantity_TextChanged" />
                                                                    </td>
                                                                    <td class="center-align hide">
                                                                        <asp:TextBox ID="txtUnit" runat="server" ClientIDMode="Static" Width="50" TabIndex="20" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox ID="txtUnitRate" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="80" TabIndex="21" Enabled="false" AutoPostBack="true" OnTextChanged="txtUnitRate_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox ID="txtDiscountPercent" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="50" TabIndex="22" Enabled="false" AutoPostBack="true" OnTextChanged="txtDiscountPercent_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align hide">
                                                                        <asp:TextBox ID="txtDiscountAmt" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="80" TabIndex="23" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align hide">
                                                                        <asp:TextBox ID="txtNetRate" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="80" TabIndex="24" Enabled="false" />
                                                                    </td>
                                                                    <td class="text-right hide">
                                                                        <asp:TextBox ID="txtHeaderDiscAmt" runat="server" ClientIDMode="Static" Width="80" TabIndex="25" Enabled="false" CssClass="form-control onlyDecimal" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                        <asp:TextBox ID="txtAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="90" TabIndex="25" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        ...
                                                                        <asp:TextBox ID="txtTaxRate" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="50" TabIndex="26" Enabled="false" AutoPostBack="true" OnTextChanged="txtTaxRate_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                        ...
                                                                        <asp:TextBox ID="txtTaxAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="90" TabIndex="27" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                        <asp:TextBox ID="txtNetAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="90" TabIndex="28" Enabled="false" />
                                                                    </td>
                                                    ...
                                                    <table id="tblSummary" class="table responsive-table striped" border="0">
                                                        <tbody>
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtHeadDiscount" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="44" AutoPostBack="true" OnTextChanged="txtHeadDiscount_TextChanged" />
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotBasicAmt" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="36" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-80 right-align">Other Charge <small style="color: navy; font-weight: 600;">(With Tax)</small></td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotOthChrgBeforeGST" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="39" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20">
                                                                    ...
                                                                    <asp:TextBox ID="txtTotGST" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="42" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-80 right-align">Other Charges <small style="color: Navy; font-weight: 600;">(Excluding Tax)</small></td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotOthChrgAfterGST" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="45" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-80 right-align">Round Off</td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtRoff" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="48" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-80 right-align">Net Amount</td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotNetAmt" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="49" ReadOnly="true" Style="font-weight: bold;" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-70 right-align">Advance Amount</td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtAdvPer" class="form-control onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="50" Style="font-weight: bold;" ToolTip="Advance Percentage" placeholder="%" OnTextChanged="txtAdvPer_TextChanged" />
                                                                    <asp:TextBox ID="txtAdvAmt" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="51" Style="font-weight: bold;" ToolTip="Advance Amount" />
                                                                </td>
                                                            </tr>
                                            ...
                                            <table id="tblPaySchedule" class="table responsive-table striped">
                                                <asp:Repeater ID="rptPaySchedule" runat="server" ClientIDMode="Static" OnItemCommand="rptPaySchedule_ItemCommand">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            <td class="right-align width-30">
                                                                <asp:TextBox ID="edPayAmount" runat="server" ClientIDMode="Static" CssClass="form-control text-right onlyDecimal" Text='<%# Eval("PayAmount") %>' AutoPostBack="true" TabIndex="53" />
                                                            </td>
                                                    ...
                                                    <FooterTemplate>
                                                        <tr>
                                                            <td class="right-align width-30">
                                                                <asp:TextBox ID="ftPayAmount" runat="server" ClientIDMode="Static" CssClass="form-control text-right onlyDecimal" Text='<%# Eval("PayAmount") %>' AutoPostBack="true" TabIndex="56" />
                                                            </td>
                                                            <td class="center-align width-30">
