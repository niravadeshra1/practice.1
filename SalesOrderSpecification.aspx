                                                        ...
                                                        <asp:Repeater ID="rptProductSpecs" runat="server" ClientIDMode="Static" OnItemDataBound="rptProductSpecs_ItemDataBound">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <tr class="blueShed" id="itemRow<%# Container.ItemIndex + 1 %>">
                                                                    ...
                                                                    <td class="text-center">
                                                                        <asp:TextBox class="form-control text-left" ID="newMaterialHead" runat="server" ClientIDMode="Static" TabIndex="7" Text='<%# Eval("MaterialHead") %>'  AutoPostBack="true" OnTextChanged="newMaterialHead_TextChanged"/>
                                                                    </td>
                                                                    <td class="text-center">
                                                                        <asp:TextBox class="form-control text-left" ID="newMaterialSpec" runat="server" ClientIDMode="Static" TabIndex="7" Text='<%# Eval("MaterialSpec") %>'  AutoPostBack="true" OnTextChanged="newMaterialSpec_TextChanged"/>
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
