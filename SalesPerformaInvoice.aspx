<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesPerformaInvoice.aspx.cs" Inherits="StarsProject.SalesPerformaInvoice" MaintainScrollPositionOnPostback="true" %>
                                        ...
                                        <div class="col m12">
                                            <div class="row">
                                                <div class="input-field col m2">
                                                    <label class="active" for="txtOrderNo">Proforma #</label>
                                                    <asp:TextBox ID="txtOrderNo" runat="server" class="form-control" ClientIDMode="Static" TabIndex="1" ReadOnly="true" placeholder="" />
                                                </div>
                                                <div class="input-field col m2">
                                                    <label class="active" for="txtOrderDate">Proforma Date <span class="materialize-red-text font-weight-800">*</span></label>
                                                    <asp:TextBox ID="txtOrderDate" runat="server" class="form-control" ClientIDMode="Static" TabIndex="2" placeholder="" z TextMode="Date" />
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="input-field col m1.5">
                                                    ...
                                                    <asp:TextBox ID="txtExchangeRate" runat="server" MaxLength="12" placeholder="" class="form-control onlyDecimal" ClientIDMode="Static" TabIndex="14" />
                                                </div>
                                                <% } %>
                                                <div class="input-field col m1.5">
                                                    <label class="active" for="txtCreditDays">Credit Days</label>
                                                    <asp:TextBox ID="txtCreditDays" runat="server" MaxLength="50" placeholder="" class="form-control onlyNumeric" ClientIDMode="Static" TabIndex="14" />
                                                </div>
                                                <div class="input-field col m1.5">
                                              ...
                                              <% if (hdnSerialKey.Value == "KKS1-RR30-LL80-AA89" ||hdnSerialKey.Value == "GR5T-E7K3-EN2G-LAP4") { %>
                                            <div class="row">
                                                 <div class="input-field col m3">
                                    ...
                                    <div class="row">
                                        <div class="col s12">
                                            <ul id="Ul1" class="tabs" runat="server" clientidmode="Static" enableviewstate="true" style="background-color: antiquewhite;">
                                                ...
                                                <li class="tab col m1.5 p-0"><a id="lnkTNC" class="left" href="#pnl_TNC" tabindex="28">Terms & Conditions</a></li>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edUnitQty" runat="server" ClientIDMode="Static" Text='<%# Eval("UnitQty") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex="14" />
                                                                    </td>
                                                                    <% } %>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edQuantity" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="edQuantity_TextChanged" Style="width: 70px; text-align: right;" TabIndex="15" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edUnitRate" runat="server" ClientIDMode="Static" Text='<%# Eval("UnitRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex="16" />
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edDiscountPercent" runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountPercent") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="17" />
                                                                    </td>
                                                                    <td class="right-align hide">
                                                                        <asp:TextBox ID="edDiscountAmt" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountAmt") %>' OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;" Enabled="false" TabIndex="18" />
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="edNetRate" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("NetRate") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex="19" />
                                                                    </td>
                                                                    <td class="text-right">
                                                                        <asp:TextBox ID="edHeaderDiscAmt" runat="server" ClientIDMode="Static" Text='<%# Eval("HeaderDiscAmt") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex="20" CssClass="form-control onlyDecimal" />
                                                                    </td>
                                                                    <td class="right-align width-7">
                                                                        <asp:TextBox ID="edAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("Amount") %>' Style="width: 90px; text-align: right;" Enabled="false" TabIndex="21" />
                                                                    </td>
                                                                    <td class="right-align width-5">
                                                                        ...
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="edTaxRate" runat="server" ClientIDMode="Static" Text='<%# Eval("TaxRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="22" />
                                                                    </td>
                                                                    <td class="right-align width-7">
                                                                        ...
                                                                        <asp:TextBox ID="edTaxAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("TaxAmount") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex="23" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                        <asp:TextBox ID="edNetAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("NetAmount") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex="24" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                            ...
                                                            <FooterTemplate>
                                                                <tr style="background-color: #dde8f3; border-bottom: 5px solid navy;">
                                                                    ...
                                                                    <% if (hdnSerialKey.Value == "SA98-6HY9-HU67-LORF")
                                                                        { %>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="txtUnitQty" runat="server" ClientIDMode="Static" Width="70" AutoPostBack="true" OnTextChanged="txtUnitQty_TextChanged" TabIndex="30" MaxLength="10" />
                                                                    </td>
                                                                    <% } %>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="txtQuantity" runat="server" ClientIDMode="Static" Width="70" TabIndex="31" AutoPostBack="true" OnTextChanged="txtQuantity_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="txtUnitRate" runat="server" ClientIDMode="Static" Width="80" TabIndex="32" AutoPostBack="true" OnTextChanged="txtUnitRate_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="txtDiscountPercent" runat="server" ClientIDMode="Static" Width="50" TabIndex="33" AutoPostBack="true" OnTextChanged="txtDiscountPercent_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align hide">
                                                                        <asp:TextBox ID="txtDiscountAmt" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="80" TabIndex="34" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="txtNetRate" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="80" TabIndex="35" Enabled="false" />
                                                                    </td>
                                                                    <td class="text-right hide">
                                                                        <asp:TextBox ID="txtHeaderDiscAmt" runat="server" ClientIDMode="Static" Width="80" TabIndex="36" Enabled="false" CssClass="form-control onlyDecimal" />
                                                                    </td>
                                                                    <td class="right-align width-7">
                                                                        <asp:TextBox ID="txtAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="90" TabIndex="37" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align width-5">
                                                                        ...
                                                                        <asp:TextBox CssClass="onlyDecimal" ID="txtTaxRate" runat="server" ClientIDMode="Static" Width="50" TabIndex="38" AutoPostBack="true" OnTextChanged="txtTaxRate_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align width-7">
                                                                        ...
                                                                        <asp:TextBox ID="txtTaxAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="90" TabIndex="39" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                        <asp:TextBox ID="txtNetAmount" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="90" TabIndex="40" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                    ...
                                                    <table id="tblCharge" class="table responsive-table striped width-100" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt1" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="16" AutoPostBack="true" OnTextChanged="txtOthChrgAmt1_TextChanged" Style="text-align: right;" MaxLength="12" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt2" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="18" AutoPostBack="true" OnTextChanged="txtOthChrgAmt2_TextChanged" Style="text-align: right;" MaxLength="12"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt3" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="20" AutoPostBack="true" OnTextChanged="txtOthChrgAmt3_TextChanged" Style="text-align: right;" MaxLength="12"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt4" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="22" AutoPostBack="true" OnTextChanged="txtOthChrgAmt4_TextChanged" Style="text-align: right;" MaxLength="12"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt5" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="24" AutoPostBack="true" OnTextChanged="txtOthChrgAmt5_TextChanged" Style="text-align: right;" MaxLength="12"/>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table id="tblSummary" class="table responsive-table striped" border="0">
                                                        <tbody>
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtHeadDiscount" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="25" AutoPostBack="true" OnTextChanged="txtHeadDiscount_TextChanged" MaxLength="12"/>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20">
                                                                    ...
                                                                    <asp:TextBox ID="txtTotGST" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="60" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-80 right-align">Other Charges <small style="color: Navy; font-weight: 600;">(Excluding Tax)</small></td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotOthChrgAfterGST" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="61" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-80 right-align">Round Off</td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtRoff" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="62" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-80 right-align">Net Amount</td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotNetAmt" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="63" ReadOnly="true" Style="font-weight: bold;" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-30">
                                                                    <table class="table responsive-table striped">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:TextBox ID="txtAdvPer" class="form-control onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="26" Style="font-weight: bold; width: 50px;" ToolTip="Advance Percentage" placeholder="" AutoPostBack="true" OnTextChanged="txtAdvPer_TextChanged" MaxLength="12"/></td>
                                                                                <td><span>Amt</span></td>
                                                                                <td>
                                                                                    <asp:TextBox ID="txtAdvAmt" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="27" Style="font-weight: bold; width: 80px;" ToolTip="Advance Amount" MaxLength="12"/></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </td>
                                        ...
                                        <div id="pnl_TNC" class="col m12 mt-1" runat="server" clientidmode="Static" enableviewstate="true" style="display: none;">
                                            <div class="row">
                                                ...
                                                <div class="input-field col m12">
                                                    ...
                                                    <asp:TextBox ID="txtTermsCondition" runat="server" class="form-control" ClientIDMode="Static" TabIndex="30" TextMode="MultiLine" Rows="20" Height="100px" placeholder="" MaxLength="5000"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col m6">
                                                    <label class="active" for="txtDelTerms">Delivery Terms</label>
                                                    <asp:TextBox ID="txtDelTerms" runat="server" class="form-control" ClientIDMode="Static" TabIndex="31" TextMode="MultiLine" Rows="20" placeholder="" MaxLength="2000"/>
                                                </div>
                                                <div class="input-field col m6">
                                            ...
                                            <table id="tblPaySchedule" class="table responsive-table striped">
                                                <asp:Repeater ID="rptPaySchedule" runat="server" ClientIDMode="Static" OnItemCommand="rptPaySchedule_ItemCommand">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            <td class="right-align width-30">
                                                                <asp:TextBox ID="edPayAmount" runat="server" ClientIDMode="Static" CssClass="form-control text-right onlyDecimal" Text='<%# Eval("PayAmount") %>' AutoPostBack="true" TabIndex="38" />
                                                            </td>
                                                    ...
                                                    <FooterTemplate>
                                                        <tr>
                                                            <td class="right-align width-30">
                                                                <asp:TextBox ID="ftPayAmount" runat="server" ClientIDMode="Static" CssClass="form-control text-right onlyDecimal" Text='<%# Eval("PayAmount") %>' AutoPostBack="true" TabIndex="41" />
                                                            </td>
                                                            <td class="center-align width-30">
                                        ...
                                        <div id="pnl_Shipment" class="col m12 mt-1" runat="server" clientidmode="Static" enableviewstate="true" style="display: none;">
                                            <div class="row">
                                                <div class="input-field col m4">
                                                    <label class="active" for="txtPreCarrBy"><% if (hdnSerialKey.Value == "COL1-AKL9-TEC9-SJ99") { %>Driver Name <% } else {%> Pre Carriage By (Transporter Name) <%} %></label>
                                                    <asp:TextBox ID="txtPreCarrBy" runat="server" class="form-control" ClientIDMode="Static" TabIndex="45" placeholder="" MaxLength="50" />
                                                </div>
                                                <div class="input-field col m4">
                                                    <label class="active" for="txtPreCarrRecPlace"><% if (hdnSerialKey.Value == "COL1-AKL9-TEC9-SJ99") { %>Driver Contact Detail <% } else {%> Place Of Rec.By Pre Carrier <%} %></label>
                                                    <asp:TextBox ID="txtPreCarrRecPlace" runat="server" class="form-control" ClientIDMode="Static" TabIndex="46" placeholder="" />
                                                </div>
                                                <div class="input-field col m4">
                                                    <label class="active" for="txtFlightNo"><% if (hdnSerialKey.Value == "COL1-AKL9-TEC9-SJ99") { %>Vehicle/Vessel/Flight No <% } else {%> Vessel/Flight No <%} %></label>
                                                    <asp:TextBox ID="txtFlightNo" runat="server" class="form-control" ClientIDMode="Static" TabIndex="47" placeholder="" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col m4">
                                                    <label class="active" for="txtPortOfLoading"><% if (hdnSerialKey.Value == "COL1-AKL9-TEC9-SJ99") { %>Machine Commitioning <% } else {%> Port Of Loading <%} %></label>
                                                    <asp:TextBox ID="txtPortOfLoading" runat="server" class="form-control" ClientIDMode="Static" TabIndex="48" placeholder="" />
                                                </div>
                                                <div class="input-field col m4">
                                                    <label class="active" for="txtPortOfDispatch"><% if (hdnSerialKey.Value == "COL1-AKL9-TEC9-SJ99") { %>Reffrence List <% } else {%> Port Of Dispatch <%} %></label>
