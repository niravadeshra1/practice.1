                    ...
                    <div id="myModal" class="mt-2">
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="row">
                                     <div class="input-field col m6">
                                          <label class="active" for="rdblSalesTargetType">Select Sales Target Type</label>
                                            <asp:DropDownList class="select2-theme browser-default" ID="rdblSalesTargetType" runat="server" TabIndex="7">
                                ...
                                <div class="row">
                                    <div class="input-field col m3">
                                        <label class="active" for="txtTargetAmount">Sales Target<span class="materialize-red-text font-weight-800">*</span></label>
                                        <asp:TextBox ID="txtTargetAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" MaxLength="15" TabIndex="8" placeholder="" />      
                                    </div> 
                                </div>
