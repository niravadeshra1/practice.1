...
<%--                                                    <li class="nav-item">
                                                        <a class="nav-link" id="jobinout-tab" data-toggle="tab" href="#jobinout" role="tab" aria-controls="home" aria-selected="false">Job Card Ledger</a>
                                                    </li>--%>
                                                </ul>
                                            </div>
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr class="blueShed">
                                                                        ...
                                                                        <td class="text-center">
                                                                            <a href="javascript:viewQuotation(<%# Eval("pkID")%>);"><%# Eval("OutwardNo") %></a>
                                                                        </td>
