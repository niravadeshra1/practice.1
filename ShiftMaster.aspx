                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="input-field col m3">
                                            ...
                                            <asp:TextBox ID="txtGraceMins" runat="server" ClientIDMode="Static" class="form-control onlyNumeric" PlaceHolder="" TabIndex="4" TextMode="SingleLine" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col m3">
                                            <label class="active" for="txtMessage">Minimum Hours Of Half Day<span class="materialize-red-text font-weight-800">*</span></label>
                                            <asp:TextBox ID="txtMinHrsHalfDay" runat="server" ClientIDMode="Static" class="form-control onlyDecimal" PlaceHolder="" TabIndex="5" TextMode="SingleLine" />
                                        </div>
                                        <div class="input-field col m3">
                                            <label class="active" for="txtMessage">Minimum Hours Of Full Day<span class="materialize-red-text font-weight-800">*</span></label>
                                            <asp:TextBox ID="txtMinHrsFullDay" runat="server" ClientIDMode="Static" class="form-control onlyDecimal" PlaceHolder="" TabIndex="6" TextMode="SingleLine" />
                                        </div>
                                        <div class="input-field col m3">
