...
<%@ Register Src="~/myModuleSharing.ascx" TagPrefix="uc1" TagName="myModuleSharing" %>
...
<body class="loginpage">
    ...
    <asp:HiddenField ID="hdnTagging" runat="server" ClientIDMode="Static" />
    <asp:HiddenField ID="hdnfiretodowebtoken" runat="server" ClientIDMode="Static" />
                    ...
                    <div id="myModal" style="display:block; width:100%;">
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="row mt-1" style="border-bottom:4px solid;">
                                    <div class="col m4">
                                        <div class="row">
                                            <div class="input-field col m12">
                                                ...
                                                <asp:TextBox ID="txtTaskDescription" runat="server" class="form-control" ClientIDMode="Static" TabIndex="1" MaxLength="5000" TextMode="MultiLine" placeholder="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col m8">
                                        <div class="row">
                                            ...
                                            <div class="input-field col m4">
                                                ...
                                                <asp:DropDownList ID="drpAssignTo" runat="server" CssClass="select2 browser-default" ClientIDMode="Static" TabIndex="5"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="row" style="min-height: 75px;">
                                            <div class="input-field col m2">
                                                <label class="active" for="chkReminder">Reminder Alert</label>
                                                <asp:CheckBox id="chkReminder" class="filled-in" runat="server" clientidmode="Static" TabIndex="6" AutoPostBack="true" OnCheckedChanged="chkReminder_CheckedChanged" />
                                            </div>
                                ...
                                <% if (hdnTagging.Value == "yes")
                                    { %>
                                <div class="row mb-1" style="border-bottom:4px solid;">
                                    <div class="input-field col m2">
                                        <uc1:myModuleSharing runat="server" ID="myModuleSharing" />
                                    </div>
                                </div>
                                <% } %>
                                <div class="row">
                                    <div class="col m4">
                                        <div class="input-field col m12">
                                            ...
                                            <asp:DropDownList ID="drpOption" runat="server" CssClass="select2-theme browser-default" ClientIDMode="Static" TabIndex="12" AutoPostBack="true" OnSelectedIndexChanged="drpOption_SelectedIndexChanged">
                                                <asp:ListItem Text="Add Activity" Value="activity" Selected="True" />
                                                <asp:ListItem Text="Re-Assign Task" Value="reassign" />
                                                <asp:ListItem Text="Complete Task" Value="complete" />
                                            </asp:DropDownList>
                                        </div>
                                        <div id="divTransfer" runat="server" clientidmode="Static" class="input-field col m12 mt-5" style="display:none;">
                                            <label class="active" for="drpTransferTo">Transfer To</label>
                                            <asp:DropDownList ID="drpTransferTo" runat="server" CssClass="select2 browser-default" ClientIDMode="Static" TabIndex="12" AutoPostBack="true" OnSelectedIndexChanged="drpTransferTo_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div id="divCompDate" runat="server" clientidmode="Static" class="input-field col m12 mt-5" style="display:block;">
                                        ...
                                        <div class="input-field col m12 mt-5">
                                            <label class="active form-control" for="txtClosingRemarks">Closing Remarks <small class="text-muted font-italic"> (Max 350 Char) </small></label>
                                            <asp:TextBox ID="txtClosingRemarks" runat="server" class="form-control" MaxLength="50000" ClientIDMode="Static" TabIndex="14" TextMode="MultiLine" Rows="3" placeholder="" style="height:100px; min-height:100px;" />
                                        </div>
                                    </div>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <tr id="trRemarks" runat="server" clientidmode="Static">
                                                        ...
                                                        <td class="center-align">
                                                            <asp:TextBox ID="txtClosingRemarks" runat="server" class="form-control"  MaxLength="50000" ClientIDMode="Static" TextMode="MultiLine" style="color:navy; border:none; resize:none; overflow: auto !important;" Enabled="false" Text='<%#Eval("ClosingRemarks") %>'/>
                                                        </td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                    </tr>
