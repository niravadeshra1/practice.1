                                    ...
                                    <div class="card user-statistics-card float-left mt-0 padding-1" style="width: 58%;">
                                        <div class="card-content p-0" style="min-height: 200px;">
                                            ...
                                            <div id="panel1" runat="server" class="user-statistics-container">
                                                ...
                                                <div class="row">
                                                     <h5 class="card-title padding-1 mb-1 float-left left-align width-100 gradient-45deg-light-blue-indigo">&nbsp;Basic Details<i class="material-icons float-left">ac_unit</i></h5>
                                                    <div class="col m12">
                                                        <div class="row">
                                                            ...
                                                            <div class="input-field col m7">
                                                                <label class="active" for="txtCompanyName" style="color: black !important;">Company Name <span class="materialize-red-text font-weight-800">*</span>
                                                                    ...
                                                                    &nbsp;&nbsp;&nbsp;<small id="isExistingCustomer" runat="server" style="padding-left: 5px;padding-right: 5px;border-radius: 8px;color: white; font-size: 16px;"></small>
                                                                </label>
                                                                <asp:TextBox ID="txtCompanyName" runat="server" ClientIDMode="Static" EnableViewState="true" class="form-control" TabIndex="6" placeholder="Search & Select Existing Customer ..Or.. On No Selection New Customer Will Create" AutoPostBack="true" onKeyup="bindDDLTo('#txtCompanyName')" OnTextChanged="txtCompanyName_TextChanged" />
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="input-field col m5">
                                                        ...
                                                        <div class="card small" style="height:350px;">
                                                             <div class="card-title blue white-text" style="padding:10px;">
                                                                <p class="no-margin">Company's Primary Contacts</p>
                                                                 <a id="lnkFilter" runat="server" clientidmode="static" class="material-icons background-round gradient-45deg-purple-amber gradient-shadow white-text float-right tooltipped btn-move-up accent-2 z-depth-4 right" data-position="center" data-tooltip="Add New Contact"  style="padding:5px; top:-30px; right:-5px;"><i class="material-icons activator" style="line-height: 20px;">add</i></a>
                                                            </div>
...
<%--            </ContentTemplate>
            ...
            <script type="text/javascript">
                ...
                function bindDDLTo(selector) {
                    ...
                    //&& ($("#hdnpkID").val() == '' || $("#hdnpkID").val() == '0') commented by trilok for search customer in edit action
