                                        ...
                                        <div class="card-content" style="padding:10px 5px 5px 5px  !important;">
                                            ...
                                            <div class="row">
                                                <div class="input-field col m6">
                                                    ...
                                                    <asp:TextBox ID="txtGrossWeight" runat="server" class="form-control onlyDecimal" ClientIDMode="Static" TabIndex="60" placeholder="" MaxLength="15" />
                                                </div>
                                                <div class="input-field col m6">
                                                    <label class="active" for="txtTareWeight">Tare Weight (U.L.W)</label>
                                                    <asp:TextBox ID="txtTareWeight" runat="server" class="form-control onlyDecimal" ClientIDMode="Static" TabIndex="61" placeholder="" MaxLength="15" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col m6">
                                                    <label class="active" for="txtNetWeight">Net Weight (Capacity)</label>
                                                    <asp:TextBox ID="txtNetWeight" runat="server" class="form-control onlyDecimal" ClientIDMode="Static" TabIndex="62" placeholder="" MaxLength="15" />
                                                </div>
                                                <div class="input-field col m6">
                                ...
                                <div class="input-field col m12">
                                    ...
                                    <div class="card-content" style="padding:10px 5px 5px 5px  !important;">
                                        <div class="row">
                                            ...
                                            <div class="input-field col m3">
                                                <asp:TextBox ID="txtKilometers" runat="server" ClientIDMode="Static" class="form-control onlyNumeric" PlaceHolder=" " TabIndex="8"  />
