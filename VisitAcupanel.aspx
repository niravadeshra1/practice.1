                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row">
                                <div class="input-field col m12">
                                    <div class="row">
                                        ...
                                        <div class="input-field col m4">
                                            ...
                                            <asp:TextBox ID="txtContactNo1" runat="server" class="form-control  onlyNumeric" placeholder="" MaxLength="10" ClientIDMode="Static" TabIndex="2" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="input-field col m4">
                                        <label class="active" for="txtComplaintNotes">Complaint Description (max 2000 chars)</label>
                                        <asp:TextBox ID="txtComplaintNotes" runat="server" class="form-control" placeholder="" ClientIDMode="Static" MaxLength="2000" TextMode="MultiLine" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col m4">
                                ...
                                <div class="row">
                                    <div class="input-field col m4">
                                        <label class="active" for="txtSiteCondition">Site Condition (max 2000 chars)</label>
                                    ...
                                    <div class="input-field col m4">
                                        <label class="active" for="txtFaultByService">Fault Finding By Service Engineer (max 2000 chars)<span class="materialize-red-text font-weight-800">*</span></label>
                                    ...
                                    <div class="input-field col m4">
                                        <label class="active" for="txtActionTaken">Action Taken (max 2000 chars)<span class="materialize-red-text font-weight-800">*</span></label>
                            ...
                            <div class="row mt-1">
                                <div class="input-field col m4">
                                    <label class="active" for="txtFurtherAction">Further Action To be taken (max 2000 chars)</label>
