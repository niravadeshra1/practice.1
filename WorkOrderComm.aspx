                                                        ...
                                                        <asp:Repeater ID="rptOrderDetail" runat="server" ClientIDMode="Static" OnItemCommand="rptOrderDetail_ItemCommand" OnItemDataBound="rptOrderDetail_ItemDataBound">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox ID="edQuantity" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex="108" />
                                                                    </td>
                                                                    ...
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="edUnitRate" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("UnitRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 70px; text-align: right;" TabIndex="110" />
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="edDiscountPercent" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountPercent") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="111" />
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="edDiscountAmt" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("DiscountAmt") %>' OnTextChanged="editItem_TextChanged" Style="width: 80px; text-align: right;" Enabled="false" TabIndex="112" />
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="edNetRate" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("NetRate") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex="113" />
                                                                    </td>
                                                                    <td class="text-right">
                                                                        <asp:TextBox ID="edHeaderDiscAmt" runat="server" ClientIDMode="Static" Text='<%# Eval("HeaderDiscAmt") %>' Style="width: 80px; text-align: right;" Enabled="false" TabIndex="114" CssClass="form-control onlyDecimal" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                        <asp:TextBox ID="edAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("Amount") %>' Style="width: 90px; text-align: right;" Enabled="false" TabIndex="115" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        ...
                                                                        <asp:TextBox ID="edTaxRate" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("TaxRate") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged" Style="width: 50px; text-align: right;" TabIndex="116" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                        ...
                                                                        <asp:TextBox ID="edTaxAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("TaxAmount") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex="117" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                        <asp:TextBox ID="edNetAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Text='<%# Eval("NetAmount") %>' AutoPostBack="true" Style="width: 90px; text-align: right;" Enabled="false" TabIndex="118" />
                                                                    </td>
                                                            ...
                                                            <FooterTemplate>
                                                                <tr style="background-color: #dde8f3; border-bottom: 5px solid navy;">
                                                                    ...
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox ID="txtQuantity" CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="70" TabIndex="9" AutoPostBack="true" OnTextChanged="txtQuantity_TextChanged" />
                                                                    </td>
                                                                    ...
                                                                    <td class="right-align" style="width: 8%;">
                                                                        <asp:TextBox ID="txtUnitRate"  CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="80" TabIndex="11" AutoPostBack="true" OnTextChanged="txtUnitRate_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="txtDiscountPercent" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="50" TabIndex="12" AutoPostBack="true" OnTextChanged="txtDiscountPercent_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="txtDiscountAmt" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="80" TabIndex="13" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align">
                                                                        <asp:TextBox ID="txtNetRate" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="80" TabIndex="14" Enabled="false" />
                                                                    </td>
                                                                    <td class="text-right"> 
                                                                        <asp:TextBox ID="txtHeaderDiscAmt" runat="server" ClientIDMode="Static" Width="80" TabIndex="15" Enabled="false" CssClass="form-control onlyDecimal" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                        <asp:TextBox ID="txtAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="90" TabIndex="16" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 8%;">
                                                                        ...
                                                                        <asp:TextBox ID="txtTaxRate" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="50" TabIndex="17" AutoPostBack="true" OnTextChanged="txtTaxRate_TextChanged" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                        ...
                                                                        <asp:TextBox ID="txtTaxAmount"  CssClass="onlyDecimal" runat="server" ClientIDMode="Static" Width="90" TabIndex="18" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align" style="width: 10%;">
                                                                        <asp:TextBox ID="txtNetAmount" CssClass="onlyDecimal"  runat="server" ClientIDMode="Static" Width="90" TabIndex="19" Enabled="false" />
                                                                    </td>
                                                                    <td class="right-align hide" style="width: 10%;">
                                                    ...
                                                    <table id="tblCharge" class="table responsive-table striped width-100" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt1" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="22" AutoPostBack="true" OnTextChanged="txtOthChrgAmt1_TextChanged" Style="text-align: right;" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt2" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="24" AutoPostBack="true" OnTextChanged="txtOthChrgAmt2_TextChanged" Style="text-align: right;" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt3" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="26" AutoPostBack="true" OnTextChanged="txtOthChrgAmt3_TextChanged" Style="text-align: right;" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt4" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="28" AutoPostBack="true" OnTextChanged="txtOthChrgAmt4_TextChanged" Style="text-align: right;" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="width-70">
                                                                ...
                                                                <td class="width-30">
                                                                    <asp:TextBox ID="txtOthChrgAmt5" class="form-control inputOther onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="30" AutoPostBack="true" OnTextChanged="txtOthChrgAmt5_TextChanged" Style="text-align: right;" />
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table id="tblSummary" class="table responsive-table striped" border="0">
                                                        <tbody>
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20"> 
                                                                    <asp:TextBox ID="txtHeadDiscount" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="31" AutoPostBack="true" OnTextChanged="txtHeadDiscount_TextChanged" />
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotBasicAmt" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="32" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-80 right-align">Other Charge <small style="color: navy; font-weight: 600;">(With Tax)</small></td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotOthChrgBeforeGST" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="33" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-20">
                                                                    ...
                                                                    <asp:TextBox ID="txtTotGST" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="34" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-80 right-align">Other Charges <small style="color: Navy; font-weight: 600;">(Excluding Tax)</small></td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotOthChrgAfterGST" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="35" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-80 right-align">Round Off</td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtRoff" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="36" ReadOnly="true" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                <td class="width-80 right-align">Net Amount</td>
                                                                <td class="width-20">
                                                                    <asp:TextBox ID="txtTotNetAmt" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="37" ReadOnly="true" Style="font-weight: bold;" />
                                                                </td>
                                                            </tr>
                                                            <tr class="border-none">
                                                                ...
                                                                <td class="width-35">
                                                                    <table class="table responsive-table striped">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td><asp:TextBox ID="txtAdvPer" class="form-control onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="38" Style="font-weight: bold; width:50px;" ToolTip="Advance Percentage" placeholder="%" OnTextChanged="txtAdvPer_TextChanged" /></td>
                                                                                <td><span>Amt </span></td>
                                                                                <td><asp:TextBox ID="txtAdvAmt" class="form-control inputCalc onlyDecimal" runat="server" ClientIDMode="Static" TabIndex="39" Style="font-weight: bold;width:80px;" ToolTip="Advance Amount" /></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </td>
                                            ...
                                            <table id="tblPaySchedule" class="table responsive-table striped">
                                                <asp:Repeater ID="rptPaySchedule" runat="server" ClientIDMode="Static" OnItemCommand="rptPaySchedule_ItemCommand">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            <td class="right-align width-30">
                                                                <asp:TextBox ID="edPayAmount" runat="server" ClientIDMode="Static" CssClass="form-control text-right onlyDecimal" Text='<%# Eval("PayAmount") %>' AutoPostBack="true" TabIndex="442" />
                                                            </td>
                                                            <td class="center-align width-30">
                                                                <asp:TextBox ID="edDueDate" runat="server" ClientIDMode="Static" CssClass="datepicke " Text='<%# Eval("DueDate", "{0:yyyy-MM-dd}") %>' AutoPostBack="true" Width="180px" TabIndex="443" />
                                                            </td>
                                                    ...
                                                    <FooterTemplate>
                                                        <tr>
                                                            <td class="right-align width-30">
                                                                <asp:TextBox ID="ftPayAmount" runat="server" ClientIDMode="Static" CssClass="form-control text-right onlyDecimal" Text='<%# Eval("PayAmount") %>' AutoPostBack="true" TabIndex="42" />
                                                            </td>
                                                            <td class="center-align width-30">
