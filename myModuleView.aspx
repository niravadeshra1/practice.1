...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" src="js/myAllPopup.js"></script>
    ...
    <script type="text/javascript"> 
        ...
        function openQuoteFromInquiry(id) {
            ...
            var url = "";
            if ($("#hdnSerialKey").val() == "HEMA-AUTO-SI08-NVRL") // Hema AutoMation
                url = "QuotationHema.aspx?mode=add&id=0&InquiryNo=" + id;
            else if ($("#hdnSerialKey").val() == "SYNC-SIOF-DFGH-09JH") // Synchro
                url = "QuotationSync.aspx?mode=add&id=0&InquiryNo=" + id;
            else if ($("#hdnSerialKey").val() == "COL1-AKL9-TEC9-SJ99") // Coldtech
                url = "Quotation_Coldtech.aspx?mode=add&id=0&InquiryNo=" + id;
            else  // -General
                url = "Quotation.aspx?mode=add&id=0&InquiryNo=" + id;
            $('#ifrModule').attr('src', url);
            $find("mpe").show();
        }
        // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
        ...
        function openContFollowFromExternalLeads(mode, ExtpkID, InqpkID) {
            Sys.UI.DomElement.getElementById('<%= spnModuleHeader.ClientID%>').innerHTML = "Manage External FollowUp";
            var pageUrl = '';
            if (InqpkID == '0')
                pageUrl = "FollowupExternal.aspx?followupsource=external&mode=" + mode + "&id=0" + "&ExtpkID=" + ExtpkID;
            else
                pageUrl = "Followup.aspx?mode=add&id=0" + "&InqID=" + InqpkID;
        ...
        function openContFollowFromPlusInquiryVMS(mode, ExtpkID) {
            Sys.UI.DomElement.getElementById('<%= spnModuleHeader.ClientID%>').innerHTML = "Manage Plus Inquiry VMS";
            var pageUrl = "PlusInquiryVMS.aspx?mode=" + mode + "&id=0" + "&ExtpkID=" + ExtpkID;
            $('#ifrModule').attr('src', pageUrl);
            $find("mpe").show();
        }
        ...
        //------------------------------------------------------------------------------
        function openComplaintFollowup(mode, pkID, ComplaintNo) {
            Sys.UI.DomElement.getElementById('<%= spnModuleHeader.ClientID%>').innerHTML = "Manage Complaint FollowUp";
            var pageUrl = "ComplaintFollowup.aspx?mode=" + mode + "&id=0" + "&pkID=" + pkID + "&ComplaintNo=" + ComplaintNo;
            $('#ifrModule').attr('src', pageUrl);
            $find("mpe").show();
        }
        // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
        // Below Section : To Assign Bulk Lead
        // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
        function chkAssignLeadAll(item, id)
        {
            var myVar = $("#hdnSelectedCheckBox").val();
            if (item.checked == true)
            {
                myVar = myVar + id.toString() + ",";
            }
            else
            {
                myVar = myVar.replace(id.toString() + ",", "");
            }
            $("#hdnSelectedCheckBox").val(myVar);
        }
        function openAssignLeadAll()
        {
            const elem = document.getElementById('myExtLeadAssign');
            const instance = M.Modal.init(elem, { dismissible: false });
            instance.open();
        }
        function setAssignLeadAll()
        {
            var tmpList = $("#hdnSelectedCheckBox").val();
            var bulkUrl = '/Services/NagrikService.asmx/setBulkExternalLead?LeadID=' + tmpList + "&EmployeeID=" + $("#drpEmployeeBulkLead").val();
            jQuery.ajax({
                url: bulkUrl,
                type: "get",
                success: function (data) {
                    $("#hdnSelectedCheckBox").val("");
                    gridReloadData('reload');
                    // ------------------------------
                    swal("All Lead Assign ! ", { title: 'Bulk Lead', icon: "info" }).then(function () {
                        const elem = document.getElementById('myExtLeadAssign');
                        const instance = M.Modal.init(elem, { dismissible: false });
                        instance.close();
                    });;
        ...
        {
            var tmpList = $("#hdnSelectedCheckBox").val();
            var bulkUrl = '/Services/NagrikService.asmx/sendWatapp?LeadID=' + tmpList;
            jQuery.ajax({
                url: bulkUrl,
                type: "get",
                success: function (data) {
        ...
        $(".btnTopRightCornerExternal").click(function () {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hdnSelectedCheckBox" runat="server" ClientIDMode="Static" />
    <asp:HiddenField ID="hdnSunExternalACID" runat="server" ClientIDMode="Static" />
    ...
    <asp:HiddenField ID="hdnStoreOutwardVersion" runat="server" ClientIDMode="Static" />
        ...
        <div class="col s12">
            <div class="card">
                <div class="card-content" style="padding: 8px;">
                    ...
                    <div class="float-left mr-1" style="width:auto; padding-top:8px;">
                        <span id="spnPageNo" class="mt-1 float-left badge gradient-45deg-yellow-green black-text gradient-shadow" style="font-size: 18px; border-radius: 5px;border-radius: 5px; padding: 5px; height: auto; width: 100%;">Page # : </span>  
                    </div>
                    <div class="float-left mr-1" style="width:auto; padding-top:8px;">
                        <span id="spnRecordCount" class="mt-1 float-left badge gradient-45deg-yellow-green black-text gradient-shadow" style="font-size: 18px; border-radius: 5px;border-radius: 5px; padding: 5px; height: auto; width: 100%;"></span>
                    </div>
                    <div class="float-left" style="width:auto; padding-top:8px;">
                    ...
                    <div class="float-left mr-2" style="width:300px; padding-top:8px;">
                        ...
                        <asp:DropDownList ID="drpExternalLeadAc" runat="server" class="select2-theme browser-default mr-2 float-left white blue-text" ClientIDMode="Static" OnSelectedIndexChanged="drpExternalLeadAc_SelectedIndexChanged" TabIndex="5" Style="font-size: 18px; font-weight: bold; width: 150px; margin-top: 1px; height: 35px !important; border: 1px solid black; border-radius: 5px; padding: 1px;" AutoPostBack="true">
                            ...
                            <asp:ListItem Text="TradeIndia" Value="TradeIndia" />
                             <asp:ListItem Text="ExportersIndia" Value="ExportersIndia" />
                        </asp:DropDownList>
                    </div>
                    <div class="float-left mr-2" style="width:350px; padding-top:8px;">
                        <asp:Label runat="server" ClientIDMode="Static" ID="lblSubExternalLeadAc" Style="float: left; margin-right: 10px; color:white; font-size:18px;">Select Sub Account</asp:Label>
                        <asp:DropDownList ID="drpSubExternalLeadAc" runat="server" class="select2-theme browser-default mr-2 float-left white blue-text" ClientIDMode="Static" OnSelectedIndexChanged="drpSubExternalLeadAc_SelectedIndexChanged" TabIndex="5" Style="font-size: 18px; font-weight: bold; width: 150px; margin-top: 1px; height: 35px !important; border: 1px solid black; border-radius: 5px; padding: 1px;" AutoPostBack="true" />
                    </div>
                    <div class="float-left mr-2" style="width:250px; padding-top:8px;">
                    ...
                    <h5 class="gradient-45deg-indigo-purple" style="padding: 5px; line-height: 35px; height:50px; margin: 0.42rem 0 .556rem 0;">
                        <i id="pageIcon" onclick="javascript:showhideMyMenu();" class="fa fa-th mr-1 hide"></i><span id="spnPageHeader" runat="server" clientidmode="Static" class="text-top hide" style="color: white; margin-left: 15px;">Manage Data</span>
                        
                        <%--Section : Add New Entry --%>
                        <a id="lnkAddNew" runat="server" class="material-icons background-round gradient-45deg-purple-amber gradient-shadow white-text float-right tooltipped ml-1 mr-2" data-position="center" data-tooltip="Add New Entry" href="javascript:gridAction('add', 0);" style="padding: 5px;"><i class="material-icons">add</i></a>

                        <%--Section : Add New Entry --%>
                        <a id="lnkLeadAssignTo" runat="server" class="material-icons background-round gradient-45deg-purple-amber gradient-shadow white-text float-right tooltipped ml-1 mr-1" data-position="center" data-tooltip="Assign Lead To Selected" href="javascript:openAssignLeadAll();" style="padding: 5px;"><i class="material-icons">add_alert</i></a>
                        
                        <%--Section : Download/Upload --%>
                        <asp:ImageButton ID="btnExportToExcel" runat="server" ClientIDMode="Static" CssClass="btn-floating float-right ml-1 mr-1 tooltipped hide" AlternateText="Export" data-tooltip="Export To Excel" ImageAlign="left" ImageUrl="images/buttons/export2excel.png" OnClick="btnExportToExcel_Click" Height="35px" Width="35px" Style="z-index: 0;" />
    ...
    <div id="myExtLeadAssign" class="modal" style="width: 40% !important;">
        <div class="modal-content">
            <h4>Assign Bulk Lead
                <asp:Button CssClass="btnTopRightCornerExternal float-right" ID="Button3" runat="server" Text="" Style="top: 3px !important;" />
            </h4>
            <hr />
            <div class="row mt-3">
                <div class="col m12 p-0">
                    <asp:DropDownList ID="drpEmployeeBulkLead" runat="server" class="myDropDownClass select2-theme browser-default mr-2 float-right" ClientIDMode="Static" TabIndex="5" style="width:150px;" />                            
                </div>
            </div>
        </div>
        <hr />
        <div class="modal-footer">
            <%--<button id="btnSendWatsapp" type="button" runat="server" clientidmode="Static" tabindex="11" class="btn gradient-45deg-yellow-green left mr-1" onclick="javascript:SendWatsapp();">Send Message</button>--%>
            <button id="btnAssignAllLead" type="button" runat="server" clientidmode="Static" tabindex="11" class="btn cyan right mr-1" onclick="javascript:setAssignLeadAll();">Load Order</button>
        </div>
    </div>

    <iframe id="ifrPDF" runat="server" src="PDF/QT-MAR23-008.pdf" style="width:600px; height:500px; display:none;" frameborder="0"></iframe>
    <%-- ********************************************************************************************** --%>
    ...
    <script type="text/javascript">
        ...
        $(".btnTopRightCorner").click(function () {
            if ($("#spnPageNo").text() != 'Filtered Data') {
                ...
                //var strPos2 = pgSource.indexOf('mode=continue');
                var pageno = $("#hdnCurrPageNo").val();
                if (strPos1 >= 0) {
                    jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    if (resultdata != null && resultdata != '')
                    {
                        ...
                        if ($.fn.dataTable.isDataTable('#tblView')) {
                            xtable = jQuery('#tblView').DataTable();
                            xtable.clear();
                            xtable.rows.add(resultdata).draw();
                        }
                    }
                    else {
                        //alert('bbb')
                ...
                jQuery.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (resultdata != null && resultdata != '') {
                            ...
                            swal("Search Data Not Available ! ", { title: 'Search', icon: "info" }).then(function () {
        ...
        function loadPageLayout() {
            ...
            if (viewmode == 'inquiry') {
                ...
                colstructure = [
                    ...
                    { title: "Query Date", data: "LeadDate", className: "center", width: "80" },
                    {
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            var newData = '';
                            if (data != '0' && data.trim() != '') {
                                newData = '<p class="mb-0 pill black-text" style="width:auto">&nbsp;' + data + '&nbsp;</p>';
                            }
                            return newData;
                        }
                    },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            data = '<a style="display:inline-block; width:150px; white-space: pre-wrap;" href="javascript:openCustomerInfo(\'View\',\'' + row.CustomerID + '\',\'ifrModule\'' + ');" >' + data + '</a>';
                    ...
                    {
                        title: "Status", data: "InquiryStatus", className: "center", width: "100",
                        render: function (data, type, row, meta) {
                            if (row.InquiryStatus == 'Open')
                                data = '<p class="mb-0 pill blue white-text" style="width:auto">&nbsp;' + data + '&nbsp;</p>';
                            else if (row.InquiryStatus == 'Close - Success')
                                data = '<p class="mb-0 pill green white-text">&nbsp;' + data + '&nbsp;</p>';
                            else if (row.InquiryStatus == 'Close - Lost')
                                data = '<p class="mb-0 pill red white-text">&nbsp;' + data + '&nbsp;</p>';
                            else if (row.InquiryStatus == 'On Hold' || row.InquiryStatus == 'Rest')
                                data = '<p class="mb-0 pill grey white-text">&nbsp;' + data + '&nbsp;</p>';
                            else
                                data = data;
                            return data;
                    ...
                    {
                        title: " Assign To", data: "AssignToEmployeeName", width: "150",
                        render: function (data, type, row, meta) {
                            var newData = '';
                            newData = '<span class="badge gradient-45deg-purple-deep-orange white-text gradient-shadow">' + data + '</span>';
                            if (row.SharedCount > 0)
                            {
                                newData += '<span class="badge gradient-45deg-yellow-green black-text gradient-shadow"> + ' + row.SharedCount + ' </span>';
                            }
                            return newData;

                        }
                    },
                    <% if (hdnSerialKey.Value.Contains("PN9F-NPA1-EQH3-PS1H"))
                       { %>
                        { title: "Created By", data: "CreatedName", className: "center", type: "date", width: "200" },
                    <% } %>
                    <% if (hdnSerialKey.Value.Contains("PRHS-SIOF-2929-IJHU"))
                       { %>
                    //{ title: "Closure Date", data: "ClosureDate", type: "date", className: "center", width: "150", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } }
                        { title: "Closure Date", data: "ClosureDate", className: "center", type: "date", width: "200", 
                        render: function (data, type, full) {
                            var newdate;
                            if (moment(data).year() > 2000)
                                newdate = moment(data).format('DD-MMM-YYYY'); 
            ...
            else if (viewmode == 'inquiryinfoblue') {
                para1 = jQuery.trim(jQuery("#hdnPara1").val());
                dataurl = '/Services/NagrikService.asmx/webInquiryDetailByStatus?currPageNo=1';
                dataurlsearch = '/Services/NagrikService.asmx/webInquiryDetailByStatusSearch?';
                colstructure = [
                    ...
                    //{ title: "Priority", data: "Priority", className: "center", width: "80" },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:openCustomerInfo(\'View\',\'' + row.CustomerID + '\',\'ifrModule\'' + ');">' + data + '</a>';
                            return data;
                        }
                ...
                para3 = jQuery("#drpSubExternalLeadAc").val();
                //alert(para3);
                dataurl = '/Services/NagrikService.asmx/webExternalLeadList?source=' + para1 + '&acid=' + para3 + '&cat=' + para2 + "&currPageNo=1";
                dataurlsearch = '/Services/NagrikService.asmx/webExternalLeadListSearch?source=' + para1 + '&acid=' + para3 + '&cat=' + para2;
                ...
                colstructure = [
                    {
                        title: xUntouchTitle, data: "QueryDatetime", className: "limitedWrap center", width: "80",
                        render: function (data, type, row, meta) {
                    ...
                    { title: "Source", data: "LeadSource", className: "limitedWrap center", width: "100" },
                    {
                        title: "Assign To", data: "EmployeeName", className: "limitedWrap center", width: "130",
                        render: function (data, type, row, meta) {
                    ...
                    {
                        title: "Lead No.", data: "pkID", className: "limitedWrap center", width: "50",
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:gridAction(\'view\',\'' + row.pkID + '\');">' + data + '</a>';
                            return data;
                        }
                    ...
                    {
                        title: "Date", data: "QueryDatetime", type: "date", className: "limitedWrap center", width: "80",
                        render: function (data, type, full) {
                            data = '<p class="badge badge-info mb-0">' +
                                   ((data) ? moment(data).format('DD-MMM-YYYY') : '') +
                                   '</p>' +
                                   '<p class="badge gradient-45deg-yellow-green black-text gradient-shadow mt-1" style="font-weight:bold; ">' +
                                   ((data) ? moment(data).format('hh:mm A') : '') +
                                   '</p>';
                            return data;
                        }
                    },
                    { title: "State", data: "State", className: "limitedWrap center", width: "80" },
                    {
                        title: "Sender Name", data: "SenderName", className: "limitedWrap center", width: "100",
                        render: function (data, type, row, meta) {
                    ...
                    {
                        title: "Company Name<br />Email ID", data: "CompanyName", className: "limitedWrap center", width: "100",
                        render: function (data, type, row, meta) {
                            if (row.CompanyName != '')
                    ...
                    { title: "For Product", data: "ForProduct", className: "limitedWrap center", width: "150" },
                    {
                        title: "Status", data: "LeadSource", className: "center", width: "100",
                        render: function (data, type, row, meta) {
                            ...
                            else if (row.LeadStatus == 'New') {
                                data = '<p class="mb-0 pill blue white-text ">&nbsp;' + ' New ' + '&nbsp;</p>';
                            }
                            else
                                data = '<p class="mb-0 pill silver black-text ">&nbsp;' + ' In-Process ' + '&nbsp;</p>';
                    ...
                    {
                        title: "Lead #", data: "InquiryNo", className: "limitedWrap center", width: "70",
                        render: function (data, type, row, meta) {
                            if (data != '' && data != '')
                    ...
                    { title: "Category", data: "CustomerType", className: "center", width: "150" },
                    { title: "Industry", data: "IndustryName", className: "center", width: "150" },
            ...
            else if (viewmode == 'plusinquiryvms') {
                para1 = ''; debugger;
                para2 = jQuery.trim(jQuery("#drpExternalLeadCat").val());
                dataurl = '/Services/NagrikService.asmx/webPlusInquiryVMSList?source=telecaller&acid=' + para1 + '&cat=' + para2 + "&currPageNo=1";
                dataurlsearch = '/Services/NagrikService.asmx/webPlusInquiryVMSListSearch?source=telecaller&acid=' + para1 + '&cat=' + para2;
                var xUntouchTitle = "Untouch Since <br />Updated By";
                colstructure = [
                    { title: "Customer Name", data: "CompanyName", className: "center", width: "150" },
                    { title: "Porduct", data: "ForProduct", className: "center", width: "150" },
                    { title: "Customer Type", data: "CustomerType", className: "center", width: "150" },
                    { title: "Contact #", data: "PrimaryMobileNo", className: "center", width: "150" },
                    { title: "City", data: "City", className: "center", width: "130" },
                    { title: "Lead Source", data: "LeadSource", className: "center", width: "130" },
                    { title: "Email Id", data: "SenderMail", className: "center", width: "130" }
                ];
                ...
                colstructure = [
                    ...
                    { title: "Followup Type", data: "InquiryStatus", className: "center", width: "80" },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:openCustomerInfo(\'View\',\'' + row.CustomerID + '\',\'ifrmModule\'' + '\');">' + row.CustomerName + '</a><p class="badge badge-primary" style="font-size:12px;">' + row.ContactNo1 + '</p>';
                            return data;
                        }
                        //render: function (data, type, row, meta) {
                        //    data = '<a href="javascript:openCustomerInfo(\'View\',\'' + row.CustomerID + '\',\'ifrmModule\'' + '\');">' + data + '</a>';
                        //    return data;
                        //}
                    },
...
<%--                    <% if (hdnSerialKey.Value.Contains("ECO3-2G21-TECH-3MRT"))
                ...
                colstructure = [
                    ...
                    <% if (hdnSerialKey.Value.Contains("NSIO-BASD-M39F-67SI"))
                    { %>
                        { title: "Manual Quotation No.", data: "ManualQuoteNo", className: "text-right"},
                    <% } %>
                    {
                    ...
                    <% if (hdnSerialKey.Value.Contains("U7NP-IBC9-VR3L-E3KG") || hdnSerialKey.Value.Contains("VMS7-HJLK-SATR-4LNK"))
                    { %>
                        { title: "Quotation Type", data: "QuotationType", width: "150" },
                    <% } %>
            ...
            else if (viewmode == 'purchasequotation') {
                spnModuleHeader.innerText = "Prepare Purchase Quotation";
                dataurl = '/Services/NagrikService.asmx/webPurchaseQuotationDetail?currPageNo=1';
                dataurlsearch = '/Services/NagrikService.asmx/webPurchaseQuotationDetailSearch';
                colstructure = [
                    { title: "Quotation Date", data: "QuotationDate", type: "date", className: "center", width: "150", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } },
                    {
                        title: "Quotation #", data: "QuotationNo", className: "center", width: "200",
                    ...
                    { title: "Basic Amount", data: "BasicAmt", className: "text-right", width: "110", render: jQuery.fn.dataTable.render.number(',', '.', 2, '') },
                    { title: "Net Amount", data: "NetAmt", className: "text-right", width: "110", render: jQuery.fn.dataTable.render.number(',', '.', 2, '') },
                ];
            ...
            else if (viewmode == 'salesperformainvoice') {
                dataurl = '/Services/NagrikService.asmx/webPerformaDetail?currPageNo=1';
                dataurlsearch = '/Services/NagrikService.asmx/webPerformaDetailSearch';
                colstructure = [
                    { title: "Invoice Date", data: "PerformaDate", type: "date", className: "center", width: "150", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } },
                    {
                        title: "Invoice #", data: "PerformaNo", className: "center", width: "150",
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:gridAction(\'view\',\'' + row.pkID + '\');">' + data + '</a>';
                            return data;
                        }
            ...
            else if (viewmode == 'performa') {
                dataurl = '/Services/NagrikService.asmx/webPerformaDetail?currPageNo=1';
                dataurlsearch = '/Services/NagrikService.asmx/webPerformaDetailSearch';
                colstructure = [
                    { title: "Performa Date", data: "PerformaDate", type: "date", className: "center", width: "150", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } },
                    {
                        title: "Performa #", data: "PerformaNo", className: "center", width: "150",
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:gridAction(\'view\',\'' + row.pkID + '\');">' + data + '</a>';
                            return data;
                        }
                ...
                colstructure = [
                    ...
                    { title: "Ref #", data: "RefNo", className: "center", width: "150" },
                     <% if (hdnSerialKey.Value.Contains("CL45-A6R9-T34E-AS89"))
                       { %>
                            { title: "ProjectName", data: "ProjectName", className: "center", width: "200" },
                        <% }; %>
                    {
                        title: "Customer Name", data: "CustomerName", className: "text-left limited", width: "250",
                        render: function (data, type, row, meta) {
                    ...
                    { title: "Purchase Exec.", data: "EmployeeName", className: "center", width: "150" },
                    { title: "Status", data: "ApprovalStatus", className: "center", width: "150" },
                    { title: "Order Amount", data: "OrderAmount", className: "text-right", width: "150", render: jQuery.fn.dataTable.render.number(',', '.', 2, '') }];
                break mysection1;
            }
                ...
                colstructure = [
                    ...
                    <% if (hdnSerialKey.Value.Contains("VAR2-DH0A-MAN9-8SIO"))
                        ...
                        <% }; %>
                    <% if (hdnProductionWithoutCustomer.Value.ToLower() != "yes")
                        { %>
                    {
                        title: "Customer Name", data: "CustomerName", className: "text-left limited", width: "250",
                        render: function (data, type, row, meta) {
                ...
                else if (viewmode == 'repairinginward') {
                    dataurl = '/Services/NagrikService.asmx/webRepairingInwardDetail?currPageNo=1';
                    dataurlsearch = '/Services/NagrikService.asmx/webRepairingInwardDetailSearch';
                colstructure = [
                    { title: "Inward Date", data: "InwardDate", type: "date", className: "center", width: "150", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } },
                    {
                        title: "Inward No#", data: "InwardNo", className: "center", width: "150",
            ...
            else if (viewmode == 'repairingoutward') {
            dataurl = '/Services/NagrikService.asmx/webRepairingOutwardDetail?currPageNo=1';
            dataurlsearch = '/Services/NagrikService.asmx/webRepairingOutwardDetailSearch';
                colstructure = [
            ...
            dataurl = '/Services/NagrikService.asmx/webTestCertificate?currPageNo=1';
            dataurlsearch = '/Services/NagrikService.asmx/webTestCertificateSearch';
            colstructure = [
                { title: "Test Date", data: "TestDate", type: "date", className: "center", width: "150", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } },
                {
                    title: "Test No#", data: "TestNo", className: "center", width: "150",
                    render: function (data, type, row, meta) {
                        data = '<a href="javascript:gridAction(\'view\',\'' + row.pkID + '\');">' + data + '</a>';
                        return data;
                    }
                ...
                { title: "Bill No", data: "BillNo", className: "limitedWrap center", width: "90" }];
            ...
            colstructure = [
                ...
                colstructure = [
                    ...
                    { title: "Order No", data: "ReferenceNo", type: "date", className: "center", width: "150" },
            ...
            return data;
                    ...
                    { title: "Ref No #", data: "DocRefNoList", className: "limitedWrap center", width: "90" },
                     <% if (hdnSerialKey.Value.Contains("VAR2-DH0A-MAN9-8SIO"))
                       { %>
                    ...
                    <% if (hdnProductionWithoutCustomer.Value != "yes")
                            {%>
                    {
                        title: "Customer Name", data: "CustomerName", className: "text-left limited", width: "250",
                        render: function (data, type, row, meta) {
                ...
                break mysection1;
                    ...
                    //-------------------------------------------------------------------------------------
            else if (viewmode == 'packinglist') {
                dataurl = '/Services/NagrikService.asmx/webPackingDetail?currPageNo=1';
                dataurlsearch = '/Services/NagrikService.asmx/webPackingDetailSearch';
                colstructure = [
                    { title: "Packing Date", data: "PackingDate", type: "date", className: "center", width: "150", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } },
                    {
                        title: "Packing No#", data: "PackingNo", className: "center", width: "150",
                        render: function (data, type, row, meta) {
                        data = '<a href="javascript:gridAction(\'view\',\'' + row.pkID + '\');">' + data + '</a>';
                        return data;
                    }
                    },
                    {
                        title: "Reference #", data: "ReferenceNo", className: "center-align", width: "110",
                        render: function (data, type, row, meta) {
                            data = '<b class="blue-text">' + row.OrderNo + '</b>';
                            return data;
                        }
                    }
                ];
        ...
        {%>
            ...
            else if (viewmode == 'contractinfobharattech') {
                para1 = jQuery.trim(jQuery("#hdnPara1").val());
                dataurl = '/Services/NagrikService.asmx/webContractInfoBharatTechDetailByStatus?currPageNo=1';
                dataurlsearch = '/Services/NagrikService.asmx/webContractInfoBharatTechDetailByStatusSearch?';
                colstructure = [
                    {
                        title: "AMC Code #", data: "InquiryNo", className: "center", width: "110",
                        render: function (data, type, row, meta) {
            ...
            else if (viewmode == 'monthlytourplan') {
                dataurl = '/Services/NagrikService.asmx/webMonthlyTourPlan?currPageNo=1';
                dataurlsearch = '/Services/NagrikService.asmx/webMonthlyTourPlanSearch';
                colstructure = [
                    { title: "Tour Date", data: "TourDate", type: "date", className: "center", width: "50", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } },
                    { title: "Tour Day", data: "TourDay", width: "100" },
                    { title: "Created By", data: "CreatedBy", width: "50" }];
                    ...
                    { title: "Reason For Leave", data: "ReasonForLeave", className: "limited", width: "300" },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            if (row.ApprovalStatus == 'Approved')
                                ...
                                data = '<p class="mb-0 pill blue white-text ">&nbsp;' + data + '&nbsp;</p>';
                            return data;
            ...
            else if (viewmode == 'productionplanning') {
                dataurl = '/Services/NagrikService.asmx/webProductionPlanning?currPageNo=1';
                dataurlsearch = '/Services/NagrikService.asmx/webProductionPlanningSearch';
                colstructure = [
                    {
                        title: "Trans. ID", data: "pkID", width: "100", className: "center",
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:gridAction(\'view\',\'' + row.pkID + '\');">' + data + '</a>';
                            return data;
                        }
                ...
                colstructure = [
                    ...
                    { title: "Ref. No #", data: "OrderNo", className: "center", width: "150" },
                    {
                        title: "Employee Name", data: "EmployeeName", className: "center", width: "300",
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:gridAction(\'view\',\'' + row.EmployeeID + '\');">' + data + '</a>';
                ...
                colstructure = [
                    ...
                    {
                        title: "Customer Name", data: "CustomerName", type: "text", className: "center limited", width: "200",
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:openCustomerInfo(\'View\',\'' + row.CustomerID + '\',\'ifrModule\'' + ');">' + data + '</a>';
                            return data;
                        }
                ...
                colstructure = [
                    ...
                    { title: "Voucher Date", data: "VoucherDate", type: "date", className: "center", width: "150", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:openCustomerInfo(\'View\',\'' + row.DBCustomerID + '\',\'ifrModule\'' + ');">' + data + '</a>';
                            return data;
                        }
                    },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:openCustomerInfo(\'View\',\'' + row.CRCustomerID + '\',\'ifrModule\'' + ');">' + data + '</a>';
                            return data;
                        }
                    },
                    { title: "Voucher Amount", data: "VoucherAmount", type: "text", className: "center", width: "150" }];
                ...
                colstructure = [
                    ...
                    { title: "Voucher Date", data: "VoucherDate", type: "date", className: "center", width: "150", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } },
                    {
                        title: "Debit A/c", data: "DBCustomerName", type: "text", className: "left-align limited", width: "150",
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:openCustomerInfo(\'View\',\'' + row.DBCustomerID + '\',\'ifrModule\'' + ');">' + data + '</a>';
                            return data;
                        }
                    ...
                    {
                        title: "Credit A/c", data: "CRCustomerName", type: "text", className: "left-align limited", width: "150",
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:openCustomerInfo(\'View\',\'' + row.CRCustomerID + '\',\'ifrModule\'' + ');">' + data + '</a>';
                            return data;
                        }
                ...
                colstructure = [
                    ...
                    { title: "Voucher No", data: "VoucherNo", type: "text", className: "center", width: "80" },
                    { title: "Voucher Date", data: "VoucherDate", type: "date", className: "left-align limited", width: "150", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } },
                    {
                        title: "Debit A/c", data: "DBCustomerName", type: "text", className: "left-align limited", width: "150",
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:openCustomerInfo(\'View\',\'' + row.DBCustomerID + '\',\'ifrModule\'' + ');">' + data + '</a>';
                    ...
                    {
                        title: "Credit A/c", data: "CRCustomerName", type: "text", className: "left-align limited", width: "80",
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:openCustomerInfo(\'View\',\'' + row.CRCustomerID + '\',\'ifrModule\'' + ');">' + data + '</a>';
                            return data;
                        }
                ...
                colstructure = [
                    {
                     ...
                     <% if (hdnSerialKey.Value.Contains("SI08-SB94-MY45-RY15"))
                       { %>
                    {
                        title: "Customer Name", data: "CustomerName", className: "text-left limited", width: "250",
                        render: function (data, type, row, meta) {
                    ...
                    {
                        title: "OwnerShip", data: "OwnerShipStatus", className: "center", width: "120",
                        render: function (data, type, row, meta) {
                            data = '<span class="badge gradient-45deg-yellow-green black-text gradient-shadow">' + data + '</span>';
                            return data;
                        }
                ...
                colstructure = [
                    ...
                    <% if (hdnSerialKey.Value.Contains("SUN9-SI3G-YU56-78KJ"))  //SunGuru
                    { %>
                    { title: "Manual Invoice No #", data: "OtherRef", className: "center", width: "90" },
                    <% }  %>
                ...
                colstructure = [
                    ...
                    {
                        title: "Request Desc.", data: "RequestNotes",  className: "center", width: "150"
                    },
                    {
                        title: "Voucher Date", data: "ExpenseDate", type: "date", className: "center", width: "150", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; }
                    },
                ...
                colstructure = [
                    ...
                    <% if (hdnSerialKey.Value.Contains("GR5T-E7K3-EN2G-LAP4"))
                    { %>
                    { title: "Sr.No.Repairs", data: "SrNo", className: "center", width: "100" },
                    { title: "Sr.No.Replacement", data: "SrNoReplacement", className: "center", width: "100" },
                    { title: "Error Code", data: "ErrorCodeName", className: "center", width: "100" },
                  <%}%>
                ...
                colstructure = [
                    ...
                    { title: "Complaint Date", data: "ComplaintDate", type: "date", className: "center", width: "130", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } },
                    ...
                    { title: "Assigned From", data: "CreatedByEmployee", className: "center", width: "150" },
                    { title: "Assigned To", data: "EmployeeName", className: "center", width: "150" },
                    { title: "Attended On", data: "VisitDate", type: "date", className: "center", width: "130", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } },
                    {
            ...
            else if (viewmode == 'generalrequest') {
                dataurl = '/Services/NagrikService.asmx/webGeneralRequestList?currPageNo=1';
                dataurlsearch = '/Services/NagrikService.asmx/webGeneralRequestListSearch';
                colstructure = [
                    {
                        title: "Request ID", data: "pkID", className: "center", width: "90",
                        render: function (data, type, row, meta) {
                            data = '<a href="javascript:gridAction(\'view\',\'' + row.pkID + '\');">' + data + '</a>';
                            return data;
                        }
                    },
                    { title: "Date", data: "RequestDate", type: "date", className: "center", width: "130", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } },
                    { title: "Description", data: "RequestNotes", className: "limited", width: "250" },
                    {
                        title: "Approval Status", data: "ApprovalStatus", className: "center", width: "150",
                        render: function (data, type, row, meta) {
                            if (data == 'Pending')
                                return '<span class="badge gradient-45deg-purple-deep-orange white-text gradient-shadow">' + data + '</span>';
                            else 
                                return '<span class="badge gradient-45deg-yellow-green black-text gradient-shadow">' + data + '</span>';
                        }
                        
                    },
                    { title: "Approved By", data: "ApprovedByEmployee", className: "center", width: "150" },
                    {
                        title: "Approved On", data: "ApprovedDate", type: "date", className: "center", width: "130",
                        render: function (data, type, full) {
                            var newdate;
                            if (moment(data).year() > 2000)
                                newdate = moment(data).format('DD-MMM-YYYY');
                    ...
                    { title: "Initiated By", data: "CreatedBy", className: "center", width: "150" },
                    { title: "Initiated On", data: "CreatedDate", type: "date", className: "center", width: "130", render: function (data, type, full) { return (data) ? moment(data).format('DD-MMM-YYYY') : ''; } }
                ];
            ...
            if (jQuery("#hdnActionFlag").val() == 'true') {
                ...
                else if (viewmode == 'pettycash')
                {
                    colstructure.splice(0, 0, {
                        title: "Action", className: "center", width: "30", mRender: function (data, type, row) {
                            ...
                            rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/edit.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'edit\',\'' + row.pkID + '\');"/>';
                            rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/delete.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'delete\',\'' + row.pkID + '\');"/>';
                            rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printpettycash\',\'' + row.pkID + '\');"/><span>PettyCash Voucher</span></div>';
                            rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;</div>';
                            return rtnval;
                        }
                    });
                ...
                else if (viewmode == 'quotation' || viewmode == 'repairingoutward' || viewmode == 'purchasequotation' || viewmode == 'comaccu' || viewmode == 'complaint' || viewmode == 'quotationsolar' || viewmode == 'complaintvisit' || viewmode == 'visitaccu' || viewmode == 'salesorder'
                    || viewmode == 'salesperformainvoice' || viewmode == 'salesordernew' || viewmode == 'salesorderdealer' || viewmode == 'purchaseorder' || viewmode == 'workordercomm' || viewmode == 'salesbill'
                    || viewmode == 'SalesChallan' || viewmode == 'purchasebill' || viewmode == 'purchasebillnew' || viewmode == 'contractinfobharattech' || viewmode == 'materialmovementoutward' || viewmode == 'outward'
                    || viewmode == 'jobcardoutward' || viewmode == 'indent' || viewmode == 'cashvoucher' || viewmode == 'bankvoucher' || viewmode == 'inward' || viewmode == 'test' 
                    || viewmode == 'orgemployee' || viewmode == 'vehiclemastertrip' || viewmode == 'creditnote' || viewmode == 'debitnote' || viewmode == 'performa') {
                    ...
                    colstructure.splice(0, 0, {
                        title: "Action", className: "center", width: "30", mRender: function (data, type, row) {
                            ...
                            //    //-------------------------------------------------------------------------------------------------------------viji mech intimation------------------------------------------
                            //    if ($("#hdnSerialKey").val() == 'PRUM-VJMC-PG7L-RPL3') {
                            //        rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'intimation\',\'' + row.pkID + '\');"/><span>Intimation</span></div>';
                            //    }
                            ...
                            //    }
                            //    //print order by vedant
                            //    if ($("#hdnSerialKey").val() == 'TE3R-SG4J-EQ6P-M1HT') {
                            //        rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printorder\',\'' + row.pkID + '\');"/><span>Order</span></div>';
                            //    }
                            //    //SALES ORDER FOR POWER EX -- TRILOK 
                            //    if ($("#hdnSerialKey").val() == 'PO45-WEFH-RE23-13EX') {
                            //        rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printPOWER\',\'' + row.pkID + '\');"/><span>Order</span></div>';
                            //    }
                                    
                            //}
                            if (viewmode == 'complaint') {
                                rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<a class="tooltipped" data-position="center" data-tooltip="Add Followup" href="javascript:openComplaintFollowup(\'add\',\'' + row.pkID + '\',\'' + row.ComplaintNo + '\');"><img src="images/expand.png" alt="" style="width:15px; height:15px;"/></a>';
                            }
                            else if (viewmode == 'salesperformainvoice') {
                                // print S.O
                                // rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'print\',\'' + row.pkID + '\');"/><span>Sales Order</span></div>';
                            ...
                            else if (viewmode == 'salesorderdealer')
                            {
                                ...
                                // print P.O Agreement
                                if ($("#hdnSerialKey").val() == 'ONIX-ST17-P4AD-SA1D')
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printagreement\',\'' + row.pkID + '\');"/><span>Agreement</span></div>';
                                ...
                                if ($("#hdnSerialKey").val() == 'RM34-CDFH-PO27-LME3')
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printchallan\',\'' + row.pkID + '\');"/><span>Tax Invoice</span></div>';
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'challan\',\'' + row.pkID + '\');"/><span>Sales Challan</span></div>';
                                if ($("#hdnSerialKey").val() == 'ARAN-WR5K-U7D4-LN9F')
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printchallan\',\'' + row.pkID + '\');"/><span>Delivery Challan</span></div>';
                                if ($("#hdnSerialKey").val() == 'ACSI-C803-CUP0-SHEL')
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printchallan\',\'' + row.pkID + '\');"/><span>Delivery Challan</span></div>';
                                if ($("#hdnSerialKey").val() == 'LVK4-MN01-K121-NGVL')
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printchallan\',\'' + row.pkID + '\');"/><span>Delivery Challan</span></div>';
                                ...
                                rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'Printcomaccu\',\'' + row.pkID + '\');"/><span>complaint</span></div>';
                            }
                            else if (viewmode == 'creditnote') {
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printcredit\',\'' + row.pkID + '\');"/><span>Credit Note</span></div>';
                            }
                            else if (viewmode == 'debitnote') {
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printdebit\',\'' + row.pkID + '\');"/><span>Debit Note</span></div>';
                            }
                            else if (viewmode == 'cashvoucher') {
                                ...
                                rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'print\',\'' + row.pkID + '\');"/><span>Contract Info</span></div>';
                            }
                            else if (viewmode == 'outward') {
                                ...
                                if ($("#hdnSerialKey").val() == 'SHRI-VSKM-ALUP-TUF1') {
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printoutwardpcl\',\'' + row.pkID + '\');"/><span>Packing List</span></div>';
                                }
                            }
                            else if (viewmode == 'inward') {
                                if ($("#hdnSerialKey").val() == 'HONP-MEDF-9RTS-FG10') {
                                ...
                                rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'print\',\'' + row.pkID + '\');"/><span>Trip Details</span></div>';
                            }
                            else if (viewmode == 'indent') {
                                ...
                                rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printpquot\',\'' + row.pkID + '\');"/><span>Quatation</span></div>';
                            }
                            else if (viewmode == 'test') {
                                rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'print\',\'' + row.pkID + '\');"/><span>Test Certificate</span></div>';
                            }
                            else if (viewmode == 'visitaccu') {
                                ...
                                rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printrepairingoutward\',\'' + row.pkID + '\');"/><span>Repairing Outward</span></div>';
                            }
                            else if (viewmode == 'complaintvisit') {       // Print for Parth Kitchen (PDF)
                                ...
                                } if ($("#hdnSerialKey").val() == 'HEMA-AUTO-SI08-NVRL' || $("#hdnSerialKey").val() == 'COL1-AKL9-TEC9-SJ99') {
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/expand.png" alt="" style="width:15px; height:15px;" onclick="openFeedBackFromVisit(\'add\',\'' + row.pkID + '\');"/><span>Manage Feedback</span></div>';
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img class="tooltipped" src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printcomplaintvisitHemaAuto\',\'' + row.pkID + '\');"/><span>Complaint Visit</span></div>';
                                }
                            }
                            if (viewmode == 'salesorder' || viewmode == 'salesordernew')
                            {
                            ...
                            if (viewmode == 'quotation' || viewmode == 'quotationsolar') {
                                ...
                                if ($("#hdnSerialKey").val() == 'MES6-TECH-LSR7-S8JL') {
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printMTech\',\'' + row.pkID + '\');"/><span>Quatation</span></div>';
                                }
                                if ($("#hdnSerialKey").val() == 'JAYJ-ALAR-AMBR-ICKS') {
                                rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/expand.png" alt="" style="width:15px; height:15px;" onclick="openContFollowFromQuatation(\'add\',\'' + row.pkID + '\');"/>';
                                }
                                if ($("#hdnSerialKey").val() == 'SYNC-SIOF-DFGH-09JH') {
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printsynchro\',\'' + row.pkID + '\');"/><span>Quatation</span></div>';
                                }
                                if ($("#hdnSerialKey").val() == 'DS9A-A6G3-TCH1-TP2L') {
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printDSS\',\'' + row.pkID + '\');"/><span>Quatation</span></div>';
                                }
                                if ($("#hdnSerialKey").val() == 'JIA9-IN6L-GKS3-INTL') {
                                    rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img src="images/pdf_document.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'printjia\',\'' + row.pkID + '\');"/><span>QuotationJia</span></div>';
                                }
                ...
                else if (viewmode == 'inquiry' || viewmode == 'inquiryjjb' || viewmode == 'inquiryinfoblue')
                {
                    ...
                    colstructure.splice(0, 0, {
                        title: "Action", className: "center", width: "30", mRender: function (data, type, row) {
                            ...
                            {
                                rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<a class="tooltipped" data-position="center" data-tooltip="Add Followup" href="javascript:openContFollowFromExternalLeads(\'add\',\'' + row.pkID + '\',\'' + row.InquiryNopkID + '\');"><img src="images/expand.png" alt="" style="width:15px; height:15px;"/></a>';
                            ...
                            rtnval += '<input type="checkbox" id="chkSelectLead" onclick="javascript:chkAssignLeadAll(this, \'' + row.pkID + '\')" />';
                            rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;</div>';
                            return rtnval;
                        }
                    });
                    ...
                    colstructure.splice(0, 0, {
                        title: "Action", className: "center", width: "30", mRender: function (data, type, row) {
                            ...
                            if ($("#hdnDelFlag").val() == 'true')
                                rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<div class="click-to-top"><img src="images/delete.png" alt="" style="width:15px; height:15px;" onclick="gridAction(\'delete\',\'' + row.pkID + '\');"/><span>Delete Record</span></div>';
                            rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;<a class="tooltipped" data-position="center" data-tooltip="Add Followup" href="javascript:openContFollowup(\'continue\',\'' + row.pkID + '\');"><img src="images/expand.png" alt="" style="width:15px; height:15px;"/></a>';
                            rtnval += '&nbsp;&nbsp;&nbsp;&nbsp;</div>';
                            return rtnval;
                        }
                    });
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    if (resultdata != null && resultdata != '') {
                        ...
                        $.ajax({
                            ...
                            success: function (resultdata) {
                                var resultdata11 = JSON.parse(resultdata.d);
                                var myTotalRecord11 = resultdata11[0].value;

                                if (myTotalRecord11 != null && myTotalRecord11 != '') {
                                    $("#spnRecordCount").text("Total Count : " + myTotalRecord11);
                                }
                            },
                            error: function (r) {
                    ...
                    sortingDef = [[0, "asc"]];
                    // ----------------------------------------------
                    if (viewmode == 'inquiry' || viewmode == 'inquiryjjb' || viewmode == 'inquiryinfoblue' || viewmode == 'contractinfo' || viewmode == 'contractinfobharattech' || viewmode == 'visitorinfo' || viewmode == 'courierinfo' || viewmode == 'quotation' || viewmode == 'quotationsolar' || viewmode == 'leaverequest') {
                        //sortingColNo = 0;
                        //sortingOrder = "desc";
                        sortingDef = [[2, "asc"]];
                    }
...
function setTableRowFormat(viewmode, row, data, dataIndex) {
    ...
    if (viewmode == 'inquiry' || viewmode == 'inquiryjjb' || viewmode == 'inquiryinfoblue') {
...
//------------------------------------------------------------------------------
function openFeedBackFromVisit(mode,InqID) {
    Sys.UI.DomElement.getElementById('<%= spnModuleHeader.ClientID%>').innerHTML = "Manage FollowUp";
    var pageUrl = "FeedBackForm.aspx?VisitID=" + InqID;
    $('#ifrModule').attr('src', pageUrl);
    $find("mpe").show();
}
...
function openContFollowFromQuatation(mode, QuotID) {
    ...
    $find("mpe").show();
        ...
        function gridAction(mode, id)
        {
            ...
            if (varView == 'customer') {
            ...
            else if (varView == 'inquiryinfoblue') {
                pageUrl = "InquiryInfoBlue.aspx?mode=" + mode + "&id=" + id;
                deleteUrl = 'InquiryInfoBlue.aspx/DeleteInquiry';
                deletePara = '{pkID:' + id + '}';
            }
                ...
                if (QuotationVersion == "1" || QuotationVersion == "2") {
                    ...
                    else if ($("#hdnSerialKey").val() == 'HEMA-AUTO-SI08-NVRL') // Hema Automation
                    {
                        pageUrl = "QuotationHema.aspx?mode=" + mode + "&id=" + id;
                        deleteUrl = 'QuotationHema.aspx/DeleteQuotation';
                        deletePara = '{pkID:' + id + '}';
                    }
                    else if ($("#hdnSerialKey").val() == 'SYNC-SIOF-DFGH-09JH') // Synchro
                    {
                        pageUrl = "QuotationSync.aspx?mode=" + mode + "&id=" + id;
                        deleteUrl = 'QuotationSync.aspx/DeleteQuotation';
                        deletePara = '{pkID:' + id + '}';
                    }
                    else if ($("#hdnSerialKey").val() == 'DS9A-A6G3-TCH1-TP2L') // DSS
                    {
                        pageUrl = "QuotationDss.aspx?mode=" + mode + "&id=" + id;
                        deleteUrl = 'QuotationDss.aspx/DeleteQuotation';
                        deletePara = '{pkID:' + id + '}';
                    }
                    else if ($("#hdnSerialKey").val() == 'RD41-PADF-SS42-VE1K') // Radiant
                    {
                        pageUrl = "Quotation_Radiant.aspx?mode=" + mode + "&id=" + id;
                        deleteUrl = 'Quotation_Radiant.aspx/DeleteQuotation';
                        deletePara = '{pkID:' + id + '}';
                    }
                    else if ($("#hdnSerialKey").val() == 'VMS7-HJLK-SATR-4LNK') // VMS
                    {
                        pageUrl = "QuotationVMS.aspx?mode=" + mode + "&id=" + id;
                        deleteUrl = 'QuotationVMS.aspx/DeleteQuotation';
                        deletePara = '{pkID:' + id + '}';
                    }
                    else 
                    {
            ...
            else if (varView == 'purchasequotation') {
                pageTitle = "Manage Purchase Quotation";
                pageUrl = "PurchaseQuotation.aspx?mode=" + mode + "&id=" + id;
                deleteUrl = 'PurchaseQuotation.aspx/DeletePurchaseQuotation';
                deletePara = '{pkID:' + id + '}';
            }     
            ...
            else if (varView == 'salesperformainvoice') {
                    pageUrl = "SalesPerformaInvoice.aspx?mode=" + mode + "&id=" + id;
                    deleteUrl = 'SalesPerformaInvoice.aspx/DeletePerformaInvoice';
                    deletePara = '{pkID:' + id + '}';
            ...
            else if (varView == 'performa') {
                pageUrl = "PerformaInvoice.aspx?mode=" + mode + "&id=" + id;
                deleteUrl = 'PerformaInvoice.aspx/DeletePerforma';
                deletePara = '{pkID:' + id + '}';
            }
                ...
                if ($("#hdnSerialKey").val() == 'SI08-SB94-MY45-RY15')  // For Sharvaya InfoTech
                {
                    pageUrl = "ContractInfoSharvaya.aspx?mode=" + mode + "&id=" + id;
                    deleteUrl = 'ContractInfoSharvaya.aspx/DeleteContractInfo';
                    deletePara = '{pkID:' + id + '}';
                }
                else
                {
            ...
            else if (varView == 'contractinfobharattech') {
                pageUrl = "ContractInfo_BharatTech.aspx?mode=" + mode + "&id=" + id;
                deleteUrl = 'ContractInfo_BharatTech.aspx/DeleteContractInfo';
                deletePara = '{pkID:' + id + '}';
            }
            else if (varView == 'inward') {
                if ($("#hdnSerialKey").val() == 'ACCU-TEKT-ECHN-GIES')
                {
                    pageUrl = "InwardAccutek.aspx?mode=" + mode + "&id=" + id;
                    deleteUrl = 'InwardAccutek.aspx/Deleteinward';
                    deletePara = '{pkID:' + id + '}';
                }
                else
                {
            ...
            else if (varView == 'repairinginward') {
                pageUrl = "RepairingInward.aspx?mode=" + mode + "&id=" + id;
                deleteUrl = 'RepairingInward.aspx/DeleteRepairingInward';
                deletePara = '{pkID:' + id + '}';
            }
            else if (varView == 'repairingoutward') {
                pageUrl = "RepairingOutward.aspx?mode=" + mode + "&id=" + id;
                deleteUrl = 'RepairingOutward.aspx/DeleteRepairingOutward';
                deletePara = '{pkID:' + id + '}';
            }
            else if (varView == 'test') {
                pageUrl = "TestCertificate.aspx?mode=" + mode + "&id=" + id;
                deleteUrl = 'TestCertificate.aspx/DeleteTestCertificate';
                deletePara = '{pkID:' + id + '}';
            }
            ...
            else if (varView == 'packinglist') {
                pageUrl = "PackingList.aspx?mode=" + mode + "&id=" + id;
                deleteUrl = 'PackingList.aspx/DeletePacking';
                deletePara = '{pkID:' + id + '}';
            }
            ...
            else if (varView == 'monthlytourplan') {
                cbWidth = "60%";
                cbHeight = "80%";
                pageUrl = "MonthlyTourPlan.aspx?mode=" + mode + "&id=" + id;
                deleteUrl = 'MonthlyTourPlan.aspx/DeleteMonthlyTourPlan';
                deletePara = '{pkID:' + id + '}';
            }
                ...
                else if ($("#hdnSerialKey").val() == 'PI01-YU02-RUBB-03ER')  //PIYUSH
                {
                    pageUrl = "SalesBill_Piyush.aspx?mode=" + mode + "&id=" + id;
                    deleteUrl = 'SalesBill_Piyush.aspx/DeleteSalesBill';
                }
                else
                {
            ...
            else if (varView == 'plusinquiryvms') {
                var cbWidth = "90%";
                var cbHeight = "90%";
                pageUrl = "PlusInquiryVMS.aspx?source=plusinquiryvms&mode=" + mode + "&id=" + id
                deleteUrl = 'PlusInquiryVMS.aspx/DeletePlusInquiryVMS';
                deletePara = '{pkID:\'' + id + '\'}';
            }
            else if (varView == 'generalrequest') {
                var cbWidth = "60%";
                var cbHeight = "75%";
                pageUrl = "GeneralRequest.aspx?mode=" + mode + "&id=" + id;
                deleteUrl = 'GeneralRequest.aspx/DeleteRequest';
                deletePara = '{pkID:\'' + id + '\'}';
            }
            ...
            else if (varView == 'productionplanning') {
                pageUrl = "ProductionPlanning.aspx?&mode=" + mode + "&id=" + id;
                deleteUrl = 'ProductionPlanning.aspx/DeleteTransaction';
                deletePara = '{pkID:' + id + '}';
            }
                ...
                var OutwardVersion = jQuery.trim(jQuery("#hdnStoreOutwardVersion").val());
                if (OutwardVersion == "2") {
                    pageUrl = "MaterialMovementAssembly.aspx?transtype=out&mode=" + mode + "&id=" + id;
                    deleteUrl = 'MaterialMovementAssembly.aspx/DeleteTransaction';
                }
                else {
                    ...
                    if (willDelete) {
                        jQuery.ajax({
                            ...
                            success: function (data) {
                                ...
                                swal(resultdata[0].ReturnMsg, { title: 'Record Deleted', icon: "success", timer: 5000 })
                                    .then(function () {
                                    gridReloadData('reload');
                                });
                        ...
                        swal("Your Delete Action Cancelled ! ", { title: 'Cancelled', icon: "error", timer: 5000 });
                    }
                });
            }
            // -------------------------------------------------------------
            ...
            if (mode == 'regenerate') {
                ...
                jQuery.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (returnID > 0) {
                            var pageUrl = (jQuery("#hdnSerialKey").val() == "HEMA-AUTO-SI08-NVRL" ? 'QuotationHema.aspx?id=' : 'Quotation.aspx?id=') + returnID
                            $('#ifrModule').attr('src', pageUrl);
                            $find("mpe").show();
                        }
                    },
            ...
            // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
            // Section : Generating Printing 
            // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*

            // >>>> Below Section Will Disable Popup (Only For Honmed)
            if ($("#hdnSerialKey").val() == 'HONP-MEDF-9RTS-FG10' && varView == 'salesorder' && (mode == 'print' || mode == 'printextra' || mode == 'printpi')) {
                jQuery("#hdnpopupPrintHeader").val("no");
            }

            // -------------------------------------------------------------
            if (mode == 'printpquot' && varView == 'purchasequotation') {
                ...
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        ...
                        if (willDelete) {
                            ...
                            // -------------------------------------------------------------------
                            QuotPageUrl = 'PurchaseQuotation.aspx/GenerateQuotation';
                            // ======================================================
                            ...
                            jQuery.ajax({
                                ...
                                success: function (data) {
                                    // -----------------------------------------------------------
                                    jQuery.ajax({
                                        type: "POST", url: 'PurchaseQuotation.aspx/GetQuotationNoForPDF', data: '{pkID:\'' + id + '\'}',
            ...
            // -------------------------------------------------------------
            // Section : Petty Cash Voucher Printing
            // -------------------------------------------------------------
            if (mode == 'printpettycash' && varView == 'pettycash') {
                
                jQuery.ajax({
                    type: "POST",
                    url: 'PettyCash.aspx/GeneratePettyCash',
                    data: '{pkID:\'' + id + '\'}',
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                        // -----------------------------------------------------------
                        jQuery.ajax({
                            type: "POST", url: 'PettyCash.aspx/GetPettyCashNoForPDF', data: '{pkID:\'' + id + '\'}',
                            contentType: "application/json; charset=utf-8", success: function (data11) {
                                QuotationNoForPDF = (data11.d).replace("/", "-");
                                if (QuotationNoForPDF != "") {
                                    ShowPDFfile('PDF/' + QuotationNoForPDF.toString() + '.pdf');
                                    ...
                                    alert('Voucher No PDF Not Found !')
                                }
            ...
            // -------------------------------------------------------------
            // Section : Complaint  Printing by Indrajit Rathod
            // -------------------------------------------------------------
            if (mode == 'Printcomaccu' && varView == 'comaccu') {
                var SOPageUrl = '';
                SOPageUrl = 'ComplaintAcupanel.aspx/GenerateComplaintAcupanel';
                // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        title: "Complaint Header ?", text: "Are you sure? You want to print Header !", icon: 'warning', dangerMode: true,
                        buttons: { cancel: 'Dont Print', delete: 'Yes, Print' }
                    }).then(function (willDelete) {
                        if (willDelete) {
                            var x = PageMethods.setPrintHeader('yes');
                            jQuery.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (id != "") {
                                        ShowPDFfile('PDF/COMP-' + id.toString() + '.pdf');
                                    }
                                    else {
                                        alert('Material Issue  PDF Not Found !')
                                    }
                            ...
                            jQuery.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (id != "") {
                                        ShowPDFfile('PDF/' + id.toString() + '.pdf');
                                    }
                                    else {
                                        alert('Material Issue PDF Not Found !')
                                    }
            ...
            //-------------------------------------------------------------------------
            if ((mode == 'printsynchro') && (varView == 'quotation')) {
                var QuotPageUrl = '', QuotationVersion = '', QuotationNoForPDF = '';
                QuotationVersion = jQuery.trim(jQuery("#hdnQuotationVersion").val());
                QuotationNoForPDF = '';
                // ----------------------------------------------------------------
                    ...
                    swal({
                        ...
                        if (willDelete) {
                            ...
                            if (QuotationVersion == "1" || QuotationVersion == "2") {
                                ...
                                QuotPageUrl = 'Quotation.aspx/GenerateQuotation_SynchroExtra';
                            }
                            // ======================================================
                            // Special Section For Crystal Quotation Printing 
                            // ======================================================
            ...
            //---------------------------vedant----------------------------------------------
            if ((mode == 'printjia') && (varView == 'quotation')) {
                var QuotPageUrl = '', QuotationVersion = '', QuotationNoForPDF = '';
                QuotationVersion = jQuery.trim(jQuery("#hdnQuotationVersion").val());
                QuotationNoForPDF = '';
                // ----------------------------------------------------------------
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        ...
                        if (willDelete) {
                            var x = PageMethods.setPrintHeader('yes');
                            // -------------------------------------------------------------------
                            QuotPageUrl = 'Quotation.aspx/GenerateQuotation_JIAINTERNATIONAL2';
                            // ======================================================
                            // Special Section For Crystal Quotation Printing 
                            // ======================================================
                            jQuery.ajax({
            ...
            //-------------------------------------------------------------------------
            if ((mode == 'printDSS1') && (varView == 'quotation')) {
                var QuotPageUrl = '', QuotationVersion = '', QuotationNoForPDF = '';
                QuotationVersion = jQuery.trim(jQuery("#hdnQuotationVersion").val());
                QuotationNoForPDF = '';
                // ----------------------------------------------------------------
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        ...
                        if (willDelete) {
                            var x = PageMethods.setPrintHeader('yes');
                            // -------------------------------------------------------------------
                            QuotPageUrl = 'Quotation.aspx/GenerateQuotation_DSSAssembly';
                            // ======================================================
                            // Special Section For Crystal Quotation Printing 
                            // ======================================================
                            jQuery.ajax({
            ...
            //-------------------------------------------------------------------------
            if ((mode == 'printDSS') && (varView == 'quotation')) {
                var QuotPageUrl = '', QuotationVersion = '', QuotationNoForPDF = '';
                QuotationVersion = jQuery.trim(jQuery("#hdnQuotationVersion").val());
                QuotationNoForPDF = '';
                // ----------------------------------------------------------------
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        ...
                        if (willDelete) {
                            swal({
                                title: "Quotation Assembly Type ", icon: 'warning', dangerMode: false,
                                buttons: { cancel: 'Print With Prices ?', delete: 'Print WithOut Prices ?' }
                            }).then(function (willDelete) {
                                if (willDelete) {
                                    var x = PageMethods.setQuotationWithPrices('no');
                                }
                                else
                                {
                                    var x = PageMethods.setQuotationWithPrices('yes');
                                }
            ...
            if ((mode == 'printMTech') && (varView == 'quotation' || varView == 'quotationsolar')) {
                var QuotPageUrl = '', QuotationVersion = '', QuotationNoForPDF = '';
                QuotationVersion = jQuery.trim(jQuery("#hdnQuotationVersion").val());
                QuotationNoForPDF = '';
                // ----------------------------------------------------------------
                    ...
                    swal({
                        ...
                        if (willDelete) {
                            ...
                            if (QuotationVersion == "1" || QuotationVersion == "2") {
                                ...
                                QuotPageUrl = 'Quotation.aspx/GenerateQuotation_MTechExtra';
                            }
                            // ======================================================
                            // Special Section For Crystal Quotation Printing 
                            // ======================================================
            ...
            //-------------------------------------------------------------------------------------------------------------------
            if (mode == 'intimation' && varView == 'salesorder') {
                var SOPageUrl = '';
                //var DSOPageUrl = '';
                var SalesOrderVersion = jQuery.trim(jQuery("#hdnSalesOrderVersion").val());
                // =========================================================================
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        ...
                        if (willDelete) {
                            ...
                            // --------------------------------------------------------------------
                            SOPageUrl = 'SalesOrder.aspx/GenerateSalesOrder1';
                            // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                            jQuery.ajax({
                                type: "POST",
                                url: SOPageUrl,
            ...
            if (mode == 'printextra' && viewmode == 'salesorder') {
                var SOPageUrl = '';
                //var DSOPageUrl = '';
                var SalesOrderVersion = jQuery.trim(jQuery("#hdnSalesOrderVersion").val());
                // =========================================================================
            ...
            if ((mode == 'print' || mode == 'printpi') && varView == 'salesorder') {
                ...
                var SalesOrderVersion = jQuery.trim(jQuery("#hdnSalesOrderVersion").val());
                // =========================================================================
                //alert(jQuery.trim(jQuery("#hdnpopupPrintHeader").val()))
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
            ...
            // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
            // Section : Performa Invoice 
            // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
            if (mode == 'printpi' && varView == 'salesperformainvoice') {
                var SOPageUrl = 'SalesPerformaInvoice.aspx/GenerateSalesPerfoma';
                // =========================================================================
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        title: "Print SO/PI Header ?", text: "Are you sure? You want to print Header !", icon: 'warning', dangerMode: true,
                        ...
                        if (willDelete) {
                            ...
                            jQuery.ajax({
                                ...
                                success: function (data) {
                                    // -----------------------------------------------------------
                                    jQuery.ajax({
                                        type: "POST", url: 'SalesPerformaInvoice.aspx/GetSalesProformaNoForPDF', data: '{pkID:\'' + id + '\'}',
                                        contentType: "application/json; charset=utf-8", success: function (data11) {
                                            OrderNoForPDF = (data11.d).replace("/", "-");
                                            if (OrderNoForPDF != "")
                                                ShowPDFfile('PDF/' + OrderNoForPDF.toString() + '.pdf');
                                            else
                                                alert('Perfrma Invoice PDF Not Found !')
                                        }
                                    });
                                },
                                error: function (r) { alert('Error : ' + r.responseText); },
                                    ...
                                    jQuery.ajax({
                                        ...
                                        contentType: "application/json; charset=utf-8", success: function (data11) {
                                            ...
                                            if (OrderNoForPDF != "")
                                                ...
                                                alert('Performa Invoice PDF Not Found !')
                                        }
                                    });
                                },
                                error: function (r) { alert('Error : ' + r.responseText); },
            ...
            // Section : Performa Invoice 
            // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
            if ((mode == 'print' || mode == 'printpi') && varView == 'performa') {
                ...
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        ...
                        if (willDelete) {
                            ...
                            // --------------------------------------------------------------------
                            if (mode == 'printpi') {
                                SOPageUrl = 'PerformaInvoice.aspx/GenerateSalesPerfoma';
                                //DSOPageUrl = 'SalesOrderDealer.aspx/GenerateSalesOrderDealer';
                            }
                            // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                            jQuery.ajax({
                                ...
                                success: function (data) {
                                    // -----------------------------------------------------------
                                    jQuery.ajax({
                                        type: "POST", url: 'PerformaInvoice.aspx/GetPerformaNoForPDF', data: '{pkID:\'' + id + '\'}',
                                        contentType: "application/json; charset=utf-8", success: function (data11) {
                                            OrderNoForPDF = (data11.d).replace("/", "-");
                                            if (OrderNoForPDF != "")
                                                ShowPDFfile('PDF/' + OrderNoForPDF.toString() + '.pdf');
            ...
            // ----------------------------------------------------------------------
            // Section : SALES ORDER POWER EX
            // ----------------------------------------------------------------------
            // BY TRILOK
            if (mode == 'printPOWER' && varView == 'salesorder') {
                var SOPageUrl = '';
                SOPageUrl = 'SalesOrder.aspx/GenerateSalesOrder_PowerEX';
                // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
            ...
            // ----------------------------------------------------------------------
            // Section : terra By vedant
            // ----------------------------------------------------------------------
            //Terra print order by vedant
            if (mode == 'printorder' && varView == 'salesorder') {
                var SOPageUrl = '';
                SOPageUrl = 'SalesOrder.aspx/GenerateSalesOrder_TerraOrder';
                // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        title: "Purc.Order Header ?", text: "Are you sure? You want to print Header !", icon: 'warning', dangerMode: true,
            ...
            // ------------------------------------------
            if (mode == 'printagreement' && varView == 'purchaseorder') {
                var SOPageUrl = '';
                if ($("#hdnSerialKey").val() == 'ONIX-ST17-P4AD-SA1D')
                SOPageUrl = 'PurchaseOrders.aspx/GeneratePurchaseOrder_ONIX_Agreement';
                // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        title: "Purc.Order Header ?", text: "Are you sure? You want to print Header !", icon: 'warning', dangerMode: true,
           ...
           // Section : Visite Complaint Acupanel 
            // ----------------------------------------------------------------------
            if (mode == 'printvisitacupanel' && (varView == 'visitaccu' || varView == 'comaccu')) {
                debugger;
                var SOPageUrl = '';
            ...
            // ----------------------------------------------------------------------
           // Section : Repairng Outward edit By : SHIVAM 
            // ----------------------------------------------------------------------
            if (mode == 'printrepairingoutward' && varView == 'repairingoutward' ) {
                debugger;
                var SOPageUrl = '';
                SOPageUrl = 'RepairingOutward.aspx/GenerateOutward';
                // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        title: "Tax Invoice Header ?", text: "Are you sure? You want to print Header !", icon: 'warning', dangerMode: true,
                            ...
                            jQuery.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    jQuery.ajax({
                                        <% if (hdnSerialKey.Value.Contains(" "))
                                           { %>
                                        type: "POST", url: 'RepairingOutward.aspx/GetOutwardNoForPDF', data: '{pkID:\'' + id + '\'}',
                                        <% }
                                    else
                                    { %>
                                        type: "POST", url: 'RepairingOutward.aspx/GetOutwardNoForPDF', data: '{pkID:\'' + id + '\'}',
            ...
            //-----------------------------Hema Auto Visit-------------------------------
            if (mode == 'printcomplaintvisitHemaAuto' && (varView == 'complaintvisit')) {
                debugger;
                var SOPageUrl = '';
                SOPageUrl = 'ComplaintVisit.aspx/GenerateComplaintVisit_HemaAuto';
                // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                                    ...
                                    { %>
                                        ...
                                        contentType: "application/json; charset=utf-8", success: function (data11) {
                                            ...
                                            if (ComplaintVisitNoForPDF != "") {
                                                ShowPDFfile('PDF/' + "ComplaintVisit-" + ComplaintVisitNoForPDF.toString() + '.pdf');
                                            }
                                            else {
            ...
            if (mode == 'print' && varView == 'contractinfobharattech') {
                var SOPageUrl = '';
                SOPageUrl = 'ContractInfo_BharatTech.aspx/GenerateContractInfo';
                // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        title: "Delivery Order Header ?", text: "Are you sure? You want to print Header !", icon: 'warning', dangerMode: true,
                        ...
                        if (willDelete) {
                            ...
                            jQuery.ajax({
                                ...
                                success: function (data) {
                                    // -----------------------------------------------------------
                                    jQuery.ajax({
                                        type: "POST", url: 'ContractInfo_BharatTech.aspx/GetContractInfoNoForPDF', data: '{pkID:\'' + id + '\'}',
                                        contentType: "application/json; charset=utf-8", success: function (data11) {
                                            BillNoForPDF = (data11.d).replace("/", "-");
                                            if (BillNoForPDF != "")
                                                ShowPDFfile('PDF/' + BillNoForPDF.toString() + '.pdf');
                                            else
                                                alert(' Contract Info PDF Not Found !')
                                        }
                                    });
                                },
                                error: function (r) { alert('Error : ' + r.responseText); },
            ...
            /*------------------------Credit Note------------------------------------------*/
            if ((mode == 'printcredit' && varView == 'creditnote') || (varView == 'debitnote' && mode == 'printdebit')) {
                var SOPageUrl = '';
                if (mode == 'printcredit')
                    SOPageUrl = 'DebitCreditNoteNew.aspx/GenerateCreditNote';
                else
                    SOPageUrl = 'DebitCreditNoteNew.aspx/GenerateDebitNote';
                // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        title: "Delivery Order Header ?", text: "Are you sure? You want to print Header !", icon: 'warning', dangerMode: true,
                                ...
                                success: function (data) {
                                    // -----------------------------------------------------------
                                            if (id != "")
                                                ...
                                                alert('Credit Note PDF Not Found !')
                                },
                                error: function (r) { alert('Error : ' + r.responseText); },
                                failure: function (r) { alert('failure'); }
                            });
            ...
            /*------------------------Credit Note------------------------------------------*/
            if (mode == 'printdebit' && varView == 'debitnotenew') {
                var SOPageUrl = '';
                SOPageUrl = 'DebitCreditNoteNew.aspx/GenerateDebitNote';
                // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                            ...
                            jQuery.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (id != "")
                                        ...
                                        alert('Debit Note PDF Not Found !')
                                },
                                error: function (r) { alert('Error : ' + r.responseText); },
                                failure: function (r) { alert('failure'); }
                            });
            ...
            if (mode == 'challan' && varView == 'salesbill') {
                var SOPageUrl = '';
            ...
            if ((mode == 'printoutward' || mode == 'printoutwardpcl') && varView == 'outward') {
                var SOPageUrl = '';
                // --------------------------------------------------------------------
                // Print Outward for Outward Details
                // --------------------------------------------------------------------
                if (mode == 'printoutward') {
                    SOPageUrl = 'Outward.aspx/GenerateOutward';
                }
                // --------------------------------------------------------------------
                // Print Outward for Pending Checking List
                // --------------------------------------------------------------------
                if (mode == 'printoutwardpcl') {
                    SOPageUrl = 'Outward.aspx/GeneratePackingList';
                }
                // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
            ...
            //-----------------------------Trip Print-------------------------------
            if (mode == 'print' && varView == 'vehiclemastertrip') {
                var SOPageUrl = '';
                SOPageUrl = 'VehicleMasterTrip.aspx/GenerateTrip';
                // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
            ...
            //-----------------------------Indent Print-------------------------------
            if (mode == 'print' && varView == 'test') {
                var SOPageUrl = '';
                SOPageUrl = 'TestCertificate.aspx/GenerateTestCertificate';
                // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        title: "Do You Want to Print Header ?", text: "Are you sure? You want to print Header !", icon: 'warning', dangerMode: true,
                        buttons: { cancel: 'Dont Print', delete: 'Yes, Print' }
                    }).then(function (willDelete) {
                        if (willDelete) {
                            var x = PageMethods.setPrintHeader('yes');
                            jQuery.ajax({
                                ...
                                success: function (data) {
                                    // -----------------------------------------------------------
                                    jQuery.ajax({
                                        type: "POST", url: 'TestCertificate.aspx/GetTestNoForPDF', data: '{pkID:\'' + id + '\'}',
                                        contentType: "application/json; charset=utf-8", success: function (data11) {
                                            BillNoForPDF = (data11.d).replace("/", "-");
                                            if (BillNoForPDF != "")
                                                ShowPDFfile('PDF/' + BillNoForPDF.toString() + '.pdf');
            ...
            if (mode == 'printmovement' && varView == 'materialmovementoutward') {
                var SOPageUrl = '';
                SOPageUrl = 'MaterialMovementAssembly.aspx/GenerateMarterialMovementReport_DayaNidhi';
                // *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
                if (jQuery.trim(jQuery("#hdnpopupPrintHeader").val()) == 'yes') {
                    swal({
                        title: "Print Header ?", text: "Are you sure? You want to print Header !", icon: 'warning', dangerMode: true,
